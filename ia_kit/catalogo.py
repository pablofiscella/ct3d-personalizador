...
_EXTRA_FORMA = {
    ...
    "stickers": ("Stickers del tema: SOLO los personajes del tema y objetos DISTINTIVOS "
                 ...
                 "de pegarlo. En cada posición de la grilla va UN (1) SOLO sticker: NUNCA "
                 "grupos de dos o tres objetos juntos en la misma celda (tres copas juntas, "
                 "tres camisetas juntas, una tirita de pelotitas) — si querés repetir un "
                 "motivo, va en OTRA celda aparte. La MAYOR variedad posible de motivos "
                 "temáticos distintos, "
