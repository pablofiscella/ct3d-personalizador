...
GRADO_3 = [
    ...
    {"cod": "M2", "area": "matematica", "tema": "Tres en fila",
     "dc": "Leer, escribir, comparar y ordenar números de 3 y 4 cifras",
     "cubre": ["comparar_numeros", "numeros_palabras_3"]},
...
GRADO_2 = [
    ...
    {"cod": "M6", "area": "matematica", "tema": "Comparar números",
     "dc": "Leer, escribir, comparar y ordenar números de 2 y 3 cifras",
     "cubre": ["comparar_numeros", "ordenar_numeros", "numeros_palabras_2"]},
...
# ── 6° grado ────────────────────────────────────────────────────────────────────
# Fuente: docs/auditoria-dc-caba/grado-6.md § "Mapa propuesto del año" — 70 temas
# curriculares (23 Mate · 16 Lengua · 11 Naturales · 10 Sociales · 5 Tecnología ·
# 5 Transversales) + 3 evergreen que NO computan cobertura.
#
# El `area` de acá es el CARRIL DEL MENÚ, que son seis y están fijos. Tecnología y
# las transversales no tienen carril propio, así que se reparten por afinidad
# (programación → lógica, salud → naturales, ciudadanía → sociales); el área real del
# DC queda escrita en el campo `dc` para que el informe no la pierda.
#
# ⚠ N4, N5, N6, Tr1 y Tr2 son contenido de ESI, y S1-S9 son afirmaciones históricas:
# todo ese bloque necesita revisión docente antes de salir a la venta (ver la skill
# cobertura-curricular, sección "Contenido que pide revisión docente").
GRADO_6 = [
    # ── Matemática (23) ──────────────────────────────────────────────────────────
    {"cod": "M1",  "area": "matematica", "tema": "Números gigantes",
     "dc": "Lectura, orden y valor posicional sin restricción de rango (5 a 9 cifras)",
     "cubre": "numeros_gigantes_6"},
    {"cod": "M2",  "area": "matematica", "tema": "Criba de primos",
     "dc": "Primos y compuestos; múltiplos y divisores comunes",
     "cubre": "primos_6"},
    {"cod": "M3",  "area": "matematica", "tema": "Detector de divisibilidad",
     "dc": "Criterios de divisibilidad por 2, 5 y 10",
     "cubre": "divisibilidad_criterios_6"},
    {"cod": "M4",  "area": "matematica", "tema": "Armá el cálculo",
     "dc": "Operaciones combinadas y jerarquía; uso del paréntesis",
     "cubre": "jerarquia_6"},
    {"cod": "M5",  "area": "matematica", "tema": "Reconstruí la división",
     "dc": "Relación c×d+r=D con r<d; restos posibles e imposibles",
     "cubre": "reconstruir_division_6"},
    {"cod": "M6",  "area": "matematica", "tema": "Podio de permutaciones",
     "dc": "Combinatoria: permutaciones; combinación de dos conjuntos",
     "cubre": "permutaciones_6"},
    {"cod": "M7",  "area": "matematica", "tema": "Fracción de una cantidad",
     "dc": "Fracción de un natural con numerador distinto de 1, sin tope de rango",
     "cubre": "fraccion_cantidad_6"},
    {"cod": "M7b", "area": "matematica", "tema": "Fracciones equivalentes",
     "dc": "Equivalencia de fracciones: amplificar y simplificar",
     "cubre": "fracciones_equivalentes_6"},
    {"cod": "M8",  "area": "matematica", "tema": "Zoom en la recta",
     "dc": "Densidad y orden de fracciones y decimales en la recta numérica",
     "cubre": "densidad_recta_6"},
    {"cod": "M8b", "area": "matematica", "tema": "Suma y resta de fracciones",
     "dc": "Suma y resta con distinto denominador (el nodal más difícil de 6°)",
     "cubre": "suma_fracciones_6"},
    {"cod": "M9",  "area": "matematica", "tema": "Parejas que dan 1",
     "dc": "Fracción inversa: el producto de una fracción por su inversa da 1",
     "cubre": "fraccion_inversa_6"},
    {"cod": "M10", "area": "matematica", "tema": "Área fraccionaria",
     "dc": "Multiplicación de fracciones interpretada como área",
     "cubre": "area_fraccionaria_6"},
    {"cod": "M11", "area": "matematica", "tema": "Corredor de la coma",
     "dc": "Multiplicar y dividir por la unidad seguida de ceros; valor posicional decimal",
     "cubre": "corredor_coma_6"},
    {"cod": "M12", "area": "matematica", "tema": "Multiplicar con coma",
     "dc": "Multiplicación de decimales; cociente decimal",
     "cubre": "multiplicar_coma_6"},
    {"cod": "M13", "area": "matematica", "tema": "La tienda de descuentos",
     "dc": "Descuentos y aumentos, incluso sucesivos; elegir la oferta conveniente",
     "cubre": "descuentos_6"},
    {"cod": "M13b","area": "matematica", "tema": "Porcentaje de una cantidad",
     "dc": "Cálculo del porcentaje de una cantidad",
     "cubre": "porcentaje_cantidad_6"},
    {"cod": "M14", "area": "matematica", "tema": "Proporcionalidad aplicada",
     "dc": "Proporcionalidad directa; escalas; constante de proporcionalidad",
     "cubre": "proporcionalidad_6"},
    {"cod": "M15a","area": "matematica", "tema": "Cuadriláteros y ángulos",
     "dc": "Mediatriz; paralelogramos; suma de ángulos interiores de un cuadrilátero",
     "cubre": "cuadrilateros_6"},
    {"cod": "M15b","area": "matematica", "tema": "Cuerpos y desarrollos",
     "dc": "Desarrollo plano de prismas, cilindros y conos; elementos de los cuerpos",
     "cubre": "desarrollos_6"},
    {"cod": "M16", "area": "matematica", "tema": "Mismo área, otro borde",
     "dc": "Independencia entre área y perímetro; fórmulas; equivalencias m²↔cm²",
     "cubre": "area_perimetro_6"},
    {"cod": "M17", "area": "matematica", "tema": "La moda de la encuesta",
     "dc": "Frecuencia absoluta y relativa; gráficos; moda",
     "cubre": "moda_encuesta_6"},
    {"cod": "M18", "area": "matematica", "tema": "¿Seguro, posible o imposible?",
     "dc": "Sucesos seguros, posibles e imposibles (nodal nuevo de 6°)",
     "cubre": "probabilidad_6"},
    {"cod": "Mprob","area": "matematica", "tema": "Resolvé el problema",
     "dc": "Problemas de varios pasos; decidir qué operación resuelve",
     "cubre": "problemas_varios_pasos_6"},

    # ── Lengua (16) ──────────────────────────────────────────────────────────────
    {"cod": "L0",  "area": "lengua", "tema": "Leé y respondé",
     "dc": "Comprensión lectora: literal, inferencial y predictiva",
     "cubre": "comprension_lectora_6"},
    {"cod": "L0b", "area": "lengua", "tema": "Idea principal y cuadro sinóptico",
     "dc": "Técnicas de estudio: idea central y jerarquización de la información",
     "cubre": "idea_principal_6"},
    {"cod": "L1",  "area": "lengua", "tema": "Anatomía de la noticia",
     "dc": "Partes de la noticia; la crónica periodística",
     "cubre": "noticia_partes_6"},
    {"cod": "L2",  "area": "lengua", "tema": "Resolvé el caso",
     "dc": "Relato policial: enigma, pistas, hipótesis y resolución",
     "cubre": "relato_policial_6"},
    {"cod": "L3",  "area": "lengua", "tema": "Bestiario de la ciencia ficción",
     "dc": "Ciencia ficción: robot, androide, cyborg, científico",
     "cubre": "ciencia_ficcion_6"},
    {"cod": "L4",  "area": "lengua", "tema": "¿Fuente confiable?",
     "dc": "Evaluación de fuentes; dominios; hecho verificable vs opinión fundamentada",
     "cubre": "fuente_confiable_6"},
    {"cod": "L5",  "area": "lengua", "tema": "Del directo al indirecto",
     "dc": "Discurso directo e indirecto; biografía y autobiografía",
     "cubre": "directo_indirecto_6"},
    {"cod": "L6",  "area": "lengua", "tema": "Clasificá pronombres",
     "dc": "Pronombres personales, posesivos, demostrativos e indefinidos",
     "cubre": "pronombres_6"},
    {"cod": "L7a", "area": "lengua", "tema": "Radiografía de la oración",
     "dc": "Sintagma nominal y verbal; núcleo, especificador y modificadores",
     "cubre": "sintagma_6"},
    {"cod": "L7b", "area": "lengua", "tema": "OD, OI y transitividad",
     "dc": "Objeto directo e indirecto; complementos vs adjuntos; verbos transitivos",
     "cubre": "od_oi_6"},
    {"cod": "L8",  "area": "lengua", "tema": "Conectores en acción",
     "dc": "Conectores temporales, locativos, causales-consecutivos y de síntesis",
     "cubre": "conectores_6"},
    {"cod": "L9",  "area": "lengua", "tema": "Basta de repetir",
     "dc": "Cohesión léxica: sinónimo, hiperónimo y referencia pronominal",
     "cubre": "cohesion_6"},
    {"cod": "L10", "area": "lengua", "tema": "Sonidos del poema",
     "dc": "Aliteración, onomatopeya, personificación, comparación e hipérbole",
     "cubre": "recursos_poeticos_6"},
    {"cod": "L11", "area": "lengua", "tema": "Conjugá el verbo",
     "dc": "Conjugación del modo indicativo; imperfecto vs perfecto simple",
     "cubre": "conjugacion_6"},
    {"cod": "L12a","area": "lengua", "tema": "Tildes rebeldes",
     "dc": "Acentuación completa: reglas generales, tilde diacrítica, -mente e hiato",
     "cubre": "tildes_6"},
    {"cod": "L12b","area": "lengua", "tema": "Puntuación fina",
     "dc": "Coma, punto, paréntesis, comillas y puntos suspensivos",
     "cubre": "puntuacion_6"},

    # ── Ciencias Naturales (11) ──────────────────────────────────────────────────
    {"cod": "N1",  "area": "naturales", "tema": "Armá la red del ecosistema",
     "dc": "Autótrofos y heterótrofos; el ecosistema como sistema abierto",
     "cubre": "red_ecosistema_6"},
    {"cod": "N2",  "area": "naturales", "tema": "Roles y niveles",
     "dc": "Productores, consumidores y descomponedores; especie, población y comunidad",
     "cubre": "roles_niveles_6"},
    {"cod": "N3",  "area": "naturales", "tema": "Ecorregiones de Buenos Aires",
     "dc": "Pampa, Espinal, Delta e islas: ambientes y especies",
     "cubre": "ecorregiones_6"},
    {"cod": "N4",  "area": "naturales", "tema": "Línea de la vida y la pubertad ⚠ESI",
     "dc": "Etapas de la vida; pubertad y hormonas; variabilidad individual (ESI)",
     "cubre": "pubertad_6"},
    {"cod": "N5",  "area": "naturales", "tema": "El ciclo menstrual y los mitos ⚠ESI",
     "dc": "Ovulación y menstruación; refutación de creencias erróneas (ESI)",
     "cubre": "ciclo_menstrual_6"},
    {"cod": "N6",  "area": "naturales", "tema": "Del cigoto al feto ⚠ESI",
     "dc": "Fecundación; cigoto, embrión y feto; métodos anticonceptivos e ITS (ESI)",
     "cubre": "cigoto_feto_6"},
    {"cod": "N7",  "area": "naturales", "tema": "Estados, partículas y calor",
     "dc": "Modelo de partículas; el calor en tránsito; equilibrio térmico",
     "cubre": "particulas_calor_6"},
    {"cod": "N8",  "area": "naturales", "tema": "Elegí el material térmico",
     "dc": "Conductividad térmica, dilatación y usos de los materiales",
     "cubre": "material_termico_6"},
    {"cod": "N9",  "area": "naturales", "tema": "Del geocentrismo al heliocentrismo",
     "dc": "Modelos geo y heliocéntrico; el sistema solar y sus escalas",
     "cubre": "heliocentrismo_6"},
    {"cod": "N10a","area": "naturales", "tema": "Tiempo vs. clima",
     "dc": "Variables meteorológicas; diferencia entre tiempo y clima",
     "cubre": "tiempo_clima_6"},
    {"cod": "N10b","area": "naturales", "tema": "Efecto invernadero",
     "dc": "Gases de efecto invernadero; procesos directos e indirectos; mitigación",
     "cubre": "efecto_invernadero_6"},

    # ── Ciencias Sociales (10) ───────────────────────────────────────────────────
    {"cod": "S1",  "area": "sociales", "tema": "Línea de tiempo 1862-1930",
     "dc": "Unificación 1862, federalización 1880, Ley 1420, Sáenz Peña 1912, 1916, 1930",
     "cubre": "linea_tiempo_1862_1930_6"},
    {"cod": "S2",  "area": "sociales", "tema": "¿1ª o 2ª Revolución Industrial?",
     "dc": "Vapor vs petróleo y electricidad; países centrales y periféricos",
     "cubre": "revolucion_industrial_6"},
    {"cod": "S3",  "area": "sociales", "tema": "Estado y agroexportación",
     "dc": "Mitre, Sarmiento y Avellaneda; modelo agroexportador; ferrocarril y puerto",
     "cubre": "estado_agroexportacion_6"},
    {"cod": "S4",  "area": "sociales", "tema": "Inmigración: censos y conventillo",
     "dc": "Inmigración ultramarina; lectura de censos; conventillo; Ley 1420",
     "cubre": "inmigracion_censos_6"},
    {"cod": "S5",  "area": "sociales", "tema": "El voto antes y después",
     "dc": "Ley Sáenz Peña 1912; gobiernos radicales; golpe de 1930",
     "cubre": "voto_6"},
    {"cod": "S6",  "area": "sociales", "tema": "La Gran Guerra y la crisis del '29",
     "dc": "Primera Guerra Mundial; crisis de 1929 y su impacto en la Argentina",
     "cubre": "gran_guerra_crisis_6"},
    {"cod": "S7",  "area": "sociales", "tema": "Mercosur y la energía que viaja",
     "dc": "Integración regional; grandes instalaciones de energía",
     "cubre": "mercosur_energia_6"},
    {"cod": "S8a", "area": "sociales", "tema": "Demografía en gráficos",
     "dc": "Natalidad, mortalidad y esperanza de vida; censos y su lectura",
     "cubre": "demografia_6"},
    {"cod": "S8b", "area": "sociales", "tema": "Escalas ambientales",
     "dc": "Escala local, regional y global; mitigación del riesgo",
     "cubre": "escalas_ambientales_6"},
    {"cod": "S9",  "area": "sociales", "tema": "Mi Buenos Aires querido",
     "dc": "Patrimonio porteño: tango, fileteado, Obelisco, subte A, Reserva, Mataderos",
     "cubre": "buenos_aires_6"},
...
# ── 7° grado ────────────────────────────────────────────────────────────────────
# Fuente: docs/auditoria-dc-caba/grado-7.md § "Mapa propuesto del año" — 68 temas
# (16 Matemática · 15 Lengua · 11 Naturales · 9 Sociales · 6 Tecnología ·
# 8 transversales · 3 Inglés).
#
# DECISIÓN sobre INGLÉS (26-jul): la auditoría lo suma como área nueva, pero el menú
# tiene SEIS carriles y están fijos. Abrir un séptimo cambiaría la pantalla de
# categorías de los siete grados por tres actividades de uno solo, así que Inglés
# entra en el carril de Lengua. Es reversible: el área real queda escrita en `dc`.
# La auditoría pide además audio de fonética para IN1/IN2; eso queda pendiente.
#
# ⚠ CN11, X1 y X2 son ESI, y CS1-CS3 tocan terrorismo de Estado y DDHH: todo ese
# bloque necesita revisión docente antes de salir a la venta.
GRADO_7 = [
    # ── Matemática (16) ──────────────────────────────────────────────────────────
    {"cod": "M0",  "area": "matematica", "tema": "Número y sistema de numeración",
     "dc": "Valor posicional, descomposición polinómica y sistema sexagesimal",
     "cubre": "numeracion_7"},
    {"cod": "M1",  "area": "matematica", "tema": "Potencias y raíces, ida y vuelta",
     "dc": "Potenciación y raíz cuadrada; reversibilidad entre las dos",
     "cubre": "potencias_7"},
    {"cod": "M2",  "area": "matematica", "tema": "Tribunal de divisibilidad",
     "dc": "Criterios por 3, 4, 6, 8 y 9: análisis y fundamentación",
     "cubre": "divisibilidad_7"},
    {"cod": "M3",  "area": "matematica", "tema": "Múltiplo y divisor común",
     "dc": "Mínimo común múltiplo y divisor común mayor en problemas",
     "cubre": "mcm_dcm_7"},
    {"cod": "M4",  "area": "matematica", "tema": "Expresión objetivo",
     "dc": "Cálculos combinados; jerarquía; propiedades de las operaciones",
     "cubre": "expresion_objetivo_7"},
    {"cod": "M5",  "area": "matematica", "tema": "Multiplicar y dividir fracciones",
     "dc": "Multiplicación y división de fracciones; la fracción inversa",
     "cubre": "multiplicar_fracciones_7"},
    {"cod": "M5b", "area": "matematica", "tema": "Problemas de varios pasos",
     "dc": "Problemas de varios pasos; tratamiento de la información del enunciado",
     "cubre": "problemas_pasos_7"},
    {"cod": "M6",  "area": "matematica", "tema": "Decimales y el período escondido",
     "dc": "Multiplicación y división de decimales; expresiones periódicas",
     "cubre": "decimales_periodo_7"},
    {"cod": "M7",  "area": "matematica", "tema": "Zoom infinito: la densidad",
     "dc": "Densidad de los racionales; orden con reglas distintas de los naturales",
     "cubre": "densidad_7"},
    {"cod": "M8",  "area": "matematica", "tema": "Fracción como razón y porcentaje",
     "dc": "Razón; uso de los racionales para expresar porcentajes",
     "cubre": "razon_porcentaje_7"},
    {"cod": "M9",  "area": "matematica", "tema": "Proporcionalidad directa en el plano",
     "dc": "Representación cartesiana de la proporcionalidad directa",
     "cubre": "proporcionalidad_grafico_7"},
    {"cod": "M10", "area": "matematica", "tema": "Proporcionalidad inversa",
     "dc": "Proporcionalidad inversa; distinguirla de la directa y de lo no proporcional",
     "cubre": "proporcionalidad_inversa_7"},
    {"cod": "M11", "area": "matematica", "tema": "Áreas, círculo y perímetro-área",
     "dc": "Área de paralelogramo, trapecio y romboide; perímetro y área del círculo",
     "cubre": "areas_7"},
    {"cod": "M12", "area": "matematica", "tema": "¿Moda, mediana o media?",
     "dc": "Moda, mediana y media; cuál es pertinente según la situación",
     "cubre": "media_mediana_moda_7"},
    {"cod": "M13", "area": "matematica", "tema": "Árbol de la probabilidad",
     "dc": "Diagramas de árbol; equiprobabilidad; casos favorables y posibles",
     "cubre": "probabilidad_arbol_7"},
    {"cod": "M14", "area": "matematica", "tema": "Traductor algebraico",
     "dc": "Expresiones con y sin letras; traducir un enunciado a una expresión",
     "cubre": "traductor_algebraico_7"},

    # ── Lengua (15) ──────────────────────────────────────────────────────────────
    {"cod": "L1",  "area": "lengua", "tema": "¿Fantástico, maravilloso o terror?",
     "dc": "Los subgéneros narrativos como clave de lectura",
     "cubre": "subgeneros_7"},
    {"cod": "L2",  "area": "lengua", "tema": "¿Qué narrador habla?",
     "dc": "Tipos de narrador; voces que se alternan; transformación de 1ª a 3ª",
     "cubre": "narrador_7"},
    {"cod": "L3",  "area": "lengua", "tema": "Tres modos, un verbo",
     "dc": "Modos indicativo, subjuntivo e imperativo",
     "cubre": "modos_verbales_7"},
    {"cod": "L4",  "area": "lengua", "tema": "Clasificador de sustantivos",
     "dc": "Individual/colectivo, abstracto/concreto, contable/incontable",
     "cubre": "sustantivos_7"},
    {"cod": "L5",  "area": "lengua", "tema": "¿Quién es el sujeto?",
     "dc": "Sujeto expreso y tácito; oraciones impersonales; sujeto compuesto",
     "cubre": "sujeto_7"},
    {"cod": "L6",  "area": "lengua", "tema": "Metáfora o sinécdoque",
     "dc": "Metáfora y sinécdoque; el yo poético no es el autor",
     "cubre": "metafora_sinecdoque_7"},
    {"cod": "L7",  "area": "lengua", "tema": "Hecho, opinión o argumento",
     "dc": "Distinguir hecho verificable, opinión y argumento",
     "cubre": "hecho_opinion_argumento_7"},
    {"cod": "L8",  "area": "lengua", "tema": "Recursos del argumentador",
     "dc": "Cita de autoridad, ejemplificación, contraejemplo y generalización",
     "cubre": "recursos_argumentador_7"},
    {"cod": "L9",  "area": "lengua", "tema": "Detector de persuasión",
     "dc": "Recursos de persuasión de la publicidad; verbal y visual",
     "cubre": "persuasion_7"},
    {"cod": "L10", "area": "lengua", "tema": "De la noticia a la crónica",
     "dc": "La crónica policial; discurso directo e indirecto",
     "cubre": "cronica_7"},
    {"cod": "L11", "area": "lengua", "tema": "Armá tu historieta",
     "dc": "Historieta: viñeta, globo, onomatopeya y guion",
     "cubre": "historieta_7"},
    {"cod": "L12", "area": "lengua", "tema": "Corregí el error y la ambigüedad",
     "dc": "Problemas usuales del uso; ambigüedad sintáctica",
     "cubre": "ambiguedad_7"},
    {"cod": "L13", "area": "lengua", "tema": "Análisis sintáctico completo",
     "dc": "Sujeto y predicado, núcleos, modificadores, OD, OI y predicativo",
     "cubre": "analisis_sintactico_7"},
    {"cod": "L14", "area": "lengua", "tema": "Cazador de errores de ortografía",
     "dc": "Tildación; reglas de b/v, g/j y h; homófonos",
     "cubre": "ortografia_7"},
    {"cod": "L15", "area": "lengua", "tema": "Leé y deducí",
     "dc": "Comprensión de texto largo con inferencia e intención del autor",
     "cubre": "leer_deducir_7"},

    # ── Ciencias Naturales (11) ──────────────────────────────────────────────────
    {"cod": "CN1", "area": "naturales", "tema": "Constructor de redes tróficas",
     "dc": "Cadenas y redes tróficas; roles en el ecosistema",
     "cubre": "redes_troficas_7"},
    {"cod": "CN2", "area": "naturales", "tema": "Flujo de energía y reciclaje",
     "dc": "Flujo de energía; la energía disminuye en cada nivel trófico",
     "cubre": "flujo_energia_7"},
    {"cod": "CN3", "area": "naturales", "tema": "Sucesión ecológica",
     "dc": "Sucesión tras un disturbio; efecto en cascada de una especie",
     "cubre": "sucesion_ecologica_7"},
    {"cod": "CN4", "area": "naturales", "tema": "Camino del estímulo",
     "dc": "Sentidos y sistema nervioso; central y periférico; efectos del alcohol",
     "cubre": "sistema_nervioso_7"},
    {"cod": "CN5", "area": "naturales", "tema": "Barreras y defensas",
     "dc": "Defensa inespecífica y específica; respuesta primaria y secundaria",
     "cubre": "inmune_7"},
    {"cod": "CN6", "area": "naturales", "tema": "Cómo actúa una vacuna",
     "dc": "Acción de las vacunas; calendario; protección colectiva",
     "cubre": "vacunas_7"},
    {"cod": "CN7", "area": "naturales", "tema": "Transformá la energía",
     "dc": "Transformación, conservación y degradación de la energía",
     "cubre": "transformar_energia_7"},
    {"cod": "CN8", "area": "naturales", "tema": "Química o física",
     "dc": "Transformaciones químicas y físicas; reactivos y productos; combustión",
     "cubre": "quimica_fisica_7"},
    {"cod": "CN9", "area": "naturales", "tema": "Día, noche, estaciones y fases",
     "dc": "Rotación y traslación; eje inclinado; fases lunares",
     "cubre": "movimientos_tierra_7"},
    {"cod": "CN10","area": "naturales", "tema": "Eclipses y el mapa del universo",
     "dc": "Eclipses; escalas; modelo actual del universo y exoplanetas",
     "cubre": "eclipses_universo_7"},
    {"cod": "CN11","area": "naturales", "tema": "Sistema reproductor ⚠ESI",
     "dc": "Anatomía y función del sistema reproductor (ESI)",
     "cubre": "reproductor_7"},

    # ── Ciencias Sociales (9) ────────────────────────────────────────────────────
    {"cod": "CS1", "area": "sociales", "tema": "Línea de tiempo del siglo XX argentino",
     "dc": "1930, sustitución de importaciones, peronismo, 1976, Malvinas, 1983",
     "cubre": "linea_siglo_xx_7"},
    {"cod": "CS2", "area": "sociales", "tema": "Bandos: Segunda Guerra y Guerra Fría",
     "dc": "Aliados y Eje; el mundo bipolar de la Guerra Fría",
     "cubre": "bandos_siglo_xx_7"},
    {"cod": "CS3", "area": "sociales", "tema": "¿Democracia o dictadura? ⚠",
     "dc": "Alternancia de democracias y dictaduras; terrorismo de Estado; DDHH",
     "cubre": "democracia_dictadura_7"},
    {"cod": "CS4", "area": "sociales", "tema": "Cadena productiva y producciones regionales",
     "dc": "Encadenamientos agroindustriales; producciones por región",
     "cubre": "cadena_productiva_7"},
    {"cod": "CS5", "area": "sociales", "tema": "Flujos migratorios",
     "dc": "Migraciones forzadas y voluntarias; áreas expulsoras y receptoras",
     "cubre": "migraciones_7"},
    {"cod": "CS6", "area": "sociales", "tema": "Espacios de memoria porteños ⚠",
     "dc": "Parque de la Memoria, ex ESMA, Museo del Holocausto, Museo Malvinas",
     "cubre": "espacios_memoria_7"},
    {"cod": "CS7", "area": "matematica", "tema": "Mi primera billetera",
     "dc": "Sociales/FEC: ahorro, deuda e inversión; medios de pago; interés simple",
     "cubre": "billetera_7"},
    {"cod": "CS8", "area": "sociales", "tema": "Puerto Madero y el arte urbano",
     "dc": "Refuncionalización urbana; murales, grafitis e intervenciones",
     "cubre": "puerto_madero_7"},
    {"cod": "CS9", "area": "sociales", "tema": "La comunicación en el tiempo",
     "dc": "Avance de las tecnologías de comunicación; la historieta argentina",
     "cubre": "comunicacion_tiempo_7"},
    ...
    {"cod": "IN1", "area": "lengua", "tema": "Vocabulario en inglés",
     ...
     "cubre": "ingles_vocabulario_7"},
    {"cod": "IN2", "area": "lengua", "tema": "Verbos: presente y pasado en inglés",
     "dc": "Inglés: present simple, past simple y verbos irregulares",
     "cubre": "ingles_verbos_7"},
    {"cod": "IN3", "area": "lengua", "tema": "Leé en inglés",
     "dc": "Inglés: comprensión lectora en lengua extranjera",
     "cubre": "ingles_lectura_7"},
]
