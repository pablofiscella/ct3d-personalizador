...
VIDEO_PENDIENTE = {
    ...
    "recursos_poeticos_5",     "futuro_condicional_5",     "estructura_textos_5", "opinion_argumento_5",     "problemas_pasos_5",             "mapa_america_5", "variables_5", "sensores_5", "phishing_5", "presupuesto_5",
