...
CATALOGO = [
    ...
    # ── CIENCIAS NATURALES de 6° ─────────────────────────────────────────────────
    # ⚠ N4, N5 y N6 son contenido de ESI (Ley 26.150). El manifiesto los marca para
    # revisión docente y el producto tiene que avisarle a la familia antes de que el
    # chico se encuentre con «ciclo menstrual» sin aviso (pedido de la maestra en la
    # auditoría). Se escriben con lenguaje preciso y sin eufemismos: nombrar bien es
    # parte del contenido.
    {
        "id": "red_ecosistema_6", "grado": 6, "area": "naturales",
        "titulo": "Armá la red del ecosistema", "icono": "🌿",
        "mecanica": "trivia",
        "consigna": "Pensá quién fabrica su alimento y quién lo toma de otro.",
        "explica": "Los autótrofos se fabrican el alimento; los heterótrofos lo consiguen comiendo.",
        "dc": "Autótrofos y heterótrofos; el ecosistema como sistema abierto",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · N1",
        "saber": {"id": "NAT-6-ecosistema", "nombre": "Autótrofos, heterótrofos y ecosistema",
                  "prereqs": []},
        "banco": [
            {"q": "¿Qué es un organismo autótrofo?", "ops": ["El que fabrica su propio alimento",
                     "El que come plantas", "El que descompone restos"],
             "m": "«Auto» es por sí mismo y «trofo» es alimento."},
            {"q": "¿Cuál de estos es autótrofo?", "ops": ["El helecho", "El hongo", "La lombriz"],
             "m": "Los hongos no hacen fotosíntesis: absorben materia ya elaborada."},
            {"q": "¿De dónde sacan la energía las plantas?", "ops": ["De la luz del sol",
                     "Del suelo", "Del agua de lluvia"],
            ...
            {"q": "¿Por qué se dice que un ecosistema es un sistema ABIERTO?",
             "ops": ["Porque intercambia materia y energía con el afuera",
                     "Porque no tiene límites definidos", "Porque cualquiera puede entrar"],
            ...
            {"q": "¿Qué pasa si desaparecen todos los productores de un ecosistema?",
             "ops": ["Se corta la entrada de energía y colapsa toda la red",
                     "Sólo se afectan los herbívoros", "No pasa nada, se reacomoda"],
             "m": "Los productores son la puerta de entrada de la energía a la red."},
            {"q": "¿Qué es una red alimentaria?",
             "ops": ["El conjunto de cadenas alimentarias entrelazadas de un ecosistema",
                     "Una sola cadena de tres eslabones", "El lugar donde comen los animales"],
             "m": "Una cadena es una línea; la red muestra que casi todos comen de varios."},
            {"q": "En una cadena, ¿hacia dónde va la flecha?",
             "ops": ["Hacia quien recibe la energía, o sea quien come",
                     "Hacia quien es comido", "En los dos sentidos"],
             "m": "La flecha indica el sentido en que fluye la energía."},
            {"q": "¿Qué le pasa a la energía a medida que sube por la cadena?",
             "ops": ["Se va perdiendo en cada eslabón", "Se multiplica", "Se mantiene igual"],
             "m": "Por eso hay muchas más plantas que grandes carnívoros."},
            {"q": "¿Los hongos son plantas?", "ops": ["No, forman un reino aparte",
                     "Sí, son plantas sin clorofila", "Sí, porque no se mueven"],
             "m": "No hacen fotosíntesis, y por eso no son plantas aunque no se muevan."},
            {"q": "¿Qué es la fotosíntesis?", "ops": ["El proceso por el que la planta fabrica alimento con la luz",
                     "La respiración de la planta", "La forma en que la planta toma agua"],
            ...
            {"q": "En un acuario cerrado herméticamente, ¿qué falta para que sea un sistema abierto?",
             "ops": ["El intercambio de materia con el exterior", "Los peces", "El agua"],
            ...
            {"q": "¿Qué organismo devuelve al suelo los nutrientes de los restos?",
             "ops": ["Los descomponedores", "Los productores", "Los carnívoros"],
             "m": "Sin ellos los nutrientes quedarían atrapados en la materia muerta."},
            {"q": "El fitoplancton del mar, ¿qué papel cumple?",
             "ops": ["Es productor: hace fotosíntesis", "Es consumidor", "Es descomponedor"],
             "m": "Es la base de casi toda la red alimentaria marina."},
            {"q": "¿Un ecosistema incluye sólo a los seres vivos?",
             "ops": ["No, también el agua, el suelo, el aire y la temperatura",
                     "Sí, sólo los seres vivos", "Sólo los animales"],
             "m": "Los factores no vivos son parte del ecosistema y condicionan quién puede vivir ahí."},
            {"q": "¿La ciudad es un ecosistema?", "ops": ["Sí, un ecosistema antrópico",
                     "No, porque la hicieron las personas", "Sólo las plazas lo son"],
             "m": "Tiene seres vivos, factores no vivos y flujo de materia y energía; lo particular es que lo modela la actividad humana."},
        ],
    },
    {
        "id": "roles_niveles_6", "grado": 6, "area": "naturales",
        "titulo": "Roles y niveles", "icono": "🍃",
        "mecanica": "clasificar",
        "consigna": "¿Qué papel cumple en la red?",
        "explica": "Productor fabrica, consumidor come, descomponedor recicla.",
        "categorias": [{"cat": "productor", "label": "🌱 Productor"},
                       {"cat": "consumidor", "label": "🦌 Consumidor"},
                       {"cat": "descomponedor", "label": "🍄 Descomponedor"}],
        "dc": "Productores, consumidores y descomponedores; especie, población y comunidad",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · N2",
        "saber": {"id": "NAT-6-roles", "nombre": "Roles en la red alimentaria",
                  "prereqs": ["NAT-6-ecosistema"]},
        "banco": [
            {"it": "El pasto de la pampa", "cat": "productor", "m": "Hace fotosíntesis: fabrica su alimento."},
            {"it": "La vaca", "cat": "consumidor", "m": "Come pasto: obtiene la energía de otro ser vivo."},
            {"it": "El hongo que crece en un tronco caído", "cat": "descomponedor",
             "m": "Descompone la materia muerta y devuelve los nutrientes al suelo."},
            {"it": "El ombú", "cat": "productor", "m": "Es un árbol: produce su propio alimento."},
            {"it": "El puma", "cat": "consumidor", "m": "Carnívoro: consumidor de segundo o tercer orden."},
            {"it": "Las bacterias del suelo", "cat": "descomponedor",
             "m": "Junto con los hongos cierran el ciclo de la materia."},
            {"it": "El fitoplancton", "cat": "productor", "m": "Microscópico, pero hace fotosíntesis."},
            {"it": "El hornero", "cat": "consumidor", "m": "Come insectos: obtiene energía de otros seres vivos."},
            {"it": "La lombriz que come hojas en descomposición", "cat": "descomponedor",
             "m": "Fragmenta la materia muerta y la devuelve al suelo."},
            {"it": "El junco del delta", "cat": "productor", "m": "Planta acuática que hace fotosíntesis."},
            {"it": "El carpincho", "cat": "consumidor", "m": "Herbívoro: consumidor de primer orden."},
            {"it": "El moho del pan", "cat": "descomponedor", "m": "Un hongo que se alimenta de materia ya elaborada."},
            {"it": "El alga verde de la laguna", "cat": "productor", "m": "Tiene clorofila: produce."},
            {"it": "El zorro gris", "cat": "consumidor", "m": "Come otros animales y también frutos."},
            {"it": "El carancho que come restos", "cat": "consumidor",
             "m": "Es carroñero, pero sigue siendo consumidor: no descompone la materia a nivel químico."},
            {"it": "El trébol", "cat": "productor", "m": "Planta: base de la cadena."},
            {"it": "La mulita", "cat": "consumidor", "m": "Come insectos y raíces."},
            {"it": "Las bacterias que actúan sobre un animal muerto", "cat": "descomponedor",
             "m": "Transforman la materia orgánica en nutrientes disponibles."},
        ],
    },
    {
        "id": "ecorregiones_6", "grado": 6, "area": "naturales",
        "titulo": "Ecorregiones de Buenos Aires", "icono": "🗺️",
        "mecanica": "clasificar",
        "consigna": "¿De qué ambiente es?",
        "explica": "Pampa de pastizal, Espinal de bosque bajo, Delta de islas y agua.",
        "categorias": [{"cat": "pampa", "label": "🌾 Pampa"},
                       {"cat": "espinal", "label": "🌳 Espinal"},
                       {"cat": "delta", "label": "🏝️ Delta e islas"}],
        "dc": "Pampa, Espinal, Delta e islas: ambientes y especies",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · N3",
        "saber": {"id": "NAT-6-ecorregiones", "nombre": "Ecorregiones bonaerenses",
                  "prereqs": ["NAT-6-roles"]},
        "banco": [
            {"it": "Pastizal sin árboles hasta donde llega la vista", "cat": "pampa",
             "m": "El pastizal abierto es la marca de la pampa."},
            {"it": "Bosque bajo de ñandubay y algarrobo", "cat": "espinal",
             "m": "El espinal es un bosque de árboles bajos y espinosos."},
            {"it": "Islas bajas que se inundan con la marea", "cat": "delta",
             "m": "El delta se define por el agua que entra y sale."},
            {"it": "El venado de las pampas", "cat": "pampa", "m": "Su nombre lo dice: es del pastizal."},
            {"it": "El caldén", "cat": "espinal", "m": "Árbol característico del bosque de espinal."},
            {"it": "El junco y el ceibo", "cat": "delta", "m": "Plantas de ribera y humedal."},
            {"it": "El ñandú", "cat": "pampa", "m": "Ave corredora del pastizal abierto."},
            {"it": "Suelo con espinillos y talas", "cat": "espinal",
             "m": "Los árboles espinosos son la firma del espinal."},
            {"it": "El carpincho entre los camalotes", "cat": "delta",
             "m": "Vive asociado al agua y a la vegetación flotante."},
            {"it": "La vizcacha en su vizcachera", "cat": "pampa",
             "m": "Cava sus cuevas en el suelo del pastizal."},
            {"it": "Algarrobo blanco dando sombra a un pastizal ralo", "cat": "espinal",
             "m": "Es la transición entre el bosque y el pastizal."},
            {"it": "El ciervo de los pantanos", "cat": "delta",
             "m": "Vive en humedales: su nombre lo indica."},
            {"it": "El chimango sobrevolando el campo abierto", "cat": "pampa",
             "m": "Ave de campos abiertos y cultivos."},
            {"it": "Bosque abierto de tala en las barrancas", "cat": "espinal",
             "m": "El talar es una formación típica del espinal bonaerense."},
            {"it": "El lobito de río", "cat": "delta", "m": "Necesita cursos de agua para vivir."},
            {"it": "Suelo profundo y fértil, ideal para la agricultura", "cat": "pampa",
             "m": "Justamente por ese suelo la pampa se transformó tanto."},
            {"it": "El ñandubay resistiendo la sequía", "cat": "espinal",
             "m": "Los árboles del espinal toleran suelos pobres y sequía."},
            {"it": "Sauces y alisos en la orilla del río", "cat": "delta",
             "m": "Vegetación de ribera del sistema deltaico."},
        ],
    },
    {
        "id": "pubertad_6", "grado": 6, "area": "naturales",
        "titulo": "Línea de la vida y la pubertad", "icono": "🌱",
        "mecanica": "trivia",
        "consigna": "Pensá en los cambios y en su tiempo.",
        "explica": "La pubertad llega a distinta edad en cada persona, y todos los ritmos son normales.",
        "dc": "Etapas de la vida; pubertad y hormonas; variabilidad individual (ESI)",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · N4",
        "saber": {"id": "NAT-6-pubertad", "nombre": "Pubertad y etapas de la vida",
                  "prereqs": []},
        "banco": [
            {"q": "¿Qué es la pubertad?", "ops": ["La etapa de cambios que prepara al cuerpo para la reproducción",
                     "El momento en que se termina de crecer", "Una enfermedad pasajera"],
             "m": "Es una etapa normal del desarrollo, no un problema de salud."},
            {"q": "¿Qué son las hormonas?", "ops": ["Sustancias que el cuerpo produce y que ordenan los cambios",
                     "Células de la sangre", "Alimentos que hay que consumir"],
             "m": "Viajan por la sangre y funcionan como mensajeros químicos."},
            {"q": "¿Todos los chicos empiezan la pubertad a la misma edad?",
             "ops": ["No, cada persona tiene su ritmo", "Sí, todos a los 12",
            ...
            {"q": "¿Cuáles son las etapas de la vida en orden?",
             "ops": ["Infancia, pubertad, adolescencia, adultez, vejez",
            ...
            {"q": "¿Qué diferencia hay entre pubertad y adolescencia?",
             "ops": ["La pubertad son los cambios del cuerpo; la adolescencia incluye lo emocional y social",
                     "Son exactamente lo mismo", "La adolescencia viene antes"],
             "m": "Una es biológica; la otra es más amplia y dura más tiempo."},
            {"q": "¿Es normal transpirar más durante la pubertad?",
             "ops": ["Sí, las glándulas trabajan más", "No, indica una enfermedad",
                     "Sólo en verano"],
             "m": "Es uno de los cambios esperables de esta etapa."},
            {"q": "Durante la pubertad, ¿el cuerpo crece a un ritmo parejo?",
             "ops": ["No, hay un estirón y algunas partes crecen antes que otras",
                     "Sí, todo al mismo tiempo", "No crece, sólo cambia por dentro"],
             "m": "Que las manos o los pies crezcan primero es habitual y transitorio."},
            {"q": "¿Los cambios de la pubertad son sólo físicos?",
             "ops": ["No, también hay cambios emocionales", "Sí, sólo físicos",
                     "Sólo emocionales"],
            ...
            {"q": "¿Por qué en la pubertad puede aparecer acné?",
             "ops": ["Porque las glándulas de la piel producen más grasa",
                     "Por comer chocolate", "Por no dormir"],
             "m": "El cambio hormonal actúa sobre las glándulas de la piel."},
            {"q": "¿Cambia la voz sólo en los varones?",
             "ops": ["Cambia en todas las personas, más notoriamente en los varones",
                     "Sólo en los varones", "En nadie"],
            ...
            {"q": "¿A quién conviene consultarle las dudas sobre estos cambios?",
             "ops": ["A un adulto de confianza o a un profesional de la salud",
                     "A nadie, hay que resolverlo solo", "Sólo a los amigos"],
             "m": "Preguntar es parte del cuidado del propio cuerpo."},
            {"q": "¿La pubertad termina el crecimiento?",
             "ops": ["No, el crecimiento sigue un tiempo después", "Sí, ahí se deja de crecer",
                     "Sí, y también de cambiar"],
             "m": "El cuerpo sigue desarrollándose durante la adolescencia."},
        ],
    },
    {
        "id": "ciclo_menstrual_6", "grado": 6, "area": "naturales",
        "titulo": "El ciclo menstrual y los mitos", "icono": "🌙",
        "mecanica": "trivia",
        "consigna": "Separá lo que es cierto de lo que se dice.",
        "explica": "El ciclo es un proceso normal del cuerpo, no una enfermedad ni algo sucio.",
        "dc": "Ovulación y menstruación; refutación de creencias erróneas (ESI)",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · N5",
        "saber": {"id": "NAT-6-ciclo", "nombre": "Ciclo menstrual",
                  "prereqs": ["NAT-6-pubertad"]},
        "banco": [
            {"q": "¿Qué es la menstruación?", "ops": ["La eliminación del revestimiento del útero cuando no hubo embarazo",
                     "Una pérdida de sangre por una herida", "Una enfermedad"],
             "m": "Es un proceso normal y esperable del aparato reproductor."},
            {"q": "¿Qué es la ovulación?", "ops": ["La liberación de un óvulo por parte del ovario",
                     "El día que empieza la menstruación", "El final del ciclo"],
             "m": "Ocurre aproximadamente en la mitad del ciclo, no cuando empieza el sangrado."},
            {"q": "¿Cuánto dura en promedio un ciclo menstrual?",
             "ops": ["Alrededor de 28 días, con variaciones", "Exactamente 30 días",
                     "Una semana"],
             "m": "El promedio es 28, pero ciclos de 21 a 35 días también son normales."},
            {"q": "¿Los primeros ciclos suelen ser regulares?",
             "ops": ["No, tardan un tiempo en regularizarse", "Sí, desde el primero",
            ...
            {"q": "¿Se puede hacer deporte durante la menstruación?",
             "ops": ["Sí, no hay ninguna razón para no hacerlo", "No, hay que hacer reposo",
            ...
            {"q": "¿Se puede bañar una persona durante la menstruación?",
             "ops": ["Sí, y además es recomendable", "No, hace mal", "Sólo con agua fría"],
             "m": "La higiene es parte del cuidado, no algo a evitar."},
            {"q": "¿Menstruar es sinónimo de estar enferma?",
             "ops": ["No, es un proceso normal del cuerpo", "Sí, por eso duele",
            ...
            {"q": "¿Qué se puede hacer si hay molestias durante la menstruación?",
             "ops": ["Consultar a un adulto de confianza o a un profesional de la salud",
                     "Aguantar en silencio", "Dejar de comer"],
             "m": "Las molestias fuertes merecen consulta, no resignación."},
            {"q": "¿Qué pasa con el óvulo si no es fecundado?",
             "ops": ["Se elimina junto con el revestimiento del útero",
                     "Se queda esperando al mes siguiente", "Se transforma en otra célula"],
             "m": "Ese es justamente el contenido de la menstruación."},
        ],
    },
    {
        "id": "cigoto_feto_6", "grado": 6, "area": "naturales",
        "titulo": "Del cigoto al feto", "icono": "🤰",
        "mecanica": "trivia",
        "consigna": "Seguí el desarrollo y sus nombres.",
        "explica": "Cigoto, embrión y feto son etapas distintas del mismo desarrollo.",
        "dc": "Fecundación; cigoto, embrión y feto; métodos anticonceptivos e ITS (ESI)",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · N6",
        "saber": {"id": "NAT-6-desarrollo", "nombre": "Fecundación y desarrollo embrionario",
                  "prereqs": ["NAT-6-ciclo"]},
        "banco": [
            {"q": "¿Qué es la fecundación?", "ops": ["La unión de un óvulo y un espermatozoide",
                     "La llegada del óvulo al útero", "El comienzo de la menstruación"],
             "m": "De esa unión se forma una única célula: el cigoto."},
            {"q": "¿Cómo se llama la célula que resulta de la fecundación?",
             "ops": ["Cigoto", "Embrión", "Feto"],
             "m": "Embrión y feto son etapas posteriores, con más desarrollo."},
            {"q": "¿En qué orden van las etapas?", "ops": ["Cigoto, embrión, feto",
                     "Embrión, cigoto, feto", "Feto, embrión, cigoto"],
            ...
            {"q": "¿Qué es la implantación?", "ops": ["Cuando el embrión se fija en la pared del útero",
                     "Cuando el óvulo sale del ovario", "Cuando nace el bebé"],
             "m": "Es lo que permite que el embarazo continúe."},
            {"q": "¿Para qué sirve la placenta?", "ops": ["Para intercambiar nutrientes y oxígeno con el feto",
                     "Para proteger de los golpes solamente", "Para producir hormonas únicamente"],
             "m": "Es el órgano de intercambio entre la persona gestante y el feto."},
            {"q": "¿Qué es un método anticonceptivo?",
             "ops": ["Un método para evitar un embarazo", "Un tratamiento médico",
            ...
            {"q": "¿Qué método previene el embarazo Y las infecciones de transmisión sexual?",
             "ops": ["El preservativo", "Las pastillas anticonceptivas", "Ninguno"],
             "m": "Es el único que actúa como barrera contra las dos cosas."},
            {"q": "¿Qué son las ITS?", "ops": ["Infecciones que se transmiten en las relaciones sexuales",
                     "Enfermedades hereditarias", "Alergias de la piel"],
             "m": "Se transmiten de una persona a otra; no se heredan."},
            {"q": "¿Aproximadamente cuánto dura un embarazo?",
             "ops": ["Alrededor de 9 meses", "6 meses", "12 meses"],
             "m": "Unas 40 semanas contadas desde la última menstruación."},
            {"q": "¿A partir de qué momento se habla de feto?",
             "ops": ["Cuando ya están formados los órganos principales",
                     "Desde la fecundación", "Recién al nacer"],
             "m": "Antes de eso, mientras se están formando, se lo llama embrión."},
            {"q": "¿Las pastillas anticonceptivas protegen de las ITS?",
             "ops": ["No, sólo previenen el embarazo", "Sí, de todas",
                     "Sí, de algunas"],
             "m": "Confundir esto es un riesgo real: hace falta el preservativo."},
            {"q": "¿Con quién conviene hablar sobre estos temas?",
             "ops": ["Con un adulto de confianza o un profesional de la salud",
                     "Con nadie", "Sólo buscando en internet"],
             "m": "La información confiable viene de fuentes que se puedan preguntar y repreguntar."},
            {"q": "¿Cuántas células tiene el cigoto?", "ops": ["Una", "Dos", "Miles"],
             "m": "Es una sola célula que después empieza a dividirse."},
        ],
    },
    {
        "id": "particulas_calor_6", "grado": 6, "area": "naturales",
        "titulo": "Estados, partículas y calor", "icono": "🌡️",
        "mecanica": "trivia",
        "consigna": "Pensá qué hacen las partículas.",
        "explica": "El calor es energía que va del cuerpo más caliente al más frío, nunca al revés.",
        "dc": "Modelo de partículas; el calor en tránsito; equilibrio térmico",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · N7",
        "saber": {"id": "NAT-6-calor", "nombre": "Modelo de partículas y calor",
                  "prereqs": []},
        "banco": [
            {"q": "Según el modelo de partículas, ¿qué diferencia a un sólido de un líquido?",
             "ops": ["En el sólido las partículas están ordenadas y casi fijas",
                     "El sólido no tiene partículas", "En el sólido las partículas son más grandes"],
            ...
            {"q": "Al calentar un cuerpo, ¿qué les pasa a sus partículas?",
             "ops": ["Se mueven más rápido", "Se agrandan", "Se multiplican"],
             "m": "Las partículas no cambian de tamaño ni de cantidad: cambia su movimiento."},
            {"q": "¿Qué es el calor?", "ops": ["Energía que se transfiere de un cuerpo más caliente a uno más frío",
                     "Una sustancia que tienen los cuerpos calientes", "Lo mismo que la temperatura"],
             "m": "El calor está en tránsito: un cuerpo no «tiene» calor, lo transfiere."},
            {"q": "¿Qué es el equilibrio térmico?",
             "ops": ["Cuando dos cuerpos en contacto llegan a la misma temperatura",
                     "Cuando un cuerpo deja de tener partículas", "Cuando el calor desaparece"],
             "m": "A partir de ahí ya no hay transferencia neta de energía."},
            {"q": "Si ponés una cuchara fría en agua caliente, ¿qué pasa?",
             "ops": ["El calor va del agua a la cuchara", "El frío va de la cuchara al agua",
                     "No pasa nada"],
            ...
            {"q": "¿En qué estado están las partículas más separadas?",
             "ops": ["Gaseoso", "Sólido", "Líquido"],
             "m": "Por eso un gas ocupa todo el recipiente."},
            {"q": "¿Por qué un líquido toma la forma del recipiente?",
             "ops": ["Porque sus partículas pueden deslizarse unas sobre otras",
                     "Porque no tiene partículas", "Porque las partículas se estiran"],
             "m": "Están juntas pero no fijas: pueden moverse."},
            {"q": "¿Qué es la temperatura?", "ops": ["Una medida de cuánto se agitan las partículas",
                     "La cantidad de calor que tiene un cuerpo", "El peso del cuerpo"],
            ...
            {"q": "Una pava de agua a 90 °C y una taza a 90 °C, ¿tienen la misma temperatura?",
             "ops": ["Sí, la misma temperatura, aunque distinta energía total",
                     "No, la pava está más caliente", "No, la taza está más caliente"],
             "m": "La temperatura es la misma; lo que difiere es cuánta energía total contiene cada una."},
            {"q": "¿Qué es la fusión?", "ops": ["El pasaje de sólido a líquido",
                     "El pasaje de líquido a gas", "El pasaje de gas a líquido"],
             "m": "De líquido a gas es la vaporización; de gas a líquido, la condensación."},
            {"q": "¿Por qué se empañan los vidrios en invierno?",
             "ops": ["El vapor del aire se condensa al tocar el vidrio frío",
                     "El vidrio pierde partículas", "El agua atraviesa el vidrio"],
             "m": "Al enfriarse, el vapor pasa a líquido y se deposita."},
            {"q": "Si dejás una gaseosa fría afuera, ¿qué ocurre?",
             "ops": ["Recibe calor del ambiente hasta igualar su temperatura",
                     "Le pasa frío al ambiente", "Nada, se mantiene fría"],
             "m": "Siempre fluye energía hacia el cuerpo más frío, hasta el equilibrio."},
            {"q": "Al enfriar un gas lo suficiente, ¿qué pasa?",
             "ops": ["Sus partículas se juntan y puede pasar a líquido",
                     "Sus partículas se achican", "Desaparecen las partículas"],
             "m": "Al perder energía, el movimiento disminuye y las partículas se acercan."},
            {"q": "¿El calor y la temperatura son lo mismo?",
             "ops": ["No: el calor es energía en tránsito y la temperatura, una medida",
                     "Sí, son sinónimos", "Sí, sólo cambian las unidades"],
             "m": "Confundirlos es el error clásico del tema."},
        ],
    },
    {
        "id": "material_termico_6", "grado": 6, "area": "naturales",
        "titulo": "Elegí el material térmico", "icono": "🧤",
        "mecanica": "trivia",
        "consigna": "¿Qué material conviene?",
        "explica": "Los conductores dejan pasar el calor rápido; los aislantes lo frenan.",
        "dc": "Conductividad térmica, dilatación y usos de los materiales",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · N8",
        "saber": {"id": "NAT-6-conductividad", "nombre": "Conductores y aislantes térmicos",
                  "prereqs": ["NAT-6-calor"]},
        "banco": [
            {"q": "¿De qué conviene que sea el mango de una sartén?",
             "ops": ["De un material aislante, como plástico o madera",
                     "De metal, para que se caliente parejo", "De vidrio fino"],
             "m": "El aislante frena el paso del calor y protege la mano."},
            {"q": "¿De qué conviene que sea el fondo de una olla?",
             "ops": ["De metal, buen conductor", "De madera", "De corcho"],
             "m": "Ahí sí querés que el calor pase rápido al alimento."},
            {"q": "¿Por qué la ropa de invierno abriga?",
             "ops": ["Porque atrapa aire y frena la salida del calor del cuerpo",
                     "Porque produce calor", "Porque atrae el calor del ambiente"],
             "m": "La ropa no genera calor: reduce la pérdida del que produce el cuerpo."},
            {"q": "¿Cuál de estos es mejor conductor del calor?", "ops": ["El cobre", "La lana",
                     "El telgopor"],
             "m": "Los metales son los mejores conductores; la lana y el telgopor, aislantes."},
            {"q": "¿Por qué las conservadoras son de telgopor?",
             "ops": ["Porque es aislante y frena la entrada de calor", "Porque es liviano nada más",
                     "Porque enfría el contenido"],
             "m": "No enfría: sólo demora el calentamiento de lo que hay adentro."},
            {"q": "¿Qué es la dilatación térmica?",
             "ops": ["El aumento de tamaño de un cuerpo al calentarse", "La pérdida de calor",
                     "El cambio de estado"],
            ...
            {"q": "¿Por qué las vías del tren tienen pequeñas separaciones?",
             "ops": ["Para dejar lugar a la dilatación con el calor",
                     "Para ahorrar material", "Para que pase el agua"],
            ...
            {"q": "¿Por qué un piso de cerámica se siente más frío que uno de madera a la misma temperatura?",
             "ops": ["Porque la cerámica conduce mejor y te saca calor más rápido",
                     "Porque la cerámica está más fría", "Porque la madera produce calor"],
            ...
            {"q": "¿Para qué sirve el mango de madera de un atizador?",
             "ops": ["Para aislar la mano del calor del metal", "Para que pese menos",
                     "Para que se vea mejor"],
             "m": "La madera conduce mal el calor: por eso protege."},
            {"q": "¿Un termo mantiene el café caliente porque…?",
             "ops": ["Frena el intercambio de calor con el afuera", "Produce calor",
            ...
            {"q": "¿Qué material conviene para el asa de una plancha?",
             "ops": ["Plástico resistente al calor", "Aluminio", "Hierro"],
             "m": "Los metales conducen y quemarían la mano."},
            {"q": "¿Por qué en verano conviene ropa clara?",
             "ops": ["Porque refleja más la radiación del sol", "Porque es más liviana siempre",
            ...
            {"q": "El aire quieto, ¿es conductor o aislante?",
             "ops": ["Aislante", "Conductor", "Ninguna de las dos"],
             "m": "Por eso las prendas que atrapan aire, como el polar, abrigan tanto."},
            {"q": "¿Por qué un puente lleva juntas de dilatación?",
             "ops": ["Porque el material se expande con el calor y se contrae con el frío",
                     "Porque el material se gasta", "Para que el puente se mueva con el viento"],
    ...
    },
    {
        ...
        "saber": {"id": "NAT-6-sistema-solar", "nombre": "Modelos del sistema solar",
                  "prereqs": []},
        "banco": [
            {"q": "¿Qué sostiene el modelo geocéntrico?",
             "ops": ["Que la Tierra está en el centro y todo gira a su alrededor",
                     "Que el Sol está en el centro", "Que no hay centro"],
             "m": "«Geo» es Tierra: el nombre lo dice."},
            {"q": "¿Qué sostiene el modelo heliocéntrico?",
             "ops": ["Que el Sol está en el centro y los planetas giran alrededor",
                     "Que la Tierra está en el centro", "Que la Luna está en el centro"],
             "m": "«Helio» es Sol."},
            {"q": "¿Por qué se abandonó el modelo geocéntrico?",
             "ops": ["Porque el heliocéntrico explicaba mejor las observaciones",
                     "Porque lo prohibieron", "Porque era más difícil de calcular"],
             "m": "En ciencia un modelo se reemplaza cuando otro explica más y mejor."},
            {"q": "¿Cuántos planetas tiene el sistema solar?", "ops": ["Ocho", "Nueve", "Siete"],
            ...
            {"q": "¿Qué diferencia a los planetas rocosos de los gaseosos?",
             "ops": ["Los rocosos son más chicos y tienen superficie sólida",
                     "Los gaseosos están más cerca del Sol", "Los rocosos no tienen atmósfera"],
            ...
            {"q": "¿Qué observación de Galileo apoyó el heliocentrismo?",
             "ops": ["Que Júpiter tiene lunas girando a su alrededor",
                     "Que la Luna tiene cráteres", "Que el Sol es amarillo"],
             "m": "Si algo giraba alrededor de Júpiter, no todo giraba alrededor de la Tierra."},
            {"q": "¿Qué es una órbita?", "ops": ["El recorrido de un cuerpo alrededor de otro",
                     "La distancia al Sol", "El giro sobre su propio eje"],
             "m": "El giro sobre el eje es la rotación; la órbita es la traslación."},
            {"q": "¿Qué causa el día y la noche?", "ops": ["La rotación de la Tierra sobre su eje",
                     "La traslación alrededor del Sol", "La órbita de la Luna"],
             "m": "La traslación produce el año y las estaciones, no el día."},
            {"q": "¿Por qué desde la Tierra parece que el Sol se mueve?",
             "ops": ["Porque la que se mueve es la Tierra", "Porque el Sol gira alrededor nuestro",
            ...
            {"q": "En una maqueta a escala del sistema solar, ¿qué suele ser lo más difícil de representar?",
             "ops": ["Las distancias, porque son enormes comparadas con los tamaños",
                     "Los colores", "La cantidad de planetas"],
             "m": "Si respetás el tamaño de los planetas, las distancias no entran en el aula."},
            {"q": "¿Qué es un planeta enano como Plutón?",
             "ops": ["Un cuerpo que orbita el Sol pero no despejó su órbita",
                     "Un planeta muy chico y nada más", "Una luna grande"],
             "m": "El criterio no es sólo el tamaño: incluye haber limpiado su zona orbital."},
            {"q": "¿La Luna es un planeta?", "ops": ["No, es un satélite natural de la Tierra",
                     "Sí, el más chico", "Sí, porque gira alrededor del Sol"],
             "m": "Un planeta orbita directamente al Sol; la Luna orbita a la Tierra."},
        ],
    },
    {
        "id": "tiempo_clima_6", "grado": 6, "area": "naturales",
        "titulo": "Tiempo vs. clima", "icono": "⛅",
        "mecanica": "clasificar",
        "consigna": "¿Habla del tiempo de hoy o del clima del lugar?",
        "explica": "El tiempo es lo de ahora; el clima es el promedio de muchos años.",
        "categorias": [{"cat": "tiempo", "label": "🌦️ Tiempo"},
                       {"cat": "clima", "label": "🗓️ Clima"}],
        "dc": "Variables meteorológicas; diferencia entre tiempo y clima",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · N10a",
        "saber": {"id": "NAT-6-tiempo-clima", "nombre": "Tiempo y clima",
                  "prereqs": []},
        "banco": [
            {"it": "Hoy hay 28 grados y está despejado", "cat": "tiempo",
             "m": "Describe el estado de la atmósfera AHORA."},
            {"it": "En Ushuaia los inviernos son largos y fríos", "cat": "clima",
             "m": "Es una característica sostenida a lo largo de los años."},
            {"it": "Mañana se esperan tormentas por la tarde", "cat": "tiempo",
             "m": "Es un pronóstico de corto plazo."},
            {"it": "El noroeste argentino es una zona árida", "cat": "clima",
             "m": "Describe el patrón general de la región."},
            {"it": "Ahora está lloviznando en Palermo", "cat": "tiempo",
             "m": "Es lo que pasa en este momento y en un lugar puntual."},
            {"it": "En la selva misionera llueve mucho todo el año", "cat": "clima",
             "m": "Es el promedio de precipitaciones de muchos años."},
            {"it": "El viento sopla a 40 km/h desde el sur", "cat": "tiempo",
             "m": "Una medición del momento."},
            {"it": "Buenos Aires tiene clima templado húmedo", "cat": "clima",
             "m": "Una clasificación basada en décadas de registros."},
            {"it": "Esta noche la temperatura baja a 4 grados", "cat": "tiempo",
             "m": "Un dato puntual del pronóstico."},
            {"it": "La Patagonia es ventosa durante todo el año", "cat": "clima",
             "m": "Una característica permanente de la región."},
            {"it": "Hay 85% de humedad en este momento", "cat": "tiempo",
             "m": "Es una variable meteorológica medida ahora."},
            {"it": "En la Puna la amplitud térmica diaria es muy grande", "cat": "clima",
             "m": "Es un rasgo estable de esa región, no de un día."},
            {"it": "Cayó granizo esta mañana en Mar del Plata", "cat": "tiempo",
             "m": "Un evento puntual."},
            {"it": "El promedio de lluvias anuales de la pampa es de 900 mm", "cat": "clima",
             "m": "Un promedio de largo plazo."},
            {"it": "El cielo está parcialmente nublado", "cat": "tiempo",
             "m": "Describe la nubosidad de este momento."},
            {"it": "En el sur del país nieva todos los inviernos", "cat": "clima",
             "m": "Un patrón que se repite año tras año."},
        ],
    },
    {
        "id": "efecto_invernadero_6", "grado": 6, "area": "naturales",
        "titulo": "Efecto invernadero", "icono": "🌍",
        "mecanica": "trivia",
        "consigna": "Pensá qué gases y de dónde vienen.",
        "explica": "El efecto invernadero es natural; el problema es cuánto lo aumentamos.",
        "dc": "Gases de efecto invernadero; procesos directos e indirectos; mitigación",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · N10b",
        "saber": {"id": "NAT-6-invernadero", "nombre": "Efecto invernadero y mitigación",
                  "prereqs": ["NAT-6-tiempo-clima"]},
        "banco": [
            {"q": "¿Qué es el efecto invernadero?",
             "ops": ["La retención de calor por gases de la atmósfera",
                     "Un agujero en la atmósfera", "El calor directo del sol"],
             "m": "El agujero de ozono es otro problema distinto: conviene no mezclarlos."},
            {"q": "¿El efecto invernadero es en sí mismo algo malo?",
             "ops": ["No, es natural y necesario; el problema es su aumento",
                     "Sí, siempre fue dañino", "No existe"],
             "m": "Sin él la Tierra sería demasiado fría para la vida como la conocemos."},
            {"q": "¿Cuál de estos es un gas de efecto invernadero?",
             "ops": ["El dióxido de carbono", "El nitrógeno", "El argón"],
             "m": "El nitrógeno es el gas más abundante del aire, pero no retiene calor así."},
            {"q": "¿Qué actividad libera más dióxido de carbono?",
             "ops": ["Quemar combustibles fósiles", "Plantar árboles", "Usar energía solar"],
             "m": "Los árboles y la energía solar van en el sentido contrario."},
            {"q": "¿Qué es el metano?", "ops": ["Un gas de efecto invernadero muy potente",
                     "Un gas inofensivo", "Un tipo de contaminación del agua"],
            ...
            {"q": "Usar el colectivo en vez del auto particular es una medida de…",
             "ops": ["Mitigación", "Adaptación", "Ninguna de las dos"],
            ...
            {"q": "¿Qué diferencia hay entre mitigación y adaptación?",
             "ops": ["Mitigar reduce las causas; adaptarse prepara para las consecuencias",
                     "Son lo mismo", "Mitigar es sólo plantar árboles"],
             "m": "Construir defensas contra inundaciones es adaptación, no mitigación."},
            {"q": "¿Cuál es una fuente de energía renovable?",
             "ops": ["La energía eólica", "El carbón", "El petróleo"],
             "m": "El viento no se agota; el carbón y el petróleo sí."},
            {"q": "¿Por qué los bosques ayudan contra el cambio climático?",
             "ops": ["Porque absorben dióxido de carbono al crecer", "Porque dan sombra",
                     "Porque producen metano"],
             "m": "Funcionan como sumideros de carbono."},
            {"q": "Comprar productos de cerca en vez de importados, ¿ayuda?",
             "ops": ["Sí, porque reduce las emisiones del transporte",
                     "No, es indistinto", "Sí, pero sólo por el precio"],
             "m": "Es una emisión indirecta: no la ves, pero está en el traslado."},
            {"q": "¿Qué es una emisión indirecta?",
             "ops": ["La que se produce en otro lugar por algo que consumimos acá",
                     "La que sale del caño de escape", "La que no se puede medir"],
            ...
            {"q": "¿La energía nuclear emite dióxido de carbono al generar electricidad?",
             "ops": ["No en la generación, aunque tiene otros problemas",
                     "Sí, muchísimo", "Sí, más que el carbón"],
             "m": "Su discusión pasa por los residuos y la seguridad, no por el CO₂."},
            {"q": "Separar los residuos, ¿en qué ayuda?",
             "ops": ["Permite reciclar y reduce lo que se entierra y genera metano",
                     "No ayuda en nada", "Sólo mejora el aspecto de la ciudad"],
             "m": "Los rellenos sanitarios son una fuente importante de metano."},
            {"q": "¿Qué significa que un proceso libere GEI de forma directa?",
             "ops": ["Que la emisión ocurre en el propio proceso",
                     "Que la emisión ocurre en otro país", "Que no se puede evitar"],
             "m": "Quemar nafta en el auto es directo; la nafta que se usó para traerte la comida, indirecto."},
        ],
    },

    # ── CIENCIAS SOCIALES de 6° ──────────────────────────────────────────────────
    # ⚠ Todo este bloque pide revisión docente: ningún test valida que una
    # interpretación histórica sea justa. Dos reglas que vienen de las auditorías
    # anteriores y se respetan acá: no fijar tesis discutidas como si fueran hechos, y
    # nombrar lo incompleto (un avance real puede ser parcial, y las dos cosas son
    # ciertas a la vez).
    {
        "id": "linea_tiempo_1862_1930_6", "grado": 6, "area": "sociales",
        "titulo": "Línea de tiempo 1862-1930", "icono": "📜",
        "mecanica": "ordenar",
        "consigna": "Ordená del hecho MÁS ANTIGUO al más nuevo. Tocá en orden.",
        "explica": "Anclate en las fechas que ya sabés y ubicá el resto alrededor.",
        "dc": "Unificación 1862, federalización 1880, Ley 1420, Sáenz Peña 1912, 1916, 1930",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · S1",
        "saber": {"id": "SOC-6-linea-tiempo", "nombre": "Argentina 1862-1930",
                  "prereqs": []},
        "banco": [
            {"items": ["Mitre asume la presidencia del país unificado (1862)",
                       "Se sanciona la Ley 1420 de educación común (1884)",
                       "Se sanciona la Ley Sáenz Peña (1912)",
                       "Yrigoyen asume la presidencia (1916)"]},
            {"items": ["Presidencia de Sarmiento (1868)",
                       "Federalización de Buenos Aires (1880)",
                       "Primera Guerra Mundial (1914-1918)",
                       "Golpe de Estado contra Yrigoyen (1930)"]},
            {"items": ["Presidencia de Avellaneda (1874)",
                       "Ley 1420 de educación común (1884)",
                       "Ley Sáenz Peña de voto secreto (1912)",
                       "Crisis económica mundial (1929)"]},
            {"items": ["Unificación nacional bajo Mitre (1862)",
            ...
            {"items": ["Buenos Aires se convierte en capital federal (1880)",
                       "Se organiza el modelo agroexportador (1880-1900)",
                       "Estalla la Primera Guerra Mundial (1914)",
                       "Crack de la Bolsa de Nueva York (1929)"]},
            {"items": ["Presidencia de Mitre (1862)", "Presidencia de Sarmiento (1868)",
                       "Presidencia de Avellaneda (1874)", "Presidencia de Roca (1880)"]},
            {"items": ["Ley 1420 de educación común (1884)",
                       "Censo nacional que muestra el peso de la inmigración (1895)",
                       "Ley Sáenz Peña (1912)", "Golpe de 1930"]},
            {"items": ["Se extiende la red ferroviaria hacia el puerto (1870-1890)",
            ...
            {"items": ["Sanción de la Ley Sáenz Peña (1912)",
            ...
            {"items": ["Federalización de Buenos Aires (1880)",
                       "Ley 1420 (1884)", "Censo de 1895", "Ley Sáenz Peña (1912)"]},
        ],
    },
    {
        "id": "revolucion_industrial_6", "grado": 6, "area": "sociales",
        "titulo": "¿1ª o 2ª Revolución Industrial?", "icono": "🏭",
        "mecanica": "clasificar",
        "consigna": "¿De qué etapa es?",
        "explica": "La primera va con el vapor y el carbón; la segunda, con la electricidad y el petróleo.",
        "categorias": [{"cat": "primera", "label": "🚂 1ª (vapor)"},
                       {"cat": "segunda", "label": "💡 2ª (electricidad)"}],
        "dc": "Vapor vs petróleo y electricidad; países centrales y periféricos",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · S2",
        "saber": {"id": "SOC-6-revolucion-industrial", "nombre": "Revoluciones industriales",
                  "prereqs": []},
        "banco": [
            {"it": "La máquina de vapor", "cat": "primera", "m": "Es la energía que define la primera etapa."},
            {"it": "El motor de combustión interna", "cat": "segunda",
             "m": "Funciona con derivados del petróleo: segunda etapa."},
            {"it": "El carbón como combustible principal", "cat": "primera",
             "m": "Alimentaba las máquinas de vapor."},
            {"it": "La electricidad en las fábricas", "cat": "segunda",
             "m": "Permitió mover máquinas sin correas ni calderas."},
            {"it": "La industria textil mecanizada", "cat": "primera",
             "m": "Fue el primer sector en industrializarse."},
            {"it": "La producción en serie del automóvil", "cat": "segunda",
             "m": "La línea de montaje pertenece a la segunda etapa."},
            {"it": "El ferrocarril a vapor", "cat": "primera",
             "m": "Transformó el transporte usando la misma tecnología del vapor."},
            {"it": "La industria química y del acero a gran escala", "cat": "segunda",
             "m": "Sectores característicos de la segunda revolución."},
            {"it": "El telar mecánico", "cat": "primera", "m": "Reemplazó el trabajo manual en el textil."},
            {"it": "El teléfono y el telégrafo eléctrico", "cat": "segunda",
             "m": "Las comunicaciones eléctricas son de la segunda etapa."},
            {"it": "Inglaterra como potencia industrial dominante", "cat": "primera",
             "m": "Lideró la primera etapa casi en soledad."},
            {"it": "Estados Unidos y Alemania disputando el liderazgo", "cat": "segunda",
             "m": "En la segunda etapa aparecen nuevas potencias."},
            {"it": "La lámpara eléctrica en las ciudades", "cat": "segunda",
             "m": "Cambió la vida urbana y los horarios de trabajo."},
            {"it": "Las primeras fábricas con chimeneas humeantes", "cat": "primera",
             "m": "El humo del carbón es la imagen de la primera etapa."},
            {"it": "La Argentina exportando cereales a los países industriales", "cat": "segunda",
             "m": "Se integra al mercado mundial como país periférico durante esta etapa."},
            {"it": "El barco a vapor cruzando el Atlántico", "cat": "primera",
             "m": "Aplicó al transporte marítimo la tecnología del vapor."},
        ],
    },
    {
        "id": "estado_agroexportacion_6", "grado": 6, "area": "sociales",
        "titulo": "Estado y agroexportación", "icono": "🌾",
        "mecanica": "trivia",
        "consigna": "Pensá cómo se armó el país y de qué vivía.",
        "explica": "El modelo agroexportador ordenó el territorio alrededor del puerto.",
        "dc": "Mitre, Sarmiento y Avellaneda; modelo agroexportador; ferrocarril y puerto",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · S3",
        "saber": {"id": "SOC-6-agroexportacion", "nombre": "Estado y modelo agroexportador",
                  "prereqs": ["SOC-6-linea-tiempo"]},
        "banco": [
            {"q": "¿Qué exportaba principalmente la Argentina del modelo agroexportador?",
             "ops": ["Cereales, carne y lana", "Máquinas y automóviles", "Petróleo refinado"],
            ...
            {"q": "¿Por qué la red ferroviaria tenía forma de abanico hacia Buenos Aires?",
             "ops": ["Porque estaba pensada para llevar la producción al puerto",
                     "Porque el terreno lo imponía", "Porque unía las provincias entre sí"],
            ...
            {"q": "¿Qué fue la Ley 1420 de 1884?",
             "ops": ["La ley de educación común, gratuita y obligatoria",
                     "La ley de inmigración", "La ley del voto secreto"],
            ...
            {"q": "¿Qué papel cumplía el puerto de Buenos Aires en ese modelo?",
             "ops": ["Era la salida de las exportaciones y la entrada de las importaciones",
                     "Era sólo un puerto militar", "No tenía importancia económica"],
            ...
            {"q": "¿Quiénes financiaron en buena parte los ferrocarriles argentinos?",
             "ops": ["Capitales británicos", "El Estado argentino en soledad",
            ...
            {"q": "En el reparto internacional de esa época, la Argentina era…",
             "ops": ["Un país periférico proveedor de materias primas",
                     "Un país central industrializado", "Un país aislado del comercio"],
            ...
            {"q": "¿Qué fue el frigorífico para la exportación de carne?",
             "ops": ["La tecnología que permitió mandar carne enfriada a Europa",
                     "Un tipo de barco", "Una raza de ganado"],
             "m": "Sin frío, la carne no podía cruzar el Atlántico."},
            {"q": "El alambrado de los campos, ¿qué cambió?",
             "ops": ["Delimitó la propiedad y permitió mejorar el ganado",
                     "Sólo sirvió para marcar caminos", "No tuvo efecto económico"],
            ...
            {"q": "¿Qué presidencia se ubica entre las de Sarmiento y Roca?",
             "ops": ["La de Avellaneda", "La de Mitre", "La de Yrigoyen"],
            ...
            {"q": "¿Qué significa que un país exporte materias primas e importe manufacturas?",
             "ops": ["Que vende productos poco elaborados y compra los elaborados",
                     "Que vende y compra lo mismo", "Que no comercia con nadie"],
            ...
            {"q": "¿Qué cambió el telégrafo para el comercio de la época?",
             "ops": ["Permitió conocer los precios de Europa casi al instante",
                     "Sirvió sólo para uso militar", "No influyó en el comercio"],
            ...
            {"q": "El crecimiento de esa economía, ¿llegó por igual a todo el país?",
             "ops": ["No: se concentró en la región pampeana y el litoral",
                     "Sí, a todas las provincias por igual", "Sólo llegó al noroeste"],
             "m": "Las economías regionales quedaron en una posición muy distinta."},
        ],
    },
    {
        "id": "inmigracion_censos_6", "grado": 6, "area": "sociales",
        "titulo": "Inmigración: censos y conventillo", "icono": "🚢",
        "mecanica": "trivia",
        "consigna": "Leé los datos y pensá cómo se vivía.",
        "explica": "Los censos permiten ver de golpe cuánto cambió la población.",
        "dc": "Inmigración ultramarina; lectura de censos; conventillo; Ley 1420",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · S4",
        "saber": {"id": "SOC-6-inmigracion", "nombre": "Inmigración ultramarina",
                  "prereqs": ["SOC-6-agroexportacion"]},
        "banco": [
            {"q": "¿De qué países llegaba la mayor parte de los inmigrantes ultramarinos?",
             "ops": ["Italia y España", "Alemania y Francia", "Inglaterra y Portugal"],
             "m": "Hubo inmigración de muchos orígenes, pero esos dos fueron con diferencia los mayores."},
            {"q": "¿Qué era un conventillo?",
             "ops": ["Una casa grande subdividida donde muchas familias compartían patio y servicios",
                     "Un edificio de departamentos modernos", "Un hotel para turistas"],
             "m": "Una pieza por familia y todo lo demás compartido."},
            {"q": "¿Por qué emigraba tanta gente de Europa en esa época?",
             "ops": ["Por pobreza, falta de tierra y guerras", "Por turismo",
            ...
            {"q": "¿Para qué sirve un censo?",
             "ops": ["Para contar y describir a la población en un momento dado",
                     "Para cobrar impuestos únicamente", "Para elegir autoridades"],
            ...
            {"q": "Si un censo muestra que el 30% de los habitantes de una ciudad nació en el extranjero, ¿qué indica?",
             "ops": ["Que la inmigración tuvo un peso enorme en esa población",
                     "Que la ciudad era muy chica", "Que casi nadie emigraba"],
            ...
            {"q": "¿Qué papel cumplió la escuela pública con los hijos de inmigrantes?",
             "ops": ["Enseñar el idioma y una historia común", "Separarlos del resto",
            ...
            {"q": "¿Qué era el Hotel de Inmigrantes?",
             "ops": ["El lugar donde los recién llegados se alojaban unos días al desembarcar",
                     "Un hotel de lujo del puerto", "Una escuela para adultos"],
             "m": "Ofrecía alojamiento, comida y ayuda para conseguir trabajo."},
            {"q": "¿Todos los inmigrantes se quedaron definitivamente?",
             "ops": ["No, muchos volvieron o venían por temporadas", "Sí, todos se quedaron",
            ...
            {"q": "¿Qué huellas dejó la inmigración en el habla del Río de la Plata?",
             "ops": ["Palabras y modismos, sobre todo del italiano", "Ninguna",
            ...
            {"q": "En un conventillo, ¿cómo eran las condiciones sanitarias?",
             "ops": ["Precarias, con baños compartidos y hacinamiento",
                     "Muy buenas, con baño en cada pieza", "No había gente viviendo ahí"],
             "m": "El hacinamiento facilitaba la propagación de enfermedades."},
            {"q": "¿Qué actividad concentró a muchos inmigrantes en la ciudad?",
             "ops": ["El trabajo en talleres, comercios y el puerto", "La minería",
                     "La pesca de altura"],
            ...
            {"q": "Si comparás dos censos de distintas décadas, ¿qué podés ver?",
             "ops": ["Cómo cambió la población en ese período", "Sólo cuánta gente había hoy",
            ...
            {"q": "¿La llegada de inmigrantes generó tensiones sociales?",
             "ops": ["Sí, hubo conflictos laborales y también rechazo de algunos sectores",
                     "No, fue un proceso sin conflictos", "Sólo hubo conflictos entre inmigrantes"],
            ...
            {"q": "¿Qué prometía a los inmigrantes la Constitución de 1853?",
             "ops": ["Los mismos derechos civiles que a los ciudadanos argentinos",
                     "Tierra gratis garantizada para todos", "El voto inmediato"],
             "m": "Los derechos civiles no son lo mismo que los políticos: votar requería la ciudadanía."},
        ],
    },
    {
        "id": "voto_6", "grado": 6, "area": "sociales",
        "titulo": "El voto antes y después", "icono": "🗳️",
        "mecanica": "trivia",
        "consigna": "Pensá quién podía votar y cómo.",
        "explica": "La Ley Sáenz Peña cambió CÓMO se votaba, pero no incluyó a todos.",
        "dc": "Ley Sáenz Peña 1912; gobiernos radicales; golpe de 1930",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · S5",
        "saber": {"id": "SOC-6-voto", "nombre": "Ampliación del sufragio",
                  "prereqs": ["SOC-6-linea-tiempo"]},
        "banco": [
            {"q": "¿Qué estableció la Ley Sáenz Peña de 1912?",
             "ops": ["Voto secreto, obligatorio y universal masculino",
                     "Voto para todas las personas adultas", "El fin de las elecciones"],
            ...
            {"q": "¿Las mujeres podían votar después de la Ley Sáenz Peña?",
             "ops": ["No, recién pudieron desde 1947", "Sí, desde 1912",
                     "Sí, pero sólo en algunas provincias"],
             "m": "El voto femenino llegó con la Ley 13.010, mucho después."},
            {"q": "Antes de 1912, ¿cómo se votaba?",
             "ops": ["A viva voz y sin secreto, lo que facilitaba la presión",
                     "Con boleta secreta", "Por correo"],
             "m": "Sin secreto, quien tenía poder podía controlar y presionar el voto."},
            {"q": "¿Qué significa que el voto sea secreto?",
             "ops": ["Que nadie puede saber a quién votaste", "Que no se cuentan los votos",
            ...
            {"q": "¿Qué significa que el voto sea obligatorio?",
             "ops": ["Que las personas habilitadas tienen el deber de votar",
                     "Que hay que votar a un candidato determinado", "Que se vota todos los años"],
            ...
            {"q": "¿Quién ganó la primera elección presidencial con la nueva ley, en 1916?",
             "ops": ["Hipólito Yrigoyen", "Julio Roca", "Marcelo T. de Alvear"],
             "m": "Alvear gobernó después, entre los dos mandatos de Yrigoyen."},
            {"q": "¿Qué pasó en 1930?",
             "ops": ["Un golpe de Estado interrumpió el orden constitucional",
                     "Se amplió el voto a las mujeres", "Terminó la Primera Guerra"],
             "m": "Fue el primer golpe de Estado del siglo XX en la Argentina."},
            {"q": "¿Qué es el fraude electoral?",
             "ops": ["Manipular una elección para alterar el resultado",
                     "Votar en blanco", "No presentarse a votar"],
             "m": "Fue una práctica extendida antes de 1912 y volvió después de 1930."},
            {"q": "¿Qué significa «universal» en el sufragio de 1912?",
             "ops": ["Universal masculino: todos los varones nativos mayores de edad",
            ...
            {"q": "¿Los inmigrantes que no se habían nacionalizado podían votar?",
             "ops": ["No, hacía falta la ciudadanía", "Sí, todos", "Sí, tras cinco años"],
             "m": "Es una de las razones por las que mucha población quedó fuera del sistema político."},
            {"q": "El padrón electoral servía para…",
             "ops": ["Registrar quiénes estaban habilitados para votar",
                     "Contar los votos", "Elegir a los candidatos"],
             "m": "Se armó a partir del registro militar de los varones."},
            {"q": "¿Qué se buscaba con el voto secreto y obligatorio?",
             "ops": ["Que la elección reflejara mejor la voluntad de la gente",
                     "Que votara menos gente", "Que el gobierno eligiera a los candidatos"],
             "m": "Reducir la presión y ampliar la participación eran los dos objetivos."},
            {"q": "Después de 1930, ¿qué pasó con las elecciones?",
             "ops": ["Hubo un período con fraude sistemático",
                     "Se mantuvieron completamente limpias", "Dejaron de hacerse elecciones"],
             "m": "Hubo elecciones, pero con prácticas fraudulentas conocidas."},
        ],
    },
    {
        "id": "gran_guerra_crisis_6", "grado": 6, "area": "sociales",
        "titulo": "La Gran Guerra y la crisis del '29", "icono": "🌐",
        "mecanica": "trivia",
        "consigna": "Seguí la cadena de causas y consecuencias.",
        "explica": "Lo que pasa en el mundo llega acá a través del comercio.",
        "dc": "Primera Guerra Mundial; crisis de 1929 y su impacto en la Argentina",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · S6",
        "saber": {"id": "SOC-6-guerra-crisis", "nombre": "Primera Guerra y crisis del '29",
                  "prereqs": ["SOC-6-agroexportacion"]},
        "banco": [
            {"q": "¿Entre qué años ocurrió la Primera Guerra Mundial?",
             "ops": ["1914-1918", "1939-1945", "1929-1933"],
             "m": "1939-1945 es la Segunda; 1929 es la crisis económica."},
            {"q": "¿Qué postura tomó la Argentina durante la Primera Guerra Mundial?",
             "ops": ["Se mantuvo neutral", "Participó junto a los Aliados",
            ...
            {"q": "¿Cómo afectó la guerra al comercio argentino?",
             "ops": ["Se interrumpieron importaciones y bajó el comercio con Europa",
                     "No tuvo ningún efecto", "Aumentaron las importaciones"],
             "m": "Al faltar productos importados, algunas industrias locales empezaron a producirlos."},
            {"q": "¿Qué fue la crisis de 1929?",
             "ops": ["Una crisis económica mundial que empezó con la caída de la Bolsa de Nueva York",
            ...
            {"q": "¿Cómo golpeó la crisis del '29 a la Argentina?",
             "ops": ["Cayeron los precios y la demanda de sus exportaciones",
                     "Aumentaron las exportaciones", "No la afectó"],
            ...
            {"q": "¿Qué es la sustitución de importaciones?",
             "ops": ["Producir localmente lo que antes se compraba afuera",
                     "Dejar de exportar", "Importar más productos"],
            ...
            {"q": "¿Qué relación hay entre la crisis del '29 y el golpe de 1930 en la Argentina?",
             "ops": ["La crisis agravó el descontento, aunque no fue su única causa",
                     "La crisis causó el golpe por sí sola", "No hubo ninguna relación"],
             "m": "Los procesos históricos suelen tener varias causas: conviene no reducirlo a una."},
            {"q": "¿Qué fue el Tratado de Versalles?",
             "ops": ["El acuerdo que cerró la Primera Guerra Mundial",
                     "Un tratado comercial entre Argentina e Inglaterra", "El fin de la crisis del '29"],
            ...
            {"q": "Durante la crisis, ¿qué pasó con el desempleo en el mundo?",
             "ops": ["Creció fuertemente", "Bajó", "Se mantuvo igual"],
            ...
            {"q": "¿Por qué se dice que la economía argentina era vulnerable?",
             "ops": ["Porque dependía de pocos productos y de pocos compradores",
                     "Porque no tenía recursos naturales", "Porque no tenía puertos"],
             "m": "Depender de pocos mercados amplifica cualquier sacudón externo."},
            {"q": "¿Qué fue la Gran Depresión?",
             "ops": ["El largo período de crisis económica que siguió al crack de 1929",
                     "Una batalla de la Primera Guerra", "Una crisis política argentina"],
            ...
            {"q": "La guerra en Europa, ¿favoreció en algo a la industria local argentina?",
             "ops": ["Sí, al faltar productos importados hubo que fabricarlos acá",
                     "No, la perjudicó por completo", "No hubo ningún efecto"],
            ...
            {"q": "¿Qué es una causa externa de un proceso histórico?",
             "ops": ["La que se origina fuera del país y lo afecta",
                     "La que ocurre dentro del país", "La que no se puede comprobar"],
             "m": "La crisis del '29 es externa; el descontento acumulado acá es interno."},
        ],
    },
    {
        "id": "mercosur_energia_6", "grado": 6, "area": "sociales",
        "titulo": "Mercosur y la energía que viaja", "icono": "⚡",
        "mecanica": "trivia",
        "consigna": "Pensá en la región y en cómo llega la energía.",
        "explica": "Integrarse es acordar reglas comunes para comerciar y producir juntos.",
        "dc": "Integración regional; grandes instalaciones de energía",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · S7",
        "saber": {"id": "SOC-6-mercosur", "nombre": "Integración regional y energía",
                  "prereqs": []},
        "banco": [
            {"q": "¿Qué es el Mercosur?",
             "ops": ["Un bloque de integración económica de países sudamericanos",
                     "Una alianza militar", "Una empresa de energía"],
             "m": "Su objetivo central es comercial y económico."},
            {"q": "¿Cuáles fueron los cuatro países fundadores del Mercosur?",
             "ops": ["Argentina, Brasil, Uruguay y Paraguay", "Argentina, Chile, Perú y Brasil",
            ...
            {"q": "¿Qué ventaja busca un bloque de integración?",
             "ops": ["Comerciar entre sus miembros con menos trabas",
                     "Cerrar las fronteras", "Unificar los gobiernos"],
             "m": "Integrarse no significa dejar de ser países independientes."},
            {"q": "¿Qué es la represa de Yacyretá?",
             "ops": ["Una central hidroeléctrica compartida entre Argentina y Paraguay",
                     "Una central nuclear", "Un puerto de exportación"],
             "m": "Es un ejemplo de obra binacional de generación de energía."},
            {"q": "¿Qué es Salto Grande?",
             "ops": ["Una represa hidroeléctrica compartida con Uruguay",
                     "Una central térmica en Buenos Aires", "Un parque eólico patagónico"],
             "m": "Otra obra binacional, esta vez sobre el río Uruguay."},
            {"q": "¿Cómo llega la electricidad desde una represa hasta las ciudades?",
             "ops": ["Por líneas de alta tensión", "En camiones", "Por caños subterráneos de gas"],
            ...
            {"q": "¿Qué tipo de energía genera una represa hidroeléctrica?",
             "ops": ["Energía eléctrica a partir de la fuerza del agua",
                     "Energía a partir del carbón", "Energía solar"],
             "m": "Aprovecha el movimiento del agua para mover las turbinas."},
            {"q": "¿Dónde se ubican los principales parques eólicos argentinos?",
             "ops": ["En la Patagonia y el sur bonaerense", "En la selva misionera",
                     "En el centro de la ciudad de Buenos Aires"],
             "m": "Se instalan donde el viento es fuerte y constante."},
            {"q": "¿Qué es una central nuclear?",
             "ops": ["Una instalación que genera electricidad a partir de la fisión del átomo",
                     "Una represa muy grande", "Un tipo de parque solar"],
             "m": "La Argentina tiene tres: Atucha I, Atucha II y Embalse."},
            {"q": "¿Una obra binacional es…?",
             "ops": ["Una obra construida y administrada por dos países",
                     "Una obra de una empresa privada", "Una obra que cruza dos provincias"],
             "m": "Requiere un acuerdo entre los dos Estados."},
            {"q": "¿Por qué conviene integrarse regionalmente en materia de energía?",
             "ops": ["Porque las obras son muy caras y compartir recursos las hace posibles",
                     "Porque así se consume menos", "Porque lo exige el Mercosur"],
             "m": "Además permite compensar picos de demanda entre países."},
            {"q": "¿Qué es un país asociado del Mercosur?",
             "ops": ["Uno que participa con acuerdos parciales, sin ser miembro pleno",
                     "Uno que fundó el bloque", "Uno que se retiró"],
             "m": "Tiene beneficios comerciales pero no todas las obligaciones del miembro pleno."},
        ],
    },
    {
        "id": "demografia_6", "grado": 6, "area": "sociales",
        "titulo": "Demografía en gráficos", "icono": "📈",
        "mecanica": "trivia",
        "consigna": "¿Qué mide cada indicador?",
        "explica": "Cada tasa mide algo distinto: nacimientos, muertes o cuánto se vive.",
        "dc": "Natalidad, mortalidad y esperanza de vida; censos y su lectura",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · S8a",
        "saber": {"id": "SOC-6-demografia", "nombre": "Indicadores demográficos",
                  "prereqs": ["SOC-6-inmigracion"]},
        "banco": [
            {"q": "¿Qué mide la tasa de natalidad?",
             "ops": ["Los nacimientos por cada mil habitantes en un año",
                     "Las muertes por cada mil habitantes", "Cuántos años vive la gente"],
             "m": "Cada tasa mide una cosa distinta: conviene no mezclarlas."},
            {"q": "¿Qué mide la tasa de mortalidad?",
             "ops": ["Las muertes por cada mil habitantes en un año", "Los nacimientos",
                     "La cantidad de migrantes"],
             "m": "Junto con la natalidad determina el crecimiento natural."},
            {"q": "¿Qué es la esperanza de vida?",
             "ops": ["El promedio de años que se espera que viva una persona",
                     "La edad máxima que alcanza alguien", "La edad de jubilación"],
             "m": "Es un promedio estadístico, no un límite individual."},
            {"q": "¿Qué es el crecimiento vegetativo?",
             "ops": ["La diferencia entre nacimientos y defunciones",
                     "La cantidad de inmigrantes", "El total de habitantes"],
            ...
            {"q": "Si en un país nacen más personas de las que mueren, el crecimiento vegetativo es…",
             "ops": ["Positivo", "Negativo", "Nulo"],
             "m": "Sería negativo si murieran más de las que nacen."},
            {"q": "¿Qué muestra una pirámide de población?",
             "ops": ["Cómo se reparte la población por edad y sexo",
                     "Dónde vive la gente", "Cuánto gana cada persona"],
            ...
            {"q": "Si un gráfico de líneas muestra la población subiendo año a año, ¿qué indica?",
             "ops": ["Que la población crece", "Que la población se mantiene",
                     "Que la población baja"],
             "m": "Una línea ascendente en el tiempo representa crecimiento."},
        ],
    },
    {
        "id": "escalas_ambientales_6", "grado": 6, "area": "sociales",
        "titulo": "Escalas ambientales", "icono": "🔭",
        "mecanica": "clasificar",
        "consigna": "¿A qué escala ocurre este problema?",
        "explica": "Un problema puede ser de una cuadra, de una región o de todo el planeta.",
        "categorias": [{"cat": "local", "label": "🏘️ Local"},
                       {"cat": "regional", "label": "🗺️ Regional"},
        ...
        "saber": {"id": "SOC-6-escalas", "nombre": "Escalas de los problemas ambientales",
                  "prereqs": []},
        "banco": [
            {"it": "Basura acumulada en la esquina del barrio", "cat": "local",
             "m": "Afecta a quienes viven en ese lugar puntual."},
            {"it": "Contaminación de la cuenca Matanza-Riachuelo", "cat": "regional",
             "m": "Involucra a varios municipios y a toda una cuenca."},
            {"it": "Aumento de la temperatura media del planeta", "cat": "global",
             "m": "Ningún país lo resuelve por su cuenta."},
            {"it": "Un árbol caído que corta una calle", "cat": "local",
             "m": "Afecta a una manzana."},
            {"it": "Sequía prolongada en la región pampeana", "cat": "regional",
             "m": "Abarca varias provincias, pero no todo el planeta."},
            {"it": "Pérdida de biodiversidad en todo el mundo", "cat": "global",
             "m": "Es un proceso planetario."},
            {"it": "Ruido de una obra en construcción", "cat": "local",
             "m": "Molesta a los vecinos inmediatos."},
            {"it": "Deforestación del Gran Chaco", "cat": "regional",
             "m": "Se extiende por varias provincias y países vecinos."},
            {"it": "Acidificación de los océanos", "cat": "global",
             "m": "Afecta a todos los mares del planeta."},
            {"it": "Una plaza sin desagües que se inunda", "cat": "local",
             "m": "Un problema puntual de infraestructura barrial."},
            {"it": "Contaminación del río Paraná por vertidos industriales", "cat": "regional",
             "m": "Recorre varias provincias aguas abajo."},
            {"it": "Reducción de la capa de ozono", "cat": "global",
             "m": "Se abordó con un acuerdo internacional, el Protocolo de Montreal."},
            {"it": "Un basural a cielo abierto en las afueras del pueblo", "cat": "local",
             "m": "Afecta principalmente a esa localidad."},
            {"it": "Incendios en el delta del Paraná", "cat": "regional",
             "m": "Su humo llega a varias provincias."},
            {"it": "Aumento del nivel del mar", "cat": "global",
             "m": "Es consecuencia de procesos planetarios."},
            {"it": "Falta de arbolado en una avenida", "cat": "local",
             "m": "Se resuelve con una intervención en ese lugar."},
            {"it": "Retroceso de los glaciares patagónicos", "cat": "regional",
             "m": "Es un efecto regional de un proceso global."},
            {"it": "Emisiones mundiales de gases de efecto invernadero", "cat": "global",
             "m": "Se miden y se negocian a escala planetaria."},
        ],
    },
    {
        "id": "buenos_aires_6", "grado": 6, "area": "sociales",
        "titulo": "Mi Buenos Aires querido", "icono": "🏙️",
        "mecanica": "trivia",
        "consigna": "Reconocé el patrimonio de la ciudad.",
        "explica": "El patrimonio no es sólo lo antiguo: también las prácticas que se siguen haciendo.",
        "dc": "Patrimonio porteño: tango, fileteado, Obelisco, subte A, Reserva, Mataderos",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · S9",
        "saber": {"id": "SOC-6-buenos-aires", "nombre": "Patrimonio de Buenos Aires",
                  "prereqs": []},
        "banco": [
            {"q": "¿En qué año se inauguró el Obelisco?", "ops": ["1936", "1910", "1950"],
            ...
            {"q": "¿Qué línea de subte fue la primera de Buenos Aires y de Sudamérica?",
             "ops": ["La línea A, en 1913", "La línea B, en 1930", "La línea D, en 1937"],
             "m": "Fue la primera de toda Sudamérica."},
            {"q": "¿Qué reconocimiento recibió el tango de la UNESCO?",
             "ops": ["Patrimonio Cultural Inmaterial de la Humanidad",
                     "Maravilla del mundo moderno", "Monumento histórico nacional"],
             "m": "Inmaterial porque es una práctica viva, no un edificio."},
            {"q": "¿Qué es el fileteado porteño?",
             "ops": ["Un estilo de pintura decorativa típico de la ciudad",
                     "Un baile", "Un tipo de comida"],
             "m": "También fue declarado patrimonio inmaterial por la UNESCO."},
            {"q": "¿Qué es la Reserva Ecológica Costanera Sur?",
             "ops": ["Un área natural protegida junto al Río de la Plata",
                     "Un parque de diversiones", "Un museo al aire libre"],
             "m": "Se formó sobre terrenos ganados al río y se protegió en 1986."},
            {"q": "¿Qué se celebra en la Feria de Mataderos?",
             "ops": ["Las tradiciones criollas: música, danzas y destrezas",
                     "El carnaval veneciano", "La cultura inmigrante europea"],
            ...
            {"q": "¿Qué barrio porteño se asocia históricamente con el tango y el conventillo?",
             "ops": ["La Boca", "Palermo", "Belgrano"],
             "m": "Fue zona portuaria y de gran presencia inmigrante."},
            {"q": "¿Qué es el patrimonio cultural INMATERIAL?",
             "ops": ["Las prácticas, saberes y expresiones que se transmiten entre personas",
                     "Los edificios antiguos", "Las obras de arte de los museos"],
             "m": "Lo material son objetos y edificios; lo inmaterial, prácticas vivas."},
            {"q": "¿Qué avenida cruza el Obelisco?", "ops": ["La 9 de Julio", "Rivadavia",
                     "Corrientes"],
            ...
            {"q": "¿Por qué el subte A tenía coches de madera hasta hace pocos años?",
             "ops": ["Porque eran los originales, conservados por su valor histórico",
                     "Porque no había dinero para cambiarlos", "Porque la madera es más segura"],
             "m": "Fueron declarados monumento histórico nacional."},
            {"q": "¿Qué caracteriza al fileteado como estilo?",
             "ops": ["Líneas curvas, colores fuertes, flores y frases populares",
                     "Figuras geométricas en blanco y negro", "Fotografías retocadas"],
             "m": "Nació decorando carros y colectivos de la ciudad."},
            {"q": "¿Cómo se formó el terreno de la Reserva Ecológica?",
             "ops": ["Con rellenos sobre el río que después se naturalizaron",
                     "Fue siempre una isla natural", "Se construyó como parque planificado"],
             "m": "La naturaleza colonizó un terreno de origen artificial."},
            {"q": "¿Qué es un monumento histórico nacional?",
             "ops": ["Un bien protegido por su valor para la historia del país",
                     "Cualquier edificio antiguo", "Una estatua en una plaza"],
             "m": "La protección la establece una declaración oficial, no la antigüedad sola."},
        ],
    },

    # ── TECNOLOGÍA, DISEÑO Y PROGRAMACIÓN de 6° ──────────────────────────────────
    # No hay carril propio en el menú —son seis y están fijos—, así que estas cinco
    # se reparten: medición va a Naturales y programación y diseño, a Lógica.
    {
        "id": "instrumentos_medida_6", "grado": 6, "area": "naturales",
        "titulo": "Elegí el instrumento", "icono": "📐",
        "mecanica": "trivia",
        "consigna": "¿Con qué se mide y en qué escala?",
        "explica": "El instrumento se elige por lo que mide Y por el rango que necesitás.",
        "dc": "Tecnología: instrumento y escala de medida; sensor→procesamiento→display",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · T1",
        "saber": {"id": "TEC-6-instrumentos", "nombre": "Instrumentos y escalas de medición",
                  "prereqs": []},
        "banco": [
            {"q": "¿Con qué se mide la masa de una manzana?", "ops": ["Balanza", "Termómetro",
                     "Cronómetro"],
             "m": "El termómetro mide temperatura y el cronómetro, tiempo."},
            {"q": "¿Con qué se mide la temperatura del ambiente?", "ops": ["Termómetro",
                     "Barómetro", "Anemómetro"],
             "m": "El barómetro mide presión y el anemómetro, velocidad del viento."},
            {"q": "¿Con qué se mide la velocidad del viento?", "ops": ["Anemómetro", "Higrómetro",
                     "Pluviómetro"],
             "m": "El higrómetro mide humedad y el pluviómetro, lluvia acumulada."},
            {"q": "¿Con qué se mide la humedad del aire?", "ops": ["Higrómetro", "Termómetro",
                     "Balanza"],
             "m": "Cada variable meteorológica tiene su instrumento."},
            {"q": "Para medir el largo de un lápiz, ¿qué escala conviene?",
             "ops": ["Una regla en centímetros y milímetros", "Un metro de obra",
                     "Un odómetro de auto"],
             "m": "El instrumento tiene que tener la precisión adecuada al objeto."},
            {"q": "«Un lápiz mide 17 kilómetros.» ¿Qué está mal?",
             "ops": ["La unidad: debería ser centímetros", "El número",
            ...
            {"q": "En un sistema de medición automática, ¿qué hace el sensor?",
             "ops": ["Capta la magnitud física y la convierte en una señal",
                     "Muestra el resultado en pantalla", "Guarda los datos"],
             "m": "Mostrar es la función del display, no del sensor."},
            {"q": "En ese mismo sistema, ¿qué hace el display?",
             "ops": ["Muestra el resultado ya procesado", "Capta la magnitud",
                     "Realiza los cálculos"],
             "m": "El orden es sensor, procesamiento y display."},
            {"q": "¿Cuál es el orden correcto de un sistema de medición automático?",
             "ops": ["Sensor, procesamiento, display", "Display, sensor, procesamiento",
            ...
            {"q": "¿Qué es la precisión de un instrumento?",
             "ops": ["La menor diferencia que es capaz de distinguir",
                     "El valor más alto que puede medir", "Su tamaño"],
             "m": "El valor máximo es el alcance o rango, no la precisión."},
            {"q": "¿Con qué se mide la lluvia caída?", "ops": ["Pluviómetro", "Anemómetro",
                     "Balanza"],
             "m": "Mide la altura de agua acumulada en milímetros."},
            {"q": "Para pesar un camión, ¿qué instrumento se usa?",
             "ops": ["Una balanza de gran alcance, como la de una báscula",
                     "Una balanza de cocina", "Una regla"],
            ...
            {"q": "¿Con qué se mide un intervalo de tiempo corto?",
             "ops": ["Cronómetro", "Calendario", "Termómetro"],
             "m": "El calendario sirve para días, no para segundos."},
            {"q": "¿Por qué conviene repetir una medición varias veces?",
             "ops": ["Para reducir el efecto de los errores", "Para gastar más tiempo",
                     "Porque el instrumento se desgasta"],
             "m": "Promediar varias mediciones da un resultado más confiable."},
        ],
    },
    {
        "id": "secuencial_condicional_6", "grado": 6, "area": "logica",
        "titulo": "¿Secuencial o condicional?", "icono": "🔀",
        "mecanica": "trivia",
        "consigna": "Pensá si el programa siempre hace lo mismo.",
        "explica": "Con SI el programa decide; sin SI, siempre hace los mismos pasos.",
        "dc": "Tecnología: algoritmos no lineales; comparación de algoritmos",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · T2",
        "saber": {"id": "TEC-6-condicionales", "nombre": "Algoritmos con condicionales",
                  "prereqs": []},
        "banco": [
            {"q": "¿Qué es un algoritmo secuencial?",
             "ops": ["Uno que ejecuta los pasos siempre en el mismo orden",
                     "Uno que toma decisiones", "Uno que repite pasos"],
             "m": "Si toma decisiones ya no es puramente secuencial."},
            {"q": "¿Qué agrega un bloque SI a un programa?",
             "ops": ["La posibilidad de hacer cosas distintas según una condición",
                     "Más velocidad", "Más pasos siempre"],
             "m": "Es lo que convierte al algoritmo en no lineal."},
            {"q": "«Si llueve, llevá paraguas; si no, llevá gorra.» ¿Qué estructura es?",
             "ops": ["Condicional", "Secuencial", "Repetitiva"],
            ...
            {"q": "«Ponete las medias, después las zapatillas, después atá los cordones.» ¿Qué estructura es?",
             "ops": ["Secuencial", "Condicional", "Repetitiva"],
             "m": "Los pasos van siempre en el mismo orden, sin decidir nada."},
            {"q": "¿Qué es un bucle o repetición?",
             "ops": ["Una estructura que repite pasos varias veces",
                     "Una estructura que decide entre dos caminos", "Un error del programa"],
             "m": "Repetir y decidir son estructuras distintas."},
            {"q": "«Repetí 4 veces: avanzá 10 y girá 90°.» ¿Qué dibuja?",
             "ops": ["Un cuadrado", "Un triángulo", "Un círculo"],
            ...
            {"q": "Si dos programas hacen lo mismo, ¿cuál conviene?",
             "ops": ["El que usa menos pasos y se entiende mejor", "El más largo",
            ...
            {"q": "¿Por qué conviene usar un bucle en vez de repetir el mismo bloque 20 veces?",
             "ops": ["Porque el programa queda más corto y fácil de cambiar",
                     "Porque se ejecuta más rápido siempre", "Porque ocupa más memoria"],
    ...
    },
    {
        ...
        "banco": [
            ...
            {"q": "¿Los bloques y el código hacen cosas distintas?",
             "ops": ["No, expresan las mismas ideas de dos formas", "Sí, son incompatibles",
                     "Sí, el código no tiene bucles"],
             "m": "Cambia la forma de escribirlo, no lo que se puede expresar."},
            {"q": "En «x = 5», ¿qué se está haciendo?",
             "ops": ["Guardando el valor 5 en la variable x", "Comparando x con 5",
                     "Repitiendo 5 veces"],
            ...
            {"q": "¿Qué es la sintaxis de un lenguaje de programación?",
             "ops": ["Las reglas de escritura que el lenguaje exige",
                     "La velocidad del programa", "La cantidad de líneas"],
             "m": "Si no se respeta, el programa ni siquiera arranca."},
            {"q": "«mover 10 pasos» dentro de «repetir 4 veces» hace que el objeto…",
             "ops": ["Avance 40 pasos en total", "Avance 10 pasos", "No se mueva"],
             "m": "El bloque de adentro se ejecuta una vez por repetición."},
            {"q": "¿Qué significa anidar bloques?",
             "ops": ["Poner una estructura adentro de otra", "Ponerlas una al lado de la otra",
                     "Borrar una estructura"],
             "m": "Un if adentro de un for es un ejemplo de anidamiento."},
            {"q": "¿Para qué sirve comentar un programa?",
             "ops": ["Para explicar qué hace cada parte a quien lo lea después",
                     "Para que se ejecute más rápido", "Para agregar funciones"],
             "m": "Los comentarios no se ejecutan: son para las personas."},
        ],
    },
    {
        "id": "etapas_diseno_6", "grado": 6, "area": "logica",
        "titulo": "Las 5 etapas del diseño", "icono": "💡",
        "mecanica": "ordenar",
        "consigna": "Ordená el proceso de diseño. Tocá en orden.",
        "explica": "Primero se entiende el problema; recién al final se evalúa la solución.",
        "dc": "Tecnología: empatizar, definir, idear, prototipar y evaluar",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · T4",
        "saber": {"id": "TEC-6-diseno", "nombre": "Proceso de diseño",
                  "prereqs": []},
        "banco": [
            {"items": ["Preguntarles a los chicos qué les molesta del patio",
            ...
            {"items": ["Observar cómo usan la mochila los compañeros",
            ...
            {"items": ["Escuchar a quien tiene la necesidad",
            ...
            {"items": ["Registrar cómo se usa hoy el bebedero de la escuela",
            ...
            {"items": ["Averiguar por qué se traba la puerta del aula",
            ...
            {"items": ["Conversar con el bibliotecario sobre los libros perdidos",
            ...
            {"items": ["Mirar cómo se forma la fila del comedor",
    ...
    {
        "id": "sensores_6", "grado": 6, "area": "logica",
        "titulo": "Sensores y control reactivo", "icono": "📡",
        "mecanica": "trivia",
        "consigna": "Pensá qué detecta y qué hace el sistema.",
        "explica": "Un sistema reactivo mide, decide y actúa, todo el tiempo.",
        ...
        "banco": [
            ...
            {"q": "¿Cuál es la diferencia entre un sensor digital y uno analógico?",
             "ops": ["El digital entrega dos estados; el analógico, un rango de valores",
                     "El digital es más nuevo", "El analógico no funciona con electricidad"],
            ...
            {"q": "¿Qué es la realimentación en un sistema de control?",
             "ops": ["Volver a medir para ajustar la acción", "Cargar la batería",
            ...
            {"q": "¿Por qué hay que señalar cuando un contenido fue generado con inteligencia artificial?",
             "ops": ["Para que quien lo lea sepa cómo se produjo",
                     "Porque siempre está mal", "Porque es obligatorio por ley en todos lados"],
            ...
            {"q": "Si una IA genera un texto con un dato falso, ¿de quién es la responsabilidad de chequearlo?",
             "ops": ["De quien lo publica o lo usa", "De nadie", "Sólo de la empresa que la creó"],
            ...
            {"q": "Un sensor de luz que enciende el alumbrado al anochecer, ¿qué controla?",
             "ops": ["Un sistema reactivo de iluminación", "Un sistema manual",
                     "Nada, es un display"],
             "m": "Mide la luz ambiente y actúa en consecuencia."},
            {"q": "¿Qué necesita un sistema para ser reactivo?",
             "ops": ["Sensor, lógica de decisión y actuador", "Sólo un sensor",
                     "Sólo un motor"],
            ...
            {"q": "«Si la puerta está abierta más de 30 segundos, sonar la alarma.» ¿Qué mide el sensor?",
             "ops": ["Si la puerta está abierta o cerrada", "El volumen de la alarma",
                     "La temperatura"],
             "m": "Es un sensor digital de dos estados, combinado con un tiempo."},
            {"q": "¿Puede un sistema reactivo funcionar sin condicionales?",
             "ops": ["No, necesita decidir según lo que mide", "Sí, siempre",
                     "Sólo si es muy simple"],
             "m": "Reaccionar es exactamente lo que hace un condicional."},
        ],
    },

    # ── TRANSVERSALES de 6° (ESI, FEC, Financiera, Ambiental, Digital) ───────────
    # ⚠ Tr1 y Tr2 son ESI. Tr1 trata grooming: se escribe como contenido de
    # PROTECCIÓN —reconocer la señal, no guardar el secreto, avisar a un adulto— y
    # nunca describiendo cómo se comete. Marcado para revisión docente.
    {
        "id": "chat_seguro_6", "grado": 6, "area": "sociales",
        "titulo": "Chat seguro", "icono": "🛡️",
        "mecanica": "trivia",
        "consigna": "¿Qué conviene hacer en esta situación?",
        "explica": "Un adulto que te pide guardar un secreto de otros adultos está haciendo algo mal.",
        "dc": "Transversal ESI + Educación Digital: grooming como delito; cómo actuar",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · Tr1",
        "saber": {"id": "TRA-6-chat-seguro", "nombre": "Cuidado en entornos digitales",
                  "prereqs": []},
        "banco": [
            {"q": "Alguien que no conocés te escribe y dice ser de tu edad. ¿Qué conviene?",
             "ops": ["No aceptar y contarle a un adulto de confianza",
                     "Contestarle para ver quién es", "Bloquearlo y no decir nada"],
            ...
            {"q": "Un adulto te pide por chat que no le cuentes a nadie que hablan. ¿Qué significa?",
             "ops": ["Es una señal de alarma: hay que contarlo enseguida",
                     "Que quiere respetar tu privacidad", "Que es normal entre amigos"],
             "m": "Pedir secreto frente a los adultos que te cuidan es la señal más clara."},
            {"q": "¿Qué es el grooming?",
             "ops": ["Cuando un adulto contacta a un chico por internet para dañarlo",
                     "Un juego en línea", "Un tipo de virus informático"],
            ...
            {"q": "¿Está bien mandar fotos íntimas aunque te las pida alguien conocido?",
             "ops": ["No, nunca; y si te presionan hay que contarlo",
                     "Sí, si es alguien conocido", "Sí, si prometen borrarla"],
             "m": "Una vez enviada, la imagen deja de estar bajo tu control."},
            {"q": "Si un compañero comparte una foto tuya sin permiso, ¿qué hacés?",
             "ops": ["Avisarle a un adulto y guardar la evidencia",
                     "Compartir una de él", "No hacer nada"],
             "m": "Responder con lo mismo agrega un problema en vez de resolverlo."},
            {"q": "¿Por qué conviene tener el perfil privado?",
             "ops": ["Porque sólo ven tus cosas quienes vos aceptás",
                     "Porque así tenés más seguidores", "Porque la app anda más rápido"],
            ...
            {"q": "Alguien te dice que si no le contestás le va a pasar algo malo. ¿Qué es eso?",
             "ops": ["Una forma de manipulación: hay que contarlo",
                     "Una preocupación genuina", "Una broma sin importancia"],
             "m": "Generar culpa para que no cortes el contacto es una técnica conocida."},
            {"q": "¿Qué información NO conviene publicar?",
             "ops": ["Dirección, escuela y horarios", "Tu color favorito",
            ...
            {"q": "¿Cómo tiene que ser una contraseña segura?",
             "ops": ["Larga, con letras, números y símbolos, y no compartida",
                     "Tu fecha de nacimiento", "La misma para todas las cuentas"],
            ...
            {"q": "Si algo en internet te hace sentir incómodo, ¿qué es lo primero?",
             "ops": ["Contárselo a un adulto de confianza", "Resolverlo solo",
            ...
            {"q": "¿Qué significa que algo publicado en internet deja huella?",
             "ops": ["Que puede quedar aunque lo borres", "Que se borra solo",
    ...
    },
    {
        ...
        "saber": {"id": "TRA-6-its-violencia", "nombre": "ITS y tipos de violencia",
                  "prereqs": ["NAT-6-desarrollo"]},
        "banco": [
            {"q": "¿Qué significa ITS?",
             "ops": ["Infección de transmisión sexual", "Infección de tipo severo",
                     "Enfermedad hereditaria"],
             "m": "Se transmiten entre personas; no se heredan."},
            {"q": "¿El VIH se transmite por compartir el mate?",
             "ops": ["No, la saliva no transmite VIH", "Sí, siempre", "Sí, a veces"],
            ...
            {"q": "¿El VIH se transmite por abrazar a una persona que lo tiene?",
             "ops": ["No, el contacto cotidiano no lo transmite", "Sí", "Sólo si hay sudor"],
            ...
            {"q": "¿Se puede tener una ITS sin síntomas?",
             "ops": ["Sí, por eso los controles médicos son importantes",
                     "No, siempre hay síntomas", "Sólo en los adultos mayores"],
             "m": "Muchas cursan sin señales visibles durante mucho tiempo."},
            {"q": "¿Qué es la violencia física?",
             "ops": ["La que daña el cuerpo con golpes o empujones",
                     "La que se ejerce con palabras", "La que controla el dinero"],
             "m": "Cada tipo de violencia tiene su forma; nombrarlas ayuda a reconocerlas."},
            {"q": "¿Qué es la violencia psicológica?",
             "ops": ["Humillar, amenazar o descalificar de manera sostenida",
                     "Sólo los golpes", "Sólo el control del dinero"],
             "m": "No deja marcas visibles, y por eso a veces cuesta reconocerla."},
            {"q": "¿Qué es la violencia simbólica?",
             "ops": ["Mensajes e imágenes que naturalizan la desigualdad",
                     "Una discusión fuerte", "Un golpe accidental"],
             "m": "Circula en publicidades, chistes y frases repetidas."},
            {"q": "Si un compañero se burla todos los días de otro, ¿qué es?",
             "ops": ["Una forma de violencia, y hay que contarlo",
                     "Una broma sin importancia", "Un problema entre ellos dos"],
            ...
            {"q": "¿Dónde se puede consultar sobre salud sexual en la Argentina?",
             "ops": ["En un centro de salud, de forma gratuita y confidencial",
                     "En ningún lado", "Sólo en clínicas privadas"],
             "m": "La atención en el sistema público es gratuita y confidencial."},
            {"q": "Si alguien te toca sin tu permiso, ¿qué hacés?",
             "ops": ["Decir que no y contárselo a un adulto de confianza",
                     "Callarte para no hacer lío", "Esperar a ver si se repite"],
             "m": "Tu cuerpo es tuyo, y avisar es siempre lo correcto."},
            {"q": "¿Existe una ITS que se cure sola sin tratamiento?",
             "ops": ["No conviene asumirlo: hay que consultar siempre",
                     "Sí, todas se curan solas", "Sí, la mayoría"],
            ...
            {"q": "¿Qué hace la vacuna contra el VPH?",
             "ops": ["Previene infecciones que pueden causar cáncer",
                     "Cura una infección ya presente", "Reemplaza al preservativo"],
             "m": "Está en el calendario nacional y es gratuita."},
        ],
    },
    {
        "id": "tres_poderes_6", "grado": 6, "area": "sociales",
        "titulo": "Los tres poderes y la ley", "icono": "⚖️",
        "mecanica": "clasificar",
        "consigna": "¿Qué poder hace esto?",
        "explica": "Uno hace las leyes, otro las aplica y otro las hace cumplir en los juicios.",
        "categorias": [{"cat": "legislativo", "label": "🏛️ Legislativo"},
                       {"cat": "ejecutivo", "label": "🏢 Ejecutivo"},
                       {"cat": "judicial", "label": "⚖️ Judicial"}],
        "dc": "Transversal FEC: división de poderes; sanción de las leyes; sufragio",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · Tr3",
        "saber": {"id": "TRA-6-poderes", "nombre": "División de poderes",
                  "prereqs": ["SOC-6-voto"]},
        "banco": [
            {"it": "Sancionar una ley nueva", "cat": "legislativo",
             "m": "Hacer las leyes es la función del Congreso."},
            {"it": "Reglamentar y hacer cumplir una ley ya sancionada", "cat": "ejecutivo",
             "m": "El Ejecutivo administra y ejecuta lo que la ley establece."},
            {"it": "Resolver un juicio entre dos personas", "cat": "judicial",
             "m": "Juzgar y aplicar la ley a un caso concreto es del Poder Judicial."},
            {"it": "Debatir un proyecto en la Cámara de Diputados", "cat": "legislativo",
             "m": "Diputados y Senadores integran el Congreso."},
            {"it": "Nombrar a los ministros del gabinete", "cat": "ejecutivo",
             "m": "El Presidente encabeza el Poder Ejecutivo."},
            {"it": "Declarar que una ley es inconstitucional", "cat": "judicial",
             "m": "El control de constitucionalidad lo ejerce la Justicia."},
            {"it": "Aprobar el presupuesto nacional", "cat": "legislativo",
             "m": "El Congreso lo discute y lo aprueba."},
            {"it": "Vetar total o parcialmente una ley", "cat": "ejecutivo",
             "m": "Es una facultad del Presidente dentro del proceso de sanción."},
            {"it": "Dictar una sentencia", "cat": "judicial",
             "m": "Es el acto por el cual un juez resuelve un caso."},
            {"it": "Discutir el proyecto en el Senado", "cat": "legislativo",
             "m": "El Senado es la otra cámara del Congreso."},
            {"it": "Conducir la administración del país", "cat": "ejecutivo",
             "m": "Es la función central del Poder Ejecutivo."},
            {"it": "Integrar la Corte Suprema de Justicia", "cat": "judicial",
             "m": "Es el máximo tribunal del país."},
            {"it": "Modificar una ley existente", "cat": "legislativo",
             "m": "Sólo el Congreso puede cambiar una ley."},
            {"it": "Promulgar una ley aprobada por el Congreso", "cat": "ejecutivo",
             "m": "Es el paso final para que la ley entre en vigencia."},
            {"it": "Investigar si alguien cometió un delito, a cargo de un fiscal", "cat": "judicial",
             "m": "La investigación penal forma parte del ámbito judicial."},
            {"it": "Tratar un proyecto en comisión antes de votarlo", "cat": "legislativo",
             "m": "Las comisiones son parte del trabajo del Congreso."},
        ],
    },
    {
        "id": "presupuesto_6", "grado": 6, "area": "matematica",
        "titulo": "Billetera virtual y presupuesto", "icono": "💳",
        "mecanica": "trivia",
        "consigna": "Cuidá la plata y los datos.",
        "explica": "Un presupuesto reparte el 100% de lo que entra: no puede sumar más.",
        "dc": "Transversal Educación Financiera: medios de pago, seguridad y presupuesto",
        "fuente": "docs/auditoria-dc-caba/grado-6.md · Tr4",
        "saber": {"id": "TRA-6-financiera", "nombre": "Presupuesto y medios de pago",
                  "prereqs": ["MAT-6-porcentaje"]},
        "banco": [
            ...
            {"q": "¿Qué es un gasto fijo?", "ops": ["El que se repite igual todos los meses",
                     "El que cambia según el mes", "El que se hace una sola vez"],
            ...
            {"q": "Alguien te escribe diciendo que ganaste un premio y te pide tu clave. ¿Qué es?",
             "ops": ["Una estafa: nunca se comparte la clave", "Un premio real",
                     "Un aviso del banco"],
             "m": "Ninguna entidad legítima pide la clave por mensaje."},
            {"q": "¿Qué es un código de seguridad de un solo uso?",
             "ops": ["Un código que confirma una operación y no se comparte con nadie",
                     "Tu contraseña habitual", "El número de tu documento"],
             "m": "Pedírtelo por teléfono o chat es la señal de estafa más frecuente."},
            {"q": "¿Qué diferencia hay entre débito y crédito?",
             "ops": ["El débito descuenta al instante; el crédito, después",
                     "Son exactamente lo mismo", "El débito siempre cobra interés"],
             "m": "Con crédito estás usando plata que todavía no pagaste."},
            {"q": "Si pagás en cuotas «sin interés», ¿siempre pagás lo mismo?",
             "ops": ["Conviene comparar: a veces el precio de contado es menor",
                     "Sí, siempre es igual", "No, siempre es más caro"],
             "m": "El «sin interés» a veces ya está incluido en el precio de lista."},
            {"q": "¿Qué es ahorrar?", "ops": ["Guardar una parte de lo que entra para después",
                     "Gastar menos de lo que se puede", "No comprar nunca nada"],
             "m": "No es privarse de todo: es apartar una parte de forma planificada."},
            {"q": "Si gastás más de lo que entra, ¿qué pasa?",
             "ops": ["Te endeudás", "Ahorrás", "No pasa nada"],
            ...
            {"q": "¿Conviene usar la misma clave para el banco y para las redes?",
             "ops": ["No, si roban una quedan expuestas todas",
                     "Sí, es más fácil de recordar", "Sí, si es larga"],
             "m": "Repetir claves multiplica el daño de un solo robo."},
            {"q": "En un presupuesto, ¿qué son los ingresos?",
             "ops": ["La plata que entra", "La plata que sale", "Lo que se ahorra"],
            ...
            {"q": "Un link que llega por mensaje y pide iniciar sesión en el banco, ¿qué conviene hacer?",
             "ops": ["No entrar y abrir la app oficial por separado",
                     "Entrar y verificar", "Reenviarlo para consultar"],
             "m": "Los links falsos imitan la página real: siempre conviene entrar por la vía propia."},
            {"q": "¿Qué es una transferencia?",
             "ops": ["El envío de dinero de una cuenta a otra", "Un tipo de préstamo",
            ...
            {"q": "Si querés comprar algo que cuesta más de lo que tenés, ¿qué opción es más sana?",
             "ops": ["Planificar un ahorro mensual hasta juntarlo",
                     "Pedirlo prestado sin plan", "Comprarlo igual en muchas cuotas"],
             "m": "Endeudarse sin plan es lo que convierte una compra en un problema."},
        ],
    },
    {
        "id": "economia_circular_6", "grado": 6, "area": "sociales",
        "titulo": "Economía circular y el Riachuelo", "icono": "🔄",
        "mecanica": "clasificar",
        "consigna": "¿Es economía lineal o circular?",
        "explica": "Lineal: extraer, usar y tirar. Circular: que lo usado vuelva a entrar.",
        "categorias": [{"cat": "lineal", "label": "➡️ Lineal"},
                       {"cat": "circular", "label": "🔄 Circular"}],
        ...
        "saber": {"id": "TRA-6-circular", "nombre": "Economía circular",
                  "prereqs": ["SOC-6-escalas"]},
        "banco": [
            {"it": "Comprar una botella, usarla una vez y tirarla", "cat": "lineal",
             "m": "Extraer, usar y descartar: el modelo lineal."},
            {"it": "Devolver el envase para que lo vuelvan a llenar", "cat": "circular",
             "m": "El material vuelve al circuito en vez de convertirse en residuo."},
            {"it": "Reparar el celular en vez de cambiarlo", "cat": "circular",
             "m": "Alargar la vida útil es una estrategia circular."},
            {"it": "Diseñar un producto para que dure poco a propósito", "cat": "lineal",
             "m": "La obsolescencia programada acelera el descarte."},
            {"it": "Compostar los restos de comida", "cat": "circular",
             "m": "La materia orgánica vuelve al suelo como nutriente."},
            {"it": "Enterrar toda la basura sin separar", "cat": "lineal",
             "m": "Todo termina como residuo, y además genera metano."},
            {"it": "Fabricar remeras con hilo de botellas recicladas", "cat": "circular",
            ...
            {"it": "Cambiar de electrodoméstico cada dos años porque sale más barato que arreglarlo",
             "cat": "lineal", "m": "El diseño que impide reparar empuja al modelo lineal."},
            {"it": "Donar la ropa que ya no usás", "cat": "circular",
             "m": "Extiende la vida útil de la prenda."},
            {"it": "Usar vasos descartables en una fiesta", "cat": "lineal",
             "m": "Un solo uso y al residuo."},
            {"it": "Recuperar metales de aparatos electrónicos viejos", "cat": "circular",
             "m": "Evita extraer material nuevo de la naturaleza."},
            {"it": "Verter efluentes industriales sin tratar al río", "cat": "lineal",
             "m": "Es el tipo de práctica que contaminó la cuenca Matanza-Riachuelo."},
            {"it": "Tratar los efluentes antes de devolver el agua al río", "cat": "circular",
             "m": "El agua vuelve al ciclo en condiciones de ser reutilizada."},
            {"it": "Comprar a granel con envase propio", "cat": "circular",
             "m": "Evita generar un envase nuevo en cada compra."},
            {"it": "Reemplazar el teléfono porque salió un modelo nuevo", "cat": "lineal",
             "m": "El descarte no responde a una falla sino al recambio."},
            {"it": "Recuperar la ribera del Riachuelo y sanear la cuenca", "cat": "circular",
             "m": "Restaurar el ambiente para que vuelva a cumplir sus funciones."},
        ],
    },

    # ══════════════════════════════════════════════════════════════════════════════
    # 7° GRADO — docs/auditoria-dc-caba/grado-7.md
    # ══════════════════════════════════════════════════════════════════════════════
    # MATEMÁTICA · las paramétricas. La auditoría de 7° insiste: las plantillas son
    # "el activo más valioso" del área, porque un banco fijo para B4 ya es memoria.
    {
        "id": "potencias_7", "grado": 7, "area": "matematica",
        "titulo": "Potencias y raíces", "icono": "🔺",
        "mecanica": "parametrica",
        "consigna": "Calculá la potencia.",
        "explica": "Elevar al cuadrado es multiplicar el número por sí mismo, no por 2.",
        "dc": "Potenciación y raíz cuadrada; reversibilidad entre las dos",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M1",
        "saber": {"id": "MAT-7-potencias", "nombre": "Potencias y raíces", "prereqs": []},
        "plantilla": {
            "q": "¿Cuánto es {a} al cuadrado?",
            "vars": {"a": {"rango": [2, 30], "paso": 1}},
            "ok": "a * a",
            # el primero es EL error del tema: confundir «al cuadrado» con «por 2»
            "distractores": ["a * 2", "a * a - a", "a * a + a"],
            "tope": 1000,
            "m": "Al cuadrado es {a} × {a} = {ok}. Multiplicar por 2 da otra cosa: el "
                 "exponente dice cuántas VECES se repite el número como factor.",
        },
    },
    {
        "id": "expresion_objetivo_7", "grado": 7, "area": "matematica",
        "titulo": "Expresión objetivo", "icono": "🎯",
        "mecanica": "parametrica",
        "consigna": "Resolvé respetando el paréntesis.",
        "explica": "El paréntesis cambia el orden: lo de adentro va primero.",
        "dc": "Cálculos combinados; jerarquía; propiedades de las operaciones",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M4",
        "saber": {"id": "MAT-7-combinados", "nombre": "Cálculos combinados",
                  "prereqs": ["MAT-7-potencias"]},
        "plantilla": {
            "q": "({a} + {b}) × {c}",
            "vars": {
                "a": {"rango": [2, 40], "paso": 1},
            ...
            "ok": "(a + b) * c",
            # el primero es ignorar el paréntesis y aplicar la jerarquía por defecto
            "distractores": ["a + b * c", "a + b + c", "a * b * c"],
            "tope": 1000,
            "m": "El paréntesis manda: primero {a} + {b}, y ese resultado por {c}. Da {ok}. "
                 "Sin el paréntesis la multiplicación iría primero y daría otra cosa.",
        },
    },
    {
        "id": "problemas_pasos_7", "grado": 7, "area": "matematica",
        "titulo": "Problemas de varios pasos", "icono": "🧭",
        "mecanica": "parametrica",
        "consigna": "Leé el enunciado y resolvé.",
        "explica": "Primero decidí qué operación resuelve cada paso, y en qué orden.",
        "dc": "Problemas de varios pasos; tratamiento de la información del enunciado",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M5b",
        "saber": {"id": "MAT-7-problemas", "nombre": "Problemas de varios pasos",
                  "prereqs": ["MAT-7-combinados"]},
        "plantilla": {
            "q": "Una librería compra {b} cajas de {a} cuadernos. Si vende {c} cuadernos, "
                 "¿cuántos le quedan?",
            "vars": {
                "a": {"rango": [10, 60], "paso": 1},
                "b": {"opciones": [3, 4, 5, 6, 8]},
                "c": {"rango": [12, 90], "paso": 1},
            },
            "ok": "a * b - c",
            "distractores": ["a * b", "a * b + c", "a + b - c"],
            "tope": 500,
            "m": "Dos pasos: primero cuántos entraron ({a} × {b}) y recién después restás "
                 "los {c} vendidos. Da {ok}. Contestar el total es el error más común.",
        },
    },
    {
        "id": "razon_porcentaje_7", "grado": 7, "area": "matematica",
        "titulo": "Razón y porcentaje", "icono": "📐",
        "mecanica": "parametrica",
        "consigna": "¿Cuántos son?",
        "explica": "El porcentaje es una razón con denominador 100.",
        "dc": "Razón; uso de los racionales para expresar porcentajes",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M8",
        "saber": {"id": "MAT-7-razon", "nombre": "Razón y porcentaje", "prereqs": []},
        "plantilla": {
            "q": "En un club de {a} chicos, el {p}% juega al fútbol. ¿Cuántos son?",
            "vars": {
                "a": {"rango": [10, 150], "paso": 10},
                "p": {"opciones": [10, 20, 50]},
            },
            "ok": "a * p / 100",
            # ninguno puede coincidir con la respuesta: `a / 10` era el resultado mismo
            # cuando p valía 10, y con un solo distractor vivo la tirada se descartaba
            "distractores": ["a * p / 10", "a - a * p / 100", "a + p"],
            # tope holgado: con 200 el distractor a×p/10 se pasaba y la tirada quedaba
            # con un solo distractor vivo, así que se descartaba
            "tope": 2000,
            "m": "El {p}% son {p} de cada 100: {a} × {p} ÷ 100 = {ok}. Ojo con correr mal "
                 "la coma y con contestar los que NO juegan.",
        },
    },
    {
        "id": "proporcionalidad_inversa_7", "grado": 7, "area": "matematica",
        "titulo": "Proporcionalidad inversa", "icono": "⏳",
        "mecanica": "parametrica",
        "consigna": "Más gente, menos días.",
        "explica": "En la inversa, lo que se mantiene constante es el PRODUCTO.",
        "dc": "Proporcionalidad inversa; distinguirla de la directa",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M10",
        "saber": {"id": "MAT-7-inversa", "nombre": "Proporcionalidad inversa",
                  "prereqs": ["MAT-7-razon"]},
        # a = días-persona (el producto constante). Múltiplo de 12 ⇒ divisible por 2, 3,
        # 4 y 6, así que el resultado cae entero sin necesidad de guardas.
        "plantilla": {
            "q": "Un trabajo lleva {a} días-persona. Si lo hacen {b} personas, "
                 "¿cuántos días tardan?",
            "vars": {
                "a": {"rango": [12, 96], "paso": 12},
                "b": {"opciones": [2, 3, 4, 6]},
            },
            "ok": "a / b",
            # el primero es tratarla como DIRECTA: multiplicar en vez de dividir
            "distractores": ["a * b", "a - b", "a / 2"],
            "tope": 200,
            "m": "Si son más personas, tardan MENOS: hay que dividir. {a} ÷ {b} = {ok} días. "
                 "Multiplicar sería tratarla como proporcionalidad directa.",
        },
    },
    {
        "id": "areas_7", "grado": 7, "area": "matematica",
        "titulo": "Áreas del paralelogramo", "icono": "🔷",
        "mecanica": "parametrica",
        "consigna": "Calculá el área.",
        "explica": "El área del paralelogramo es base por ALTURA, no por el lado inclinado.",
        "dc": "Área de paralelogramo, trapecio y romboide; perímetro y área del círculo",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M11",
        "saber": {"id": "MAT-7-areas", "nombre": "Áreas de figuras planas", "prereqs": []},
        "plantilla": {
            ...
            "ok": "a * b",
            # el primero es confundir área con perímetro; el segundo, con el triángulo
            "distractores": ["2 * (a + b)", "a * b / 2", "a + b"],
            "tope": 600,
            "m": "Área es base × altura: {a} × {b} = {ok} cm². Sumar los lados da el "
                 "perímetro, y dividir por 2 da el triángulo.",
        },
    },

    # MATEMÁTICA · lo que no se puede parametrizar (fracciones y decimales como texto,
    # criterios que piden razonar, y las medidas estadísticas).
    {
        "id": "numeracion_7", "grado": 7, "area": "matematica",
        "titulo": "Número y sistema de numeración", "icono": "🔢",
        "mecanica": "trivia",
        "consigna": "Pensá cuánto vale cada cifra.",
        "explica": "El valor de una cifra depende del LUGAR que ocupa, no de su forma.",
        "dc": "Valor posicional, descomposición polinómica y sistema sexagesimal",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M0",
        "saber": {"id": "MAT-7-numeracion", "nombre": "Sistema de numeración", "prereqs": []},
        "banco": [
            {"q": "En 4.708, ¿cuánto vale el 7?", "ops": ["700", "70", "7"],
             "m": "Está en el lugar de las centenas: vale 7 × 100."},
            {"q": "En 25.031, ¿cuánto vale el 5?", "ops": ["5.000", "500", "50"],
             "m": "Ocupa el lugar de las unidades de mil."},
            {"q": "¿Cómo se descompone 3.406?",
             "ops": ["3×1.000 + 4×100 + 0×10 + 6", "3×100 + 4×10 + 6", "34×100 + 6"],
             "m": "Cada cifra se multiplica por la potencia de 10 de su lugar."},
            {"q": "¿Cuál es la descomposición polinómica de 250?",
             "ops": ["2×10² + 5×10¹ + 0", "2×10 + 5", "25×10"],
             "m": "Polinómica quiere decir con potencias de 10, no cualquier forma de escribirlo."},
            {"q": "¿Cuántos minutos hay en 2 horas y 15 minutos?", "ops": ["135", "215", "75"],
             "m": "Cada hora son 60 minutos: 2 × 60 + 15. El sistema sexagesimal no es decimal."},
            {"q": "¿Cuántos segundos hay en 3 minutos?", "ops": ["180", "300", "30"],
             "m": "Cada minuto tiene 60 segundos, no 100."},
            {"q": "¿Cuánto es 90 minutos en horas y minutos?",
             "ops": ["1 hora y 30 minutos", "9 horas", "1 hora y 9 minutos"],
             "m": "60 forman una hora y sobran 30."},
            {"q": "En el número 8.888, ¿las cuatro cifras valen lo mismo?",
             "ops": ["No: valen 8.000, 800, 80 y 8", "Sí, todas valen 8",
                     "Sí, porque son iguales"],
             "m": "Ésa es la idea de valor posicional: la misma cifra vale distinto según el lugar."},
            {"q": "¿Cuál es mayor: 10² o 2¹⁰?", "ops": ["2¹⁰, que es 1.024", "10², que es 100",
                     "Son iguales"],
             "m": "10² = 100 y 2¹⁰ = 1.024. El exponente pesa más de lo que parece."},
            {"q": "¿Cuánto es 10⁴?", "ops": ["10.000", "40", "1.000"],
            ...
            {"q": "¿Cuánto es 1 hora y 45 minutos en minutos?", "ops": ["105", "145", "60"],
             "m": "60 + 45. Pegar los números como si fuera decimal es el error clásico."},
            {"q": "¿Qué representa el 0 en el número 507?",
             "ops": ["Que no hay decenas", "Que el número vale menos", "Nada, se puede sacar"],
             "m": "Sacarlo daría 57: el cero guarda el lugar."},
            {"q": "¿Cuál de estos números es mayor?", "ops": ["1.000.000", "999.999", "100.000"],
             "m": "Contá las cifras primero: siete gana contra seis."},
            {"q": "¿Cuántas horas son 210 minutos?", "ops": ["3 horas y 30 minutos", "2 horas y 10 minutos",
                     "21 horas"],
             "m": "210 ÷ 60 da 3 y sobran 30."},
            {"q": "En 7,25 ¿cuánto vale el 2?", "ops": ["2 décimos", "2 centésimos", "2 unidades"],
             "m": "El primer lugar después de la coma son los décimos."},
        ],
    },
    {
        "id": "divisibilidad_7", "grado": 7, "area": "matematica",
        "titulo": "Tribunal de divisibilidad", "icono": "⚖️",
        "mecanica": "trivia",
        "consigna": "Aplicá el criterio, no dividas.",
        "explica": "Por 3 y por 9 se suman las cifras; por 4 se miran las dos últimas.",
        "dc": "Criterios de divisibilidad por 3, 4, 6, 8 y 9",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M2",
        "saber": {"id": "MAT-7-divisibilidad", "nombre": "Criterios de divisibilidad 3-4-6-8-9",
                  "prereqs": ["MAT-7-numeracion"]},
        "banco": [
            {"q": "¿Cuál es el criterio de divisibilidad por 3?",
             "ops": ["Que la suma de sus cifras sea múltiplo de 3", "Que termine en 3",
                     "Que sea impar"],
             "m": "Terminar en 3 no dice nada: 13 no es múltiplo de 3."},
            {"q": "¿Es 234 divisible por 3?", "ops": ["Sí: 2+3+4 = 9", "No", "Sólo por 2"],
             "m": "9 es múltiplo de 3, así que 234 también lo es."},
            {"q": "¿Cuál es el criterio por 9?",
             "ops": ["Que la suma de sus cifras sea múltiplo de 9", "Que termine en 9",
                     "Que sea múltiplo de 3 y de 6"],
             "m": "Es el mismo mecanismo que el de 3, pero exigiendo múltiplo de 9."},
            {"q": "¿Es 4.518 divisible por 9?", "ops": ["Sí: 4+5+1+8 = 18", "No", "Sólo por 3"],
             "m": "18 es múltiplo de 9. Todo múltiplo de 9 es además múltiplo de 3."},
            {"q": "¿Cuál es el criterio por 4?",
             "ops": ["Que las dos últimas cifras formen un múltiplo de 4",
                     "Que sea par", "Que termine en 4"],
             "m": "Ser par no alcanza: 14 es par y no es múltiplo de 4."},
            {"q": "¿Es 1.316 divisible por 4?", "ops": ["Sí: 16 es múltiplo de 4", "No",
                     "Sólo por 2"],
             "m": "Alcanza con mirar las dos últimas cifras."},
            {"q": "¿Cuál es el criterio por 6?",
             "ops": ["Que sea divisible por 2 Y por 3 a la vez", "Que termine en 6",
                     "Que sea divisible por 3 solamente"],
             "m": "6 = 2 × 3, así que tiene que cumplir los dos criterios."},
            {"q": "¿Es 132 divisible por 6?", "ops": ["Sí: es par y 1+3+2 = 6", "No",
                     "Sólo por 2"],
             "m": "Cumple los dos criterios a la vez."},
            {"q": "¿Es 246 divisible por 4?", "ops": ["No: 46 no es múltiplo de 4",
                     "Sí, porque es par", "Sí, porque 2+4+6 = 12"],
             "m": "La suma de cifras sirve para 3 y 9, no para 4."},
            {"q": "¿Cuál es el criterio por 8?",
             "ops": ["Que las tres últimas cifras formen un múltiplo de 8",
                     "Que sea múltiplo de 4 y de 2", "Que termine en 8"],
             "m": "Ser múltiplo de 4 no alcanza: 12 es múltiplo de 4 y no de 8."},
            {"q": "Si un número es divisible por 9, ¿es divisible por 3?",
             "ops": ["Sí, siempre", "No, nunca", "Sólo si es par"],
             "m": "Todo múltiplo de 9 lo es de 3, porque 9 contiene al 3."},
            {"q": "Si un número es divisible por 3, ¿es divisible por 9?",
             "ops": ["No necesariamente", "Sí, siempre", "Sólo si es impar"],
             "m": "12 es múltiplo de 3 y no de 9. La implicación va en un solo sentido."},
            {"q": "¿Es 720 divisible por 8?", "ops": ["Sí: 720 ÷ 8 = 90", "No",
                     "Sólo por 4"],
             "m": "Las tres últimas cifras son 720, que es múltiplo de 8."},
            {"q": "¿Por qué sirve conocer los criterios?",
             "ops": ["Para simplificar fracciones y factorizar sin hacer la división",
                     "Para sumar más rápido", "Para escribir números grandes"],
             "m": "Es la herramienta que hace rápida la simplificación."},
            {"q": "¿Es 555 divisible por 3?", "ops": ["Sí: 5+5+5 = 15", "No, es impar",
                     "Sólo por 5"],
             "m": "La paridad no tiene nada que ver con el criterio del 3."},
        ],
    },
    {
        "id": "mcm_dcm_7", "grado": 7, "area": "matematica",
        "titulo": "Múltiplo y divisor común", "icono": "⚙️",
        "mecanica": "trivia",
        "consigna": "¿Te piden un múltiplo o un divisor?",
        "explica": "El mcm es más grande que los números; el DCM, más chico o igual.",
        "dc": "Mínimo común múltiplo y divisor común mayor en problemas",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M3",
        "saber": {"id": "MAT-7-mcm", "nombre": "mcm y DCM", "prereqs": ["MAT-7-divisibilidad"]},
        "banco": [
            {"q": "¿Cuál es el mcm de 6 y 8?", "ops": ["24", "48", "2"],
             "m": "48 también es múltiplo común, pero el MÍNIMO es 24. El 2 es el divisor."},
            {"q": "¿Cuál es el DCM de 12 y 18?", "ops": ["6", "36", "3"],
             "m": "36 es el mcm. Entre los divisores comunes (1, 2, 3, 6) el mayor es 6."},
            {"q": "El mcm de dos números, ¿es mayor o menor que ellos?",
             "ops": ["Mayor o igual", "Siempre menor", "Siempre igual al más chico"],
             "m": "Es un múltiplo, así que nunca puede ser más chico."},
            {"q": "El DCM de dos números, ¿es mayor o menor que ellos?",
             "ops": ["Menor o igual", "Siempre mayor", "Siempre 1"],
            ...
            {"q": "Dos colectivos salen cada 12 y cada 18 minutos. ¿Cada cuánto coinciden?",
             "ops": ["Cada 36 minutos (mcm)", "Cada 6 minutos (DCM)", "Cada 30 minutos"],
            ...
            {"q": "¿Para qué sirve el DCM al simplificar una fracción?",
             "ops": ["Para llevarla de una vez a su mínima expresión",
                     "Para agrandarla", "Para sumarla"],
             "m": "Dividiendo por el DCM llegás en un solo paso a la mínima expresión."},
            {"q": "¿Cuál es el mcm de 2, 3 y 4?", "ops": ["12", "24", "6"],
            ...
            {"q": "Dos luces parpadean cada 6 y cada 10 segundos. ¿Cada cuánto coinciden?",
             "ops": ["Cada 30 segundos", "Cada 60 segundos", "Cada 2 segundos"],
             "m": "El mcm de 6 y 10 es 30; 60 también es común pero no es el mínimo."},
        ],
    },
    {
        "id": "multiplicar_fracciones_7", "grado": 7, "area": "matematica",
        "titulo": "Multiplicar y dividir fracciones", "icono": "🍰",
        "mecanica": "trivia",
        "consigna": "Para dividir, multiplicá por la inversa.",
        "explica": "Dividir por una fracción es multiplicar por esa fracción dada vuelta.",
        "dc": "Multiplicación y división de fracciones; la fracción inversa",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M5",
        "saber": {"id": "MAT-7-fracciones", "nombre": "Multiplicación y división de fracciones",
                  "prereqs": []},
        "banco": [
            {"q": "2/3 × 3/5 =", "ops": ["2/5", "5/8", "6/8"],
             "m": "6/15, que simplificado es 2/5. Los denominadores se multiplican, no se suman."},
            {"q": "1/2 ÷ 1/4 =", "ops": ["2", "1/8", "1/2"],
             "m": "Es 1/2 × 4/1 = 4/2 = 2. Preguntate cuántos cuartos entran en un medio."},
            {"q": "3/4 ÷ 1/2 =", "ops": ["3/2", "3/8", "1/2"],
             "m": "3/4 × 2/1 = 6/4 = 3/2. Multiplicar en vez de invertir da 3/8."},
            {"q": "Para dividir por 2/5 hay que multiplicar por…", "ops": ["5/2", "2/5", "1/5"],
             "m": "La inversa se obtiene dando vuelta los dos términos."},
            {"q": "1/3 × 6 =", "ops": ["2", "18", "1/18"],
             "m": "6/3 = 2. Un tercio de seis."},
            {"q": "¿Dividir por 1/2 agranda o achica?", "ops": ["Agranda: da el doble",
                     "Achica: da la mitad", "No cambia"],
             "m": "Preguntate cuántas mitades entran: en 3 entran 6."},
            {"q": "5/6 × 2/5 =", "ops": ["1/3", "7/11", "10/11"],
             "m": "10/30, que simplificado es 1/3."},
            {"q": "2 ÷ 1/4 =", "ops": ["8", "1/2", "2/4"],
             "m": "¿Cuántos cuartos entran en 2? Ocho."},
            {"q": "¿Cuánto da 4/7 × 7/4?", "ops": ["1", "28/28 y algo", "8/11"],
            ...
            {"q": "6 ÷ 2/3 =", "ops": ["9", "4", "12/3 sin simplificar"],
             "m": "6 × 3/2 = 18/2 = 9. En 6 entran nueve dos tercios."},
        ],
    },
    {
        "id": "decimales_periodo_7", "grado": 7, "area": "matematica",
        "titulo": "Decimales y el período escondido", "icono": "♾️",
        "mecanica": "trivia",
        "consigna": "¿Se corta o se repite?",
        "explica": "Al dividir, o la cuenta termina, o una parte se repite para siempre.",
        "dc": "Multiplicación y división de decimales; expresiones periódicas",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M6",
        "saber": {"id": "MAT-7-decimales", "nombre": "Decimales exactos y periódicos",
                  "prereqs": ["MAT-7-fracciones"]},
        "banco": [
    ...
    {
        "id": "densidad_7", "grado": 7, "area": "matematica",
        "titulo": "Zoom infinito", "icono": "🔬",
        "mecanica": "trivia",
        "consigna": "Siempre entra otro en el medio.",
        "explica": "Entre dos racionales siempre hay otro. Con los naturales no pasa.",
        "dc": "Densidad de los racionales; orden con reglas distintas de los naturales",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M7",
        "saber": {"id": "MAT-7-densidad", "nombre": "Densidad de los racionales",
                  "prereqs": ["MAT-7-decimales"]},
        "banco": [
            {"q": "¿Qué número está entre 1/2 y 3/4?", "ops": ["5/8", "1/4", "4/4"],
             "m": "A octavos: 4/8, 5/8 y 6/8. El 5/8 cae justo en el medio."},
            {"q": "¿Cuántos racionales hay entre 0 y 1?", "ops": ["Infinitos", "Cien", "Ninguno"],
             "m": "Ésa es la propiedad de densidad."},
            {"q": "Entre 3 y 4, ¿hay algún NATURAL?", "ops": ["No, ninguno", "Sí, uno", "Infinitos"],
             "m": "Los naturales son discretos: 3 y 4 son consecutivos. Los racionales no funcionan así."},
            {"q": "¿Cuál es MAYOR: 3/7 o 4/9?", "ops": ["4/9", "3/7", "Son iguales"],
             "m": "A denominador 63: 27/63 contra 28/63. Gana 4/9 por poco."},
            {"q": "¿Cómo se busca un número entre dos fracciones?",
             "ops": ["Se las lleva a un denominador común más grande",
                     "Se suman los numeradores", "Se restan"],
             "m": "Ampliando aparecen lugares intermedios que antes no se veían."},
            {"q": "¿Qué número está entre 0,25 y 0,26?", "ops": ["0,255", "0,3", "0,2"],
             "m": "Agregando un decimal más siempre aparece uno en el medio."},
            {"q": "¿Cuál es MENOR: 5/8 o 2/3?", "ops": ["5/8", "2/3", "Son iguales"],
             "m": "A denominador 24: 15/24 contra 16/24."},
            {"q": "Con los naturales, ¿cuál sigue después del 7?", "ops": ["El 8", "El 7,5",
                     "Hay infinitos"],
             "m": "Entre naturales hay un siguiente; entre racionales no existe «el siguiente»."},
            {"q": "¿Cuál es MAYOR: 0,8 o 4/5?", "ops": ["Son iguales", "0,8", "4/5"],
             "m": "4/5 es exactamente 0,8: son dos escrituras del mismo número."},
            {"q": "¿Qué fracción está entre 1/3 y 1/2?", "ops": ["5/12", "1/4", "2/3"],
             "m": "A doceavos: 4/12 y 6/12; el 5/12 queda justo en el medio."},
            {"q": "¿Un número con más cifras decimales es siempre mayor?",
             "ops": ["No: 0,25 es menor que 0,3", "Sí, siempre", "Sólo si empieza con 0"],
             "m": "Hay que comparar lugar por lugar desde la izquierda."},
            {"q": "¿Cuántos números hay entre 0,999 y 1?", "ops": ["Infinitos", "Uno", "Ninguno"],
             "m": "Aunque parezcan pegados, siempre se puede agregar un decimal más."},
            {"q": "Ordenados de menor a mayor: 2/5 · 1/2 · 3/8",
             "ops": ["3/8 · 2/5 · 1/2", "2/5 · 3/8 · 1/2", "1/2 · 2/5 · 3/8"],
             "m": "A cuarentavos: 15/40, 16/40 y 20/40."},
            {"q": "¿Cuál está entre 2 y 2,1?", "ops": ["2,05", "2,5", "1,95"],
             "m": "Hay que mirar el segundo decimal."},
        ],
    },
    {
        "id": "proporcionalidad_grafico_7", "grado": 7, "area": "matematica",
        "titulo": "Proporcionalidad en el plano", "icono": "📈",
        "mecanica": "trivia",
        "consigna": "Mirá si pasa por el origen.",
        "explica": "Una proporcionalidad directa se grafica como una recta que pasa por el (0,0).",
        "dc": "Representación cartesiana de la proporcionalidad directa",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M9",
        "saber": {"id": "MAT-7-grafico", "nombre": "Proporcionalidad en el plano cartesiano",
                  "prereqs": ["MAT-7-razon"]},
        "banco": [
            {"q": "¿Cómo se ve en el plano una proporcionalidad directa?",
             "ops": ["Una recta que pasa por el origen", "Una curva",
                     "Una recta que corta el eje arriba del cero"],
             "m": "Si no pasa por el (0,0), hay un valor fijo de arranque y ya no es proporcional."},
            {"q": "Si 1 kg cuesta $500, ¿cuánto cuestan 4 kg?", "ops": ["$2.000", "$504", "$125"],
             "m": "La constante es 500: se multiplica."},
            {"q": "¿Qué es la constante de proporcionalidad?",
             "ops": ["El número por el que se multiplica siempre", "El punto de partida",
    ...
    },
    {
        ...
        "banco": [
            ...
            {"q": "Sueldos de 1.000, 1.100, 1.200 y 20.000. ¿Qué medida representa mejor?",
             "ops": ["La mediana, porque el 20.000 desvía la media",
                     "La media, siempre es la mejor", "La moda"],
            ...
            {"q": "¿Puede una distribución tener más de una moda?",
             "ops": ["Sí, si hay empate en cantidad de apariciones", "No, nunca", "Sólo si hay 3 datos"],
             "m": "Se la llama bimodal cuando hay dos."},
            {"q": "¿Qué medida NO cambia si le agrego un dato altísimo?",
             "ops": ["La moda, casi siempre", "La media", "El total"],
             "m": "La media es la más sensible a los extremos."},
            {"q": "¿Cuál es la media de 5, 5, 5 y 5?", "ops": ["5", "20", "0"],
             "m": "Si todos los datos son iguales, la media es ese valor."},
            {"q": "Para informar «el argentino promedio», ¿qué se usa?",
             "ops": ["Depende: con datos muy dispares conviene la mediana",
                     "Siempre la media", "Siempre la moda"],
             "m": "Elegir la medida pertinente ES el contenido del tema."},
        ],
    },
    {
        "id": "probabilidad_arbol_7", "grado": 7, "area": "matematica",
        "titulo": "Árbol de la probabilidad", "icono": "🌳",
        "mecanica": "trivia",
        "consigna": "Contá los casos favorables y los posibles.",
        "explica": "La probabilidad es casos favorables sobre casos posibles.",
        "dc": "Diagramas de árbol; equiprobabilidad; casos favorables y posibles",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M13",
        "saber": {"id": "MAT-7-probabilidad", "nombre": "Probabilidad y diagramas de árbol",
                  "prereqs": ["MAT-7-estadistica"]},
        "banco": [
            ...
            {"q": "¿Para qué sirve un diagrama de árbol?",
             "ops": ["Para listar ordenadamente todos los casos posibles",
                     "Para calcular la media", "Para ordenar de mayor a menor"],
             "m": "Cada rama es una posibilidad y ninguna se pierde."},
            {"q": "¿Cuál es la probabilidad de un suceso imposible?", "ops": ["0", "1", "1/2"],
             "m": "Cero casos favorables sobre los posibles."},
            {"q": "¿Cuál es la probabilidad de un suceso seguro?", "ops": ["1", "0", "100"],
            ...
            {"q": "Si tiro una moneda 5 veces y sale cara las 5, ¿qué chance tiene la sexta?",
             "ops": ["La misma: 1 de 2", "Más chance de ceca", "Más chance de cara"],
            ...
            {"q": "En una bolsa con 3 rojas y 7 azules, ¿qué probabilidad hay de sacar roja?",
             "ops": ["3 de 10", "3 de 7", "1 de 3"],
             "m": "Favorables sobre el TOTAL, no sobre las otras."},
            {"q": "¿Puede una probabilidad ser mayor que 1?", "ops": ["No, nunca", "Sí, si hay muchos casos",
                     "Sí, si el suceso es seguro"],
             "m": "Los favorables nunca superan a los posibles."},
            {"q": "Con tres monedas, ¿cuántos resultados posibles hay?", "ops": ["8", "6", "3"],
             "m": "2 × 2 × 2: cada moneda duplica las ramas del árbol."},
            {"q": "¿Cuál es la probabilidad de sacar un número mayor que 4 en un dado?",
             "ops": ["2 de 6", "3 de 6", "4 de 6"],
             "m": "Sólo el 5 y el 6. El 4 no cuenta porque pide MAYOR que 4."},
        ],
    },
    {
        "id": "traductor_algebraico_7", "grado": 7, "area": "matematica",
        "titulo": "Traductor algebraico", "icono": "🔤",
        "mecanica": "trivia",
        "consigna": "Pasá la frase a una expresión.",
        "explica": "El paréntesis cambia todo: no es lo mismo el doble de (x+1) que el doble de x, más 1.",
        "dc": "Expresiones con y sin letras; traducir un enunciado a una expresión",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · M14",
        "saber": {"id": "MAT-7-algebra", "nombre": "Lenguaje algebraico",
                  "prereqs": ["MAT-7-combinados"]},
        "banco": [
            {"q": "«El doble de un número» se escribe…", "ops": ["2x", "x²", "x+2"],
            ...
            {"q": "«La mitad de un número» se escribe…", "ops": ["x/2", "2x", "x−2"],
             "m": "Dividir por 2 es tomar la mitad."},
            {"q": "«La mitad de la suma de un número y 2» se escribe…",
             "ops": ["(x+2)/2", "x/2+2", "x+2/2"],
             "m": "Se suma primero, y todo eso se divide."},
            {"q": "«El cuadrado de un número» se escribe…", "ops": ["x²", "2x", "√x"],
             "m": "2x es el doble; la raíz es la operación inversa."},
            {"q": "«Un número disminuido en 5» se escribe…", "ops": ["x−5", "5−x", "x/5"],
             "m": "El orden importa: 5−x sería «5 disminuido en el número»."},
            {"q": "«El triple de un número menos 4» se escribe…", "ops": ["3x−4", "3(x−4)", "x−12"],
             "m": "Sin paréntesis, el triple se aplica sólo al número."},
            {"q": "«El siguiente de un número» se escribe…", "ops": ["x+1", "x−1", "2x"],
             "m": "El anterior sería x−1."},
            {"q": "«La suma de dos números consecutivos» se escribe…",
             "ops": ["x + (x+1)", "2x", "x + 2"],
             "m": "El consecutivo de x es x+1."},
            {"q": "Si x = 5, ¿cuánto vale 2(x+3)?", "ops": ["16", "13", "10"],
             "m": "Primero el paréntesis: 5+3 = 8, y 8 × 2 = 16."},
            {"q": "Si x = 5, ¿cuánto vale 2x+3?", "ops": ["13", "16", "10"],
             "m": "Acá el 2 multiplica sólo a x: 10+3."},
            {"q": "«El área de un cuadrado de lado L» se escribe…", "ops": ["L²", "4L", "2L"],
             "m": "4L sería el perímetro."},
            {"q": "«Un número par cualquiera» se escribe…", "ops": ["2n", "n+2", "n²"],
             "m": "Todo par es el doble de algún entero."},
        ],
    },

    # ── LENGUA de 7° ─────────────────────────────────────────────────────────────
    # La auditoría marca que Lengua de 7° estaba en CERO y que ortografía y
    # comprensión de texto largo son la queja #1 de las familias.
    {
        "id": "subgeneros_7", "grado": 7, "area": "lengua",
        "titulo": "¿Fantástico, maravilloso o terror?", "icono": "👻",
        "mecanica": "clasificar",
        "consigna": "¿A qué subgénero pertenece?",
        "explica": "En el maravilloso lo raro es normal; en el fantástico, nadie lo puede explicar.",
        "categorias": [{"cat": "fantastico", "label": "🌀 Fantástico"},
                       {"cat": "maravilloso", "label": "🧚 Maravilloso"},
                       {"cat": "terror", "label": "🕯️ Terror"}],
        "dc": "Los subgéneros narrativos como clave de lectura",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L1",
        "saber": {"id": "LEN-7-subgeneros", "nombre": "Subgéneros narrativos", "prereqs": []},
        "banco": [
            {"it": "Una puerta común aparece de golpe donde antes había una pared, y nadie entiende por qué",
             "cat": "fantastico", "m": "Lo insólito irrumpe en un mundo normal y queda sin explicación."},
            {"it": "En el reino, las hadas conceden deseos desde hace siglos", "cat": "maravilloso",
            ...
            {"it": "Los pasos se acercan por el pasillo oscuro y ella contiene la respiración",
             "cat": "terror", "m": "El objetivo del texto es producir miedo."},
            {"it": "El protagonista descubre que su reflejo se mueve un segundo tarde",
             "cat": "fantastico", "m": "Un hecho imposible dentro de una vida cotidiana."},
            {"it": "El príncipe consulta al dragón, que como todos los dragones habla",
             "cat": "maravilloso", "m": "El dragón parlante es normal en ese mundo."},
            {"it": "La casa lleva años vacía y sin embargo alguien enciende la luz del sótano",
             "cat": "terror", "m": "Construye tensión y amenaza."},
            {"it": "Recibe una carta escrita por él mismo, fechada la semana que viene",
             "cat": "fantastico", "m": "Lo imposible ocurre en un mundo por lo demás normal."},
            {"it": "La bruja del bosque prepara pociones desde antes de que naciera la abuela",
             "cat": "maravilloso", "m": "El mundo entero funciona con magia."},
            {"it": "Cada noche a las tres se escuchan uñas rascando la puerta", "cat": "terror",
            ...
            {"it": "El hombre empieza a olvidar palabras, y las palabras desaparecen del diccionario",
             "cat": "fantastico", "m": "La irrupción de lo inexplicable en lo cotidiano."},
            {"it": "El caballero recibe la espada encantada de manos del anciano sabio",
             "cat": "maravilloso", "m": "Objetos mágicos aceptados como parte del mundo."},
            {"it": "El espejo del baño devuelve una habitación que no es la suya", "cat": "terror",
            ...
            {"it": "Un pueblo entero amanece sin recordar el día anterior, y la vida sigue igual",
             "cat": "fantastico", "m": "El hecho imposible no se explica ni se resuelve."},
            {"it": "Los tres deseos se piden en voz alta y el genio los concede", "cat": "maravilloso",
             "m": "El genio y los deseos son reglas del mundo del cuento."},
            {"it": "Alguien había estado durmiendo en su cama mientras ella no estaba", "cat": "terror",
             "m": "La amenaza es lo que organiza el relato."},
            {"it": "El gato de la casa empieza a contestar preguntas y la familia se aterra",
             "cat": "fantastico", "m": "Que la familia se asuste marca que NO es normal en ese mundo."},
        ],
    },
    {
        "id": "narrador_7", "grado": 7, "area": "lengua",
        "titulo": "¿Qué narrador habla?", "icono": "🗣️",
        "mecanica": "trivia",
        "consigna": "¿Quién está contando?",
        "explica": "El narrador no es el autor: es la voz que el autor eligió para contar.",
        "dc": "Tipos de narrador; voces que se alternan",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L2",
        "saber": {"id": "LEN-7-narrador", "nombre": "Tipos de narrador",
                  "prereqs": ["LEN-7-subgeneros"]},
        "banco": [
            {"q": "«Caminé hasta la esquina y esperé.» ¿Qué narrador es?",
             "ops": ["Primera persona (protagonista)", "Tercera persona omnisciente",
                     "Segunda persona"],
             "m": "El «yo» que además protagoniza la acción."},
            {"q": "«Ana caminó hasta la esquina y esperó.» ¿Qué narrador es?",
             "ops": ["Tercera persona", "Primera persona", "Narrador testigo"],
             "m": "Habla de ella desde afuera."},
            {"q": "¿Qué caracteriza al narrador omnisciente?",
             "ops": ["Sabe lo que piensan y sienten todos los personajes",
                     "Sólo cuenta lo que ve", "Es uno de los personajes"],
             "m": "«Omni» es todo: lo sabe todo, incluso lo que nadie dijo."},
            {"q": "¿Qué es un narrador testigo?",
             "ops": ["Un personaje que cuenta lo que le pasa a OTRO",
                     "El protagonista contando su historia", "Alguien que lo sabe todo"],
            ...
            {"q": "«Ana caminó hasta la esquina. No sabía que la estaban esperando.» ¿Qué narrador es?",
             "ops": ["Omnisciente", "Testigo", "Protagonista"],
             "m": "Sabe algo que la propia Ana ignora."},
            {"q": "El narrador, ¿es lo mismo que el autor?",
             "ops": ["No: es una voz que el autor construye", "Sí, siempre",
            ...
            {"q": "«Esperé en la esquina» pasado a tercera persona es…",
             "ops": ["Esperó en la esquina", "Espero en la esquina", "Esperaba yo en la esquina"],
             "m": "Cambia la persona del verbo, no el tiempo."},
            {"q": "«Marcos abrió la puerta» pasado a primera persona es…",
             "ops": ["Abrí la puerta", "Abre la puerta", "Marcos abrió la puerta"],
             "m": "El personaje pasa a contar en su propia voz."},
            {"q": "¿Puede un relato alternar narradores?",
             "ops": ["Sí, y es un recurso muy usado", "No, nunca", "Sólo en poesía"],
            ...
            {"q": "«Yo vi cómo Julián rompía el vidrio.» ¿Qué narrador es?",
             "ops": ["Testigo", "Protagonista", "Omnisciente"],
             "m": "Es un yo, pero el que actúa es Julián."},
            {"q": "Un narrador en primera persona, ¿puede equivocarse?",
             "ops": ["Sí, sólo sabe lo que él percibe", "No, siempre dice la verdad",
            ...
            {"q": "¿Qué punto de vista da más información al lector?",
             "ops": ["El omnisciente", "El protagonista", "El testigo"],
            ...
            {"q": "«Sentí que el corazón me latía fuerte.» ¿Podría contarlo un narrador en tercera?",
             "ops": ["Sí, si es omnisciente", "No, nunca", "Sólo si es testigo"],
             "m": "Un testigo no puede saber lo que otro siente por dentro."},
            {"q": "En una autobiografía, ¿qué narrador se usa?", "ops": ["Primera persona",
                     "Tercera persona", "Omnisciente"],
             "m": "El que escribe cuenta su propia vida."},
        ],
    },
    {
        "id": "modos_verbales_7", "grado": 7, "area": "lengua",
        "titulo": "Tres modos, un verbo", "icono": "🎭",
        "mecanica": "clasificar",
        "consigna": "¿Qué modo verbal es?",
        "explica": "El indicativo informa, el subjuntivo expresa deseo o duda, el imperativo ordena.",
        "categorias": [{"cat": "indicativo", "label": "📢 Indicativo"},
                       {"cat": "subjuntivo", "label": "🌫️ Subjuntivo"},
                       {"cat": "imperativo", "label": "❗ Imperativo"}],
        "dc": "Modos indicativo, subjuntivo e imperativo",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L3",
        "saber": {"id": "LEN-7-modos", "nombre": "Modos verbales", "prereqs": []},
        "banco": [
            {"it": "Mañana llueve en toda la provincia", "cat": "indicativo",
             "m": "Presenta el hecho como real: informa."},
            {"it": "Ojalá llueva mañana", "cat": "subjuntivo",
             "m": "«Ojalá» dispara el subjuntivo: expresa un deseo."},
            {"it": "Cerrá la ventana", "cat": "imperativo", "m": "Da una orden directa."},
            {"it": "Los chicos estudian todos los días", "cat": "indicativo",
             "m": "Enuncia un hecho."},
            {"it": "Quiero que estudies más", "cat": "subjuntivo",
             "m": "El verbo de deseo obliga al subjuntivo en la subordinada."},
            {"it": "Estudiá para la prueba", "cat": "imperativo", "m": "Le ordena a alguien."},
            {"it": "Ayer fuimos al cine", "cat": "indicativo", "m": "Cuenta algo que pasó."},
            {"it": "Quizás vayamos al cine", "cat": "subjuntivo",
             "m": "«Quizás» marca duda: subjuntivo."},
            {"it": "Vení al cine con nosotros", "cat": "imperativo", "m": "Es una invitación en forma de orden."},
            {"it": "El tren llega a las siete", "cat": "indicativo", "m": "Informa un hecho."},
            {"it": "Espero que el tren llegue a horario", "cat": "subjuntivo",
             "m": "«Espero que» expresa deseo y arrastra el subjuntivo."},
            {"it": "Esperá el tren en el andén", "cat": "imperativo", "m": "Indica qué hacer."},
            {"it": "Ella canta en el coro", "cat": "indicativo", "m": "Presenta el hecho como real."},
            {"it": "Ojalá cante en el coro este año", "cat": "subjuntivo",
             "m": "Deseo sobre algo que todavía no pasó."},
            {"it": "Cantá más fuerte", "cat": "imperativo", "m": "Orden directa a la segunda persona."},
            {"it": "No creo que sea tan difícil", "cat": "subjuntivo",
             "m": "La negación de «creer» expresa duda: subjuntivo."},
            {"it": "Creo que es bastante difícil", "cat": "indicativo",
             "m": "Afirmar una creencia sí va en indicativo."},
            {"it": "Prestá atención al cartel", "cat": "imperativo", "m": "Manda hacer algo."},
        ],
    },
    {
        "id": "sustantivos_7", "grado": 7, "area": "lengua",
        "titulo": "Clasificador de sustantivos", "icono": "📦",
        "mecanica": "trivia",
        "consigna": "¿Qué tipo de sustantivo es?",
        "explica": "Un mismo sustantivo se clasifica por varios ejes a la vez.",
        "dc": "Individual/colectivo, abstracto/concreto, contable/incontable",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L4",
        "saber": {"id": "LEN-7-sustantivos", "nombre": "Clases de sustantivos", "prereqs": []},
        "banco": [
            {"q": "«Rebaño» es un sustantivo…", "ops": ["Colectivo", "Individual", "Abstracto"],
             "m": "En singular nombra a un conjunto de ovejas."},
            {"q": "«Oveja» es un sustantivo…", "ops": ["Individual", "Colectivo", "Incontable"],
             "m": "En singular nombra a una sola."},
            {"q": "«Libertad» es un sustantivo…", "ops": ["Abstracto", "Concreto", "Colectivo"],
             "m": "No se puede percibir con los sentidos."},
            {"q": "«Mesa» es un sustantivo…", "ops": ["Concreto", "Abstracto", "Colectivo"],
             "m": "Se puede ver y tocar."},
            {"q": "«Agua» es un sustantivo…", "ops": ["Incontable", "Contable", "Colectivo"],
             "m": "No se dice «dos aguas» sin agregar una medida: dos VASOS de agua."},
            {"q": "«Silla» es un sustantivo…", "ops": ["Contable", "Incontable", "Abstracto"],
             "m": "Se puede contar de a una."},
            {"q": "«Arboleda» es un sustantivo…", "ops": ["Colectivo", "Individual", "Abstracto"],
             "m": "Nombra a un conjunto de árboles."},
            {"q": "«Alegría» es un sustantivo…", "ops": ["Abstracto", "Concreto", "Contable"],
             "m": "Es un sentimiento: no se toca."},
            {"q": "¿Qué caracteriza a un sustantivo colectivo?",
             "ops": ["Que en SINGULAR nombra a un conjunto", "Que va siempre en plural",
                     "Que nombra ideas"],
             "m": "«Enjambre» es singular y nombra a muchas abejas."},
            {"q": "«Arena» es un sustantivo…", "ops": ["Incontable", "Contable", "Colectivo"],
             "m": "Se mide, no se cuenta: un kilo de arena."},
            {"q": "«Manada» es colectivo de…", "ops": ["Lobos u otros animales", "Árboles", "Barcos"],
             "m": "De árboles sería arboleda; de barcos, flota."},
            {"q": "Un sustantivo, ¿puede ser concreto y contable a la vez?",
             "ops": ["Sí: «silla» es las dos cosas", "No, son excluyentes",
                     "Sólo si es colectivo"],
             "m": "Los ejes de clasificación son independientes entre sí."},
            {"q": "«Flota» es colectivo de…", "ops": ["Barcos", "Ovejas", "Estrellas"],
             "m": "De ovejas es rebaño; de estrellas, constelación."},
            {"q": "«Justicia» es un sustantivo…", "ops": ["Abstracto", "Concreto", "Contable"],
             "m": "Nombra un concepto, no un objeto."},
            {"q": "«Coraje» es un sustantivo…", "ops": ["Abstracto e incontable", "Concreto",
                     "Colectivo"],
             "m": "No se toca ni se cuenta de a uno."},
        ],
    },
    {
        "id": "sujeto_7", "grado": 7, "area": "lengua",
        "titulo": "¿Quién es el sujeto?", "icono": "🔎",
        "mecanica": "trivia",
        "consigna": "Preguntale al verbo quién.",
        "explica": "Si no hay quién realice la acción, la oración es impersonal.",
        "dc": "Sujeto expreso y tácito; oraciones impersonales",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L5",
        "saber": {"id": "LEN-7-sujeto", "nombre": "Sujeto expreso, tácito e impersonal",
                  "prereqs": []},
        "banco": [
            {"q": "En «Los chicos juegan en el patio», ¿cuál es el sujeto?",
             "ops": ["Los chicos", "juegan", "en el patio"],
             "m": "¿Quiénes juegan? Los chicos."},
            {"q": "En «Llegamos temprano», ¿cuál es el sujeto?",
             "ops": ["Nosotros, tácito", "temprano", "No tiene sujeto"],
             "m": "No está escrito, pero la terminación del verbo lo indica: es tácito."},
            {"q": "¿Qué es un sujeto tácito?", "ops": ["Uno que no está escrito pero se sobreentiende",
                     "Uno que no existe", "El que va al final"],
             "m": "El que no existe es el de las impersonales, que es distinto."},
            {"q": "«Hay tres libros en la mesa». ¿Cuál es el sujeto?",
             "ops": ["No tiene: es impersonal", "Tres libros", "La mesa"],
            ...
            {"q": "En «El profesor de música llegó tarde», ¿cuál es el NÚCLEO del sujeto?",
             "ops": ["profesor", "música", "El"],
             "m": "«De música» sólo modifica a «profesor»."},
            {"q": "«Estudiamos toda la tarde». El sujeto es…",
             "ops": ["Nosotros, tácito", "Toda la tarde", "Inexistente"],
             "m": "La desinencia del verbo indica quién."},
            {"q": "¿Puede una oración tener sujeto y no verbo?",
             "ops": ["No: sin verbo no hay oración bimembre", "Sí, siempre",
                     "Sólo en preguntas"],
             "m": "El verbo es el núcleo del predicado y no puede faltar."},
        ],
    },
    {
        "id": "metafora_sinecdoque_7", "grado": 7, "area": "lengua",
        "titulo": "Metáfora o sinécdoque", "icono": "🎨",
        "mecanica": "trivia",
        "consigna": "¿Qué recurso se está usando?",
        "explica": "La metáfora sustituye por semejanza; la sinécdoque, por pertenencia.",
        "dc": "Metáfora y sinécdoque; el yo poético no es el autor",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L6",
        "saber": {"id": "LEN-7-metafora", "nombre": "Metáfora y sinécdoque",
                  "prereqs": ["LEN-7-narrador"]},
        "banco": [
            {"q": "«Sus cabellos son oro.» ¿Qué recurso es?", "ops": ["Metáfora", "Sinécdoque",
                     "Comparación"],
             "m": "Sustituye por semejanza y sin usar «como»."},
            {"q": "«Necesitamos brazos para la cosecha.» ¿Qué recurso es?",
             "ops": ["Sinécdoque", "Metáfora", "Hipérbole"],
             "m": "Nombra la parte (los brazos) para referirse al todo (los trabajadores)."},
            {"q": "¿Qué es una sinécdoque?",
             "ops": ["Nombrar el todo por la parte, o la parte por el todo",
                     "Comparar dos cosas con «como»", "Exagerar a propósito"],
             "m": "Lo que la define es la relación de pertenencia, no el parecido."},
            {"q": "«Tiene cien cabezas de ganado.» ¿Qué recurso es?",
             "ops": ["Sinécdoque", "Metáfora", "Personificación"],
             "m": "La cabeza está por el animal entero."},
            {"q": "«La ciudad dormía.» ¿Qué recurso es?", "ops": ["Personificación", "Sinécdoque",
                     "Metáfora"],
             "m": "Le atribuye a la ciudad una acción de ser vivo."},
            {"q": "¿Qué es el yo poético?",
             "ops": ["La voz que habla en el poema, que no es el autor",
                     "El autor del poema", "El lector"],
             "m": "Un autor puede escribir un poema en la voz de otra persona."},
            {"q": "«Me compré un Picasso.» ¿Qué recurso es?", "ops": ["Metonimia o sinécdoque: el autor por la obra",
                     "Metáfora", "Comparación"],
             "m": "Se nombra al creador para referirse a lo creado."},
            {"q": "«El otoño de la vida» se refiere a…", "ops": ["La vejez, por metáfora",
                     "Una estación del año", "Una comparación"],
             "m": "Traslada el sentido del ciclo natural a la vida de una persona."},
            {"q": "«Sus ojos brillan como estrellas.» ¿Qué recurso es?",
             "ops": ["Comparación", "Metáfora", "Sinécdoque"],
             "m": "El «como» está explícito: comparación, no metáfora."},
            {"q": "¿En qué se diferencian metáfora y comparación?",
             "ops": ["La comparación usa un nexo como «como»; la metáfora sustituye directamente",
                     "La metáfora es más larga", "No se diferencian"],
             "m": "El nexo es la marca visible."},
            {"q": "«Se ganan el pan trabajando.» ¿Qué recurso es?",
             "ops": ["Sinécdoque: el pan por todo el alimento", "Metáfora", "Hipérbole"],
             "m": "Una parte del sustento nombra al sustento entero."},
            {"q": "«El poeta dice que está triste.» ¿A quién le corresponde esa tristeza?",
             "ops": ["Al yo poético, no necesariamente al autor", "Siempre al autor",
                     "Al lector"],
             "m": "Confundir yo poético con autor es el error clásico del tema."},
            {"q": "«Río de gente» es…", "ops": ["Una metáfora", "Una sinécdoque",
                     "Una personificación"],
             "m": "El río sustituye a la multitud por semejanza en cómo se mueve."},
            {"q": "«Tres velas cruzaron el horizonte.» ¿Qué recurso es?",
             "ops": ["Sinécdoque: las velas por los barcos", "Metáfora", "Comparación"],
             "m": "La parte visible nombra al todo."},
        ],
    },
    {
        "id": "hecho_opinion_argumento_7", "grado": 7, "area": "lengua",
        "titulo": "Hecho, opinión o argumento", "icono": "⚖️",
        "mecanica": "clasificar",
        "consigna": "¿Se puede verificar, es un juicio, o lo fundamenta?",
        "explica": "El argumento es una opinión que además da la razón que la sostiene.",
        "categorias": [{"cat": "hecho", "label": "📋 Hecho"},
                       {"cat": "opinion", "label": "💭 Opinión"},
                       {"cat": "argumento", "label": "🧩 Argumento"}],
        "dc": "Distinguir hecho verificable, opinión y argumento",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L7",
        "saber": {"id": "LEN-7-argumentacion", "nombre": "Hecho, opinión y argumento",
                  "prereqs": []},
        "banco": [
            {"it": "El agua hierve a 100 °C al nivel del mar", "cat": "hecho",
             "m": "Se puede medir y cualquiera obtiene el mismo resultado."},
            {"it": "El invierno es la peor estación del año", "cat": "opinion",
             "m": "«Peor» depende de quién juzgue: no hay medición posible."},
            {"it": "Conviene abrigarse en invierno porque el frío baja las defensas", "cat": "argumento",
             "m": "Sostiene una postura con una razón."},
            {"it": "La Argentina limita con cinco países", "cat": "hecho",
             "m": "Se verifica mirando un mapa."},
            {"it": "El fútbol es el deporte más lindo", "cat": "opinion",
             "m": "Un juicio de gusto, sin criterio verificable."},
            {"it": "Hay que hacer deporte porque mejora la salud cardiovascular", "cat": "argumento",
             "m": "Da la razón que fundamenta la postura."},
            {"it": "El censo de 2022 registró 46 millones de habitantes", "cat": "hecho",
             "m": "Es un dato con fuente que se puede consultar."},
            {"it": "Los libros son mejores que las películas", "cat": "opinion",
             "m": "No hay forma de medir «mejor» acá."},
            {"it": "Leer amplía el vocabulario, y por eso conviene hacerlo", "cat": "argumento",
             "m": "Encadena un motivo con una recomendación."},
            {"it": "El Aconcagua mide 6.960 metros", "cat": "hecho",
             "m": "Es una medición comprobable."},
            {"it": "Las vacaciones de invierno deberían ser más largas", "cat": "opinion",
            ...
            {"it": "Las vacaciones deberían ser más largas porque el segundo cuatrimestre es el más cargado",
             "cat": "argumento", "m": "La misma postura, ahora con una razón que la sostiene."},
            {"it": "El agua se congela a 0 °C", "cat": "hecho", "m": "Dato verificable."},
            {"it": "La música de antes era mejor", "cat": "opinion",
             "m": "No hay criterio objetivo para compararlas."},
            {"it": "Conviene separar los residuos porque reduce lo que se entierra", "cat": "argumento",
             "m": "Postura más razón: argumento."},
            {"it": "La Ley 1420 se sancionó en 1884", "cat": "hecho", "m": "Se puede consultar."},
            {"it": "Este es el mejor libro que leí", "cat": "opinion", "m": "Es un juicio personal."},
            {"it": "El transporte público conviene porque mueve más gente con menos emisiones",
             "cat": "argumento", "m": "Da el motivo que respalda la conclusión."},
        ],
    },
    {
        "id": "recursos_argumentador_7", "grado": 7, "area": "lengua",
        "titulo": "Recursos del argumentador", "icono": "🎤",
        "mecanica": "clasificar",
        "consigna": "¿Qué recurso está usando para convencer?",
        "explica": "Cada recurso convence de una manera distinta, y algunos son más débiles.",
        "categorias": [{"cat": "autoridad", "label": "🎓 Cita de autoridad"},
                       {"cat": "ejemplo", "label": "📌 Ejemplificación"},
                       {"cat": "contraejemplo", "label": "🚫 Contraejemplo"},
                       {"cat": "generalizacion", "label": "🌐 Generalización"}],
        "dc": "Cita de autoridad, ejemplificación, contraejemplo y generalización",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L8",
        "saber": {"id": "LEN-7-recursos-argumentativos", "nombre": "Recursos de la argumentación",
                  "prereqs": ["LEN-7-argumentacion"]},
        "banco": [
            {"it": "«Según la Organización Mundial de la Salud, dormir menos de 8 horas afecta la memoria»",
             "cat": "autoridad", "m": "Se apoya en una institución reconocida."},
            {"it": "«Por ejemplo, en Rosario el carril exclusivo bajó los tiempos de viaje»",
             "cat": "ejemplo", "m": "Ilustra la afirmación con un caso concreto."},
            {"it": "«Se dice que todos los adolescentes duermen poco, pero mi hermana duerme nueve horas»",
             "cat": "contraejemplo", "m": "Un solo caso alcanza para refutar un «todos»."},
            {"it": "«Los chicos de hoy no leen»", "cat": "generalizacion",
            ...
            {"it": "«El doctor Favaloro sostenía que la prevención salva más vidas que la cirugía»",
             "cat": "autoridad", "m": "Cita a un especialista reconocido."},
            {"it": "«Pensemos en el caso de Bariloche, donde el turismo cambió la economía»",
             "cat": "ejemplo", "m": "Un caso particular que ilustra la idea."},
            {"it": "«Dicen que ningún gato nada, pero el gato de Bengala sí lo hace»",
             "cat": "contraejemplo", "m": "Refuta una afirmación absoluta con un caso."},
            {"it": "«Siempre que llueve, el tránsito colapsa»", "cat": "generalizacion",
             "m": "El «siempre» es lo que la vuelve generalización."},
            {"it": "«El informe del CONICET indica que la sequía redujo la cosecha»",
             "cat": "autoridad", "m": "Respalda con una institución científica."},
            {"it": "«Mirá lo que pasó en Rosario con el ordenamiento del centro»", "cat": "ejemplo",
             "m": "Un caso concreto para apoyar la postura."},
            {"it": "«Aseguran que ninguna ave no vuela; el pingüino los desmiente»",
             "cat": "contraejemplo", "m": "Un caso que rompe la regla enunciada."},
            {"it": "«Toda la gente joven prefiere los videos a los libros»", "cat": "generalizacion",
            ...
            {"it": "«Como explica la Sociedad Argentina de Pediatría, el calendario de vacunas es gratuito»",
             "cat": "autoridad", "m": "Apela al saber de una entidad especializada."},
            {"it": "«Un caso claro es el del reciclaje en San Isidro»", "cat": "ejemplo",
             "m": "Ilustra con una experiencia concreta."},
            {"it": "«Se afirma que nadie usa el efectivo, pero en las ferias se usa todo el tiempo»",
             "cat": "contraejemplo", "m": "Desarma el «nadie» con un contraejemplo."},
            {"it": "«Los docentes están todos de acuerdo con la medida»", "cat": "generalizacion",
             "m": "Atribuye a un grupo entero una postura sin medirla."},
        ],
    },
    {
        "id": "persuasion_7", "grado": 7, "area": "lengua",
        "titulo": "Detector de persuasión", "icono": "📣",
        "mecanica": "trivia",
        "consigna": "¿Con qué te quiere convencer?",
        "explica": "La publicidad no informa: busca que hagas algo.",
        "dc": "Recursos de persuasión de la publicidad; verbal y visual",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L9",
        "saber": {"id": "LEN-7-persuasion", "nombre": "Recursos de persuasión",
                  "prereqs": ["LEN-7-recursos-argumentativos"]},
        "banco": [
            {"q": "«¡Última oportunidad! Sólo por hoy.» ¿Qué recurso usa?",
             "ops": ["Urgencia artificial", "Cita de autoridad", "Dato verificable"],
             "m": "Apura la decisión para que no la pienses."},
            {"q": "«9 de cada 10 dentistas lo recomiendan.» ¿Qué recurso usa?",
             "ops": ["Apelación a la autoridad, sin fuente", "Un dato verificable",
                     "Una comparación"],
             "m": "Parece un dato, pero no dice quién midió ni a cuántos preguntó."},
            {"q": "Un famoso usando el producto apela a…",
             "ops": ["La identificación con alguien admirado", "Un argumento lógico",
            ...
            {"q": "¿Qué diferencia hay entre publicidad y propaganda?",
             "ops": ["La publicidad vende productos; la propaganda difunde ideas",
                     "Son sinónimos", "La propaganda es más corta"],
             "m": "Una campaña de vacunación es propaganda, no publicidad."},
            {"q": "Ante una publicidad, ¿qué conviene preguntarse?",
             "ops": ["Quién la paga y qué quiere que yo haga", "Si me gusta la música",
                     "Cuánto dura"],
             "m": "Identificar el emisor y su intención es la clave de la lectura crítica."},
        ],
    },
    {
        "id": "cronica_7", "grado": 7, "area": "lengua",
        "titulo": "De la noticia a la crónica", "icono": "🗞️",
        "mecanica": "trivia",
        "consigna": "Pensá el orden y la voz del relato.",
        "explica": "La noticia va de lo más importante a lo menos; la crónica sigue el orden de los hechos.",
        "dc": "La crónica policial; discurso directo e indirecto",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L10",
        "saber": {"id": "LEN-7-cronica", "nombre": "Noticia y crónica",
                  "prereqs": ["LEN-7-narrador"]},
        "banco": [
            ...
            {"q": "En una crónica policial, ¿qué NO corresponde?",
             "ops": ["Condenar de antemano a un sospechoso", "Reconstruir los hechos",
                     "Citar a los testigos"],
             "m": "Hasta que haya sentencia, se informa sin dar por probado."},
            {"q": "¿Qué es el copete?", "ops": ["El párrafo inicial que resume lo esencial",
                     "El título", "El cierre"],
             "m": "Va entre el título y el cuerpo."},
            {"q": "«“Salí corriendo”, contó la vecina» pasado a indirecto:",
             "ops": ["La vecina contó que había salido corriendo",
                     "La vecina contó que salí corriendo", "La vecina: salí corriendo"],
             "m": "Cambian la persona y el tiempo del verbo."},
            {"q": "¿Qué preguntas debe responder una crónica completa?",
             "ops": ["Qué, quién, cuándo, dónde, cómo y por qué", "Sólo qué y cuándo",
                     "Cuánto y dónde"],
             "m": "Son las mismas seis preguntas del periodismo."},
            {"q": "En periodismo, ¿qué es contrastar fuentes?",
             "ops": ["Chequear el dato con más de un testimonio", "Elegir la fuente más rápida",
                     "Copiar de otro medio"],
             "m": "Una sola fuente puede estar equivocada o interesada."},
            {"q": "¿Qué diferencia una crónica de un cuento?",
             "ops": ["La crónica narra hechos reales verificables", "El cuento es más largo",
                     "No hay diferencia"],
             "m": "Las dos narran, pero una se compromete con la verdad de los hechos."},
            {"q": "El orden «pasó A, después B, después C» corresponde a…",
             "ops": ["Una crónica", "Una noticia", "Un aviso"],
             "m": "La noticia rompería ese orden para empezar por lo más importante."},
            {"q": "¿Para qué sirve el epígrafe de una foto?",
             "ops": ["Para explicar qué se ve y dónde fue", "Para poner el título",
                     "Para firmar la nota"],
             "m": "Una foto sin epígrafe puede leerse mal."},
        ],
    },
    {
        "id": "historieta_7", "grado": 7, "area": "lengua",
        "titulo": "Armá tu historieta", "icono": "💥",
        "mecanica": "trivia",
        "consigna": "Reconocé los elementos del lenguaje de la historieta.",
        "explica": "En la historieta el dibujo y el texto cuentan juntos: ninguno se entiende solo.",
        "dc": "Historieta: viñeta, globo, onomatopeya y guion",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L11",
        "saber": {"id": "LEN-7-historieta", "nombre": "Lenguaje de la historieta",
                  "prereqs": []},
        "banco": [
            {"q": "¿Qué es una viñeta?", "ops": ["Cada cuadro de la historieta",
                     "El globo de diálogo", "El texto del narrador"],
             "m": "Es la unidad mínima: dentro va la escena."},
            {"q": "¿Qué es un globo o bocadillo?", "ops": ["El espacio donde va lo que dice o piensa un personaje",
                     "El cuadro de la historieta", "El sonido dibujado"],
             "m": "Su forma indica si el personaje habla, piensa o grita."},
            {"q": "Un globo con el borde en forma de nube indica…",
             "ops": ["Que el personaje piensa, no habla", "Que grita", "Que susurra"],
             "m": "La forma del globo es información, no decoración."},
            {"q": "Un globo con bordes en punta indica…", "ops": ["Grito o enojo", "Pensamiento",
                     "Susurro"],
             "m": "El dibujo del globo transmite el tono."},
            {"q": "¿Qué es una onomatopeya en la historieta?",
             "ops": ["Una palabra que representa un sonido", "El texto del narrador",
                     "El nombre del autor"],
             "m": "«CRASH», «BOOM» y «PUM» son las más típicas."},
            {"q": "¿Qué es el cartucho o cartela?",
             "ops": ["El recuadro con la voz del narrador", "El globo de diálogo",
                     "El título de la historieta"],
             "m": "Suele indicar el tiempo o el lugar: «Mientras tanto…»."},
            {"q": "¿Qué es el guion de una historieta?",
             "ops": ["El texto que describe qué pasa en cada viñeta y qué se dice",
                     "El dibujo terminado", "El título"],
             "m": "Es lo que se escribe antes de dibujar."},
            {"q": "¿En qué orden se leen las viñetas en español?",
             "ops": ["De izquierda a derecha y de arriba abajo", "De derecha a izquierda",
                     "En cualquier orden"],
            ...
            {"q": "Las líneas cinéticas (rayitas de movimiento) sirven para…",
             "ops": ["Mostrar que algo se mueve", "Decorar el cuadro",
                     "Marcar el final"],
             "m": "Con una imagen fija hay que dibujar el movimiento."},
            {"q": "¿Qué pasa entre una viñeta y la siguiente?",
             "ops": ["El lector completa lo que no se muestra", "No pasa nada",
                     "Se repite la escena"],
             "m": "Ese espacio en blanco es parte del lenguaje: el lector lo llena."},
            {"q": "Mafalda es una historieta creada por…", "ops": ["Quino", "Fontanarrosa", "Caloi"],
             "m": "Fontanarrosa creó Inodoro Pereyra y Caloi, a Clemente."},
            {"q": "Clemente es un personaje creado por…", "ops": ["Caloi", "Quino", "Quirino Cristiani"],
             "m": "Caloi lo publicó durante décadas en el diario Clarín."},
            {"q": "¿Puede una historieta contar algo sin ninguna palabra?",
             "ops": ["Sí, se llama historieta muda", "No, siempre lleva texto",
                     "Sólo si es de humor"],
             "m": "La secuencia de imágenes alcanza para narrar."},
            {"q": "¿Qué es una tira cómica?", "ops": ["Una historieta corta, de pocas viñetas",
                     "Una historieta muda", "El guion sin dibujar"],
    ...
    },
    {
        ...
        "saber": {"id": "LEN-7-ambiguedad", "nombre": "Ambigüedad y problemas del uso",
                  "prereqs": ["LEN-7-sujeto"]},
        "banco": [
            {"q": "«Vi a Juan corriendo por la plaza.» ¿Por qué es ambigua?",
             "ops": ["No se sabe quién corría", "Falta el verbo", "Está mal el tiempo verbal"],
             "m": "El gerundio puede referirse a Juan o al que mira."},
            {"q": "«El perro de mi hermano que ladra mucho.» ¿Qué es ambiguo?",
             "ops": ["No se sabe si ladra el perro o el hermano", "El posesivo",
                     "Nada, está bien"],
             "m": "El relativo puede engancharse con cualquiera de los dos."},
            {"q": "¿Cómo se dice correctamente?", "ops": ["El decimoprimer piso", "El onceavo piso",
                     "El once piso"],
             "m": "«Onceavo» es una fracción (1/11), no un ordinal."},
            {"q": "«Habían muchas personas» debería ser…", "ops": ["Había muchas personas",
                     "Habían mucha gente", "Han habido muchas personas"],
            ...
            {"q": "«El mismo» usado como pronombre («llegó el paquete y abrí el mismo») es…",
             "ops": ["Un uso desaconsejado: mejor «lo abrí»", "Correcto siempre",
                     "Un error de ortografía"],
             "m": "«El mismo» funciona como adjetivo, no como sustituto del pronombre."},
            {"q": "«Media hora» o «medio hora»: ¿cuál va?", "ops": ["Media hora", "Medio hora",
                     "Las dos"],
             "m": "Concuerda con «hora», que es femenino."},
            {"q": "«Vendieron los libros a los alumnos usados.» ¿Qué pasa?",
             "ops": ["El adjetivo quedó lejos y parece referirse a los alumnos",
                     "Falta un verbo", "Está bien"],
            ...
            {"q": "«Ayer me encontré con Ana y su hermana. Ella tenía puesto un abrigo rojo.» ¿Qué falla?",
             "ops": ["No se sabe a cuál de las dos se refiere «ella»", "El tiempo verbal",
                     "El adjetivo"],
             "m": "La referencia pronominal quedó ambigua."},
            {"q": "«Contra más estudio, mejor me va» debería ser…",
             "ops": ["Cuanto más estudio, mejor me va", "Contra más estudio, mejor",
    ...
    },
    {
        ...
        "banco": [
            ...
            {"q": "En «Los tres perros del vecino ladraron», ¿cuál es el núcleo del sujeto?",
             "ops": ["perros", "vecino", "tres"],
             "m": "Los otros lo acompañan: «tres» y «del vecino» modifican a «perros»."},
            {"q": "En «Le compré un regalo», ¿qué falta explicitar?",
             "ops": ["El objeto indirecto: a quién", "El objeto directo", "El sujeto"],
             "m": "El «le» anticipa un OI que la oración no nombra."},
        ],
    },
    {
        "id": "ortografia_7", "grado": 7, "area": "lengua",
        "titulo": "Cazador de errores", "icono": "🔤",
        "mecanica": "trivia",
        "consigna": "¿Cuál está bien escrita?",
        "explica": "Tildación, reglas de letras y homófonos: los tres frentes de la ortografía.",
        "dc": "Tildación; reglas de b/v, g/j y h; homófonos",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L14",
        "saber": {"id": "LEN-7-ortografia", "nombre": "Ortografía de 7°", "prereqs": []},
        "banco": [
            {"q": "«Espero que ___ suerte.» ¿Qué va?", "ops": ["haya", "halla", "aya"],
             "m": "«Haya» es del verbo haber; «halla» es de hallar, encontrar."},
            {"q": "«Ojalá ___ la salida.» ¿Qué va?", "ops": ["halle", "haya", "aye"],
             "m": "Acá sí es encontrar: viene de hallar."},
            {"q": "«Ya está ___ el trabajo.» ¿Qué va?", "ops": ["hecho", "echo", "hexo"],
             "m": "«Hecho» viene de hacer; «echo» de echar, tirar."},
            {"q": "«Yo ___ sal a la comida.» ¿Qué va?", "ops": ["echo", "hecho", "hecho de"],
             "m": "Echar es agregar o tirar: va sin h."},
            {"q": "¿Cómo se escribe el condicional del verbo haber?", "ops": ["hubiera", "ubiera", "huviera"],
             "m": "Del verbo haber: lleva h y v."},
            {"q": "¿Cómo se escribe el pretérito de «estar»?", "ops": ["estuvo", "estubo", "hestuvo"],
             "m": "Los pretéritos de andar, estar y tener llevan v: anduvo, estuvo, tuvo."},
            {"q": "¿Cómo se escribe el infinitivo de «dirijo»?", "ops": ["dirigir", "diriguir", "dirijir"],
             "m": "Los verbos terminados en -gir van con g."},
            {"q": "¿Cómo se escribe el pretérito de «decir» en plural?", "ops": ["dijeron", "digeron", "dijieron"],
             "m": "Del verbo decir: la j se mantiene en el pretérito."},
            {"q": "¿Cómo se escribe «agotadísimo» con x?", "ops": ["exhausto", "exausto", "eshausto"],
             "m": "Lleva h intercalada después del prefijo ex-."},
            {"q": "¿Cómo se escribe lo que no está permitido?", "ops": ["prohibido", "proibido", "proivido"],
             "m": "Lleva h intercalada y b."},
            {"q": "«Se cayó del árbol» o «se calló del árbol»: ¿cuál corresponde?",
             "ops": ["Se cayó, de caer", "Se calló, de callar", "Las dos"],
             "m": "«Callar» es dejar de hablar: no aplica a un árbol."},
            {"q": "¿Cómo se escribe la expresión que anuncia que vas a mirar algo?", "ops": ["a ver qué pasa", "haber qué pasa",
                     "aver qué pasa"],
             "m": "«A ver» es preposición más verbo ver; «haber» es el infinitivo."},
            {"q": "¿Cómo se escribe la proporción de cada cien?", "ops": ["porcentaje", "porsentaje", "porcentage"],
             "m": "Las palabras terminadas en -aje van con j."},
            {"q": "¿Cómo se escribe el sustantivo derivado de «conducir»?", "ops": ["conducción", "conduczión", "conduxión"],
             "m": "Los sustantivos terminados en -ción derivados de verbos en -cir llevan cc."},
            {"q": "«Sí, quiero» o «si, quiero»: ¿cuál va?", "ops": ["Sí, con tilde",
                     "Si, sin tilde", "Da igual"],
             "m": "El «sí» afirmativo lleva tilde diacrítica; el condicional no."},
            {"q": "¿Cómo se escribe lo contrario de fracaso?", "ops": ["éxito", "exito", "écsito"],
             "m": "Es esdrújula: lleva tilde siempre."},
        ],
    },
    {
        "id": "leer_deducir_7", "grado": 7, "area": "lengua",
        "titulo": "Leé y deducí", "icono": "🔍",
        "mecanica": "trivia",
        "consigna": "Leé el texto y pensá qué quiso decir.",
        "explica": "En un texto largo la respuesta casi nunca está en una sola línea.",
        "dc": "Comprensión de texto largo con inferencia e intención del autor",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · L15",
        "saber": {"id": "LEN-7-comprension", "nombre": "Comprensión lectora con inferencia",
                  "prereqs": ["LEN-7-argumentacion"]},
        "banco": [
            {"q": "«La fábrica cerró en 1998. Diez años después, la mitad del pueblo se había ido.» ¿Qué se deduce?",
             "ops": ["El cierre provocó la emigración", "La gente se fue por el clima",
                     "El pueblo creció"],
            ...
            {"q": "«El autor dedica tres páginas a los riesgos y dos líneas a los beneficios.» ¿Qué revela?",
             "ops": ["Que su postura es crítica", "Que es neutral",
                     "Que está a favor"],
            ...
            {"q": "«Aunque el informe reconoce avances, insiste en que son insuficientes.» ¿Cuál es la postura?",
             "ops": ["Crítica, con reconocimiento parcial", "Totalmente favorable",
            ...
            {"q": "Si un texto usa «lamentablemente» y «afortunadamente», ¿qué muestra?",
             "ops": ["Que el autor valora lo que cuenta", "Que es un texto científico neutral",
            ...
            {"q": "«Los datos no permiten concluir todavía.» ¿Qué actitud expresa el autor?",
             "ops": ["Prudencia ante la evidencia", "Certeza total", "Rechazo del tema"],
             "m": "El «todavía» deja abierta la posibilidad de una conclusión futura."},
            {"q": "¿Qué es la intención del autor?", "ops": ["Para qué escribió el texto",
                     "Cuánto tardó en escribirlo", "De qué trata"],
            ...
            {"q": "Un texto que enumera ventajas y desventajas sin cerrar, ¿qué busca?",
             "ops": ["Que el lector se forme su propia opinión", "Convencer de una postura",
                     "Divertir"],
            ...
            {"q": "«El proyecto costó tres veces lo presupuestado y se entregó con dos años de atraso.» ¿Qué se deduce?",
             "ops": ["Hubo problemas serios de gestión", "Fue un éxito rotundo",
            ...
            {"q": "«Nadie de los consultados quiso dar su nombre.» ¿Qué sugiere?",
             "ops": ["Que temían alguna consecuencia", "Que eran tímidos",
            ...
            {"q": "Si un texto cita sólo a quienes están de acuerdo con él, ¿qué falla?",
             "ops": ["No contrasta posturas: es parcial", "Es demasiado largo",
                     "Le falta título"],
            ...
            {"q": "«Las clases se suspendieron por el temporal. Las pruebas se pasaron a la semana siguiente.» ¿Qué relación hay?",
             "ops": ["Causa y consecuencia", "Contraste", "Ninguna"],
            ...
            {"q": "¿Qué diferencia hay entre lo que un texto DICE y lo que SUGIERE?",
             "ops": ["Lo que sugiere se deduce de las pistas, no está escrito",
                     "Son lo mismo", "Lo que sugiere es siempre falso"],
            ...
            {"q": "«Un informe encargado por la propia empresa concluye que no hubo contaminación.» ¿Qué conviene notar?",
             "ops": ["Quién lo encargó puede afectar la conclusión",
                     "Que es definitivo", "Que no importa el emisor"],
             "m": "Identificar al emisor y su interés es parte de leer críticamente."},
            {"q": "Un párrafo que empieza con «Sin embargo» anuncia…",
             "ops": ["Que viene algo que contrasta con lo anterior", "Un ejemplo",
                     "Una conclusión"],
             "m": "El conector avisa la relación antes de que la leas."},
        ],
    },

    # ── INGLÉS de 7° · va en el carril de Lengua (ver la nota del manifiesto) ────
    # La auditoría pide audio de fonética para IN1 e IN2. Queda pendiente: estas tres
    # funcionan como reconocimiento escrito, que es lo que se puede entregar hoy.
    {
        ...
        "saber": {"id": "ING-7-vocabulario", "nombre": "Vocabulario en inglés", "prereqs": []},
        "banco": [
            {"q": "«Library» significa…", "ops": ["Biblioteca", "Librería", "Libro"],
             "m": "Es un falso amigo: la librería es «bookshop» o «bookstore»."},
            {"q": "«Actually» significa…", "ops": ["En realidad", "Actualmente", "Activamente"],
             "m": "Otro falso amigo: «actualmente» se dice «currently»."},
            {"q": "«Embarrassed» significa…", "ops": ["Avergonzado", "Embarazada", "Enojado"],
             "m": "Falso amigo clásico: embarazada es «pregnant»."},
            {"q": "«Weather» significa…", "ops": ["El tiempo atmosférico", "El tiempo del reloj",
                     "El clima de un país"],
             "m": "El tiempo del reloj es «time»; el clima de una región, «climate»."},
            {"q": "«To attend» significa…", "ops": ["Asistir a", "Atender a alguien", "Esperar"],
             "m": "Atender a un cliente es «to serve»."},
            {"q": "«Carpet» significa…", "ops": ["Alfombra", "Carpeta", "Cartera"],
             "m": "Carpeta es «folder»."},
            {"q": "«Exit» significa…", "ops": ["Salida", "Éxito", "Extra"],
             "m": "Éxito es «success»."},
            {"q": "«Homework» significa…", "ops": ["Tarea escolar", "Trabajo en casa",
                     "Casa de trabajo"],
             "m": "Se refiere específicamente a la tarea de la escuela."},
            {"q": "«Neighbour» significa…", "ops": ["Vecino", "Ni uno ni otro", "Sobrino"],
             "m": "Sobrino es «nephew»."},
            {"q": "«To realize» significa…", "ops": ["Darse cuenta", "Realizar una tarea",
                     "Alquilar"],
             "m": "Realizar una tarea es «to carry out» o «to do»."},
            {"q": "«Notice» significa…", "ops": ["Aviso o notar", "Noticia", "Nota escolar"],
             "m": "Noticia es «news»; la nota escolar, «mark» o «grade»."},
            {"q": "«Sensible» significa…", "ops": ["Sensato", "Sensible", "Simple"],
             "m": "Sensible se dice «sensitive»."},
            {"q": "«To support» significa…", "ops": ["Apoyar", "Soportar algo molesto", "Suponer"],
             "m": "Soportar algo molesto es «to put up with»."},
            {"q": "«Grocery store» es…", "ops": ["Un almacén de comida", "Una tienda de ropa",
                     "Una ferretería"],
             "m": "«Grocery» son los comestibles."},
            {"q": "«Journey» significa…", "ops": ["Viaje", "Jornada laboral", "Diario"],
             "m": "La jornada es «working day»; el diario, «newspaper»."},
        ],
    },
    {
        "id": "ingles_verbos_7", "grado": 7, "area": "lengua",
        "titulo": "Verbos en inglés", "icono": "⏱️",
        "mecanica": "trivia",
        "consigna": "Elegí la forma correcta.",
        "explica": "En present simple la tercera persona lleva -s; en past simple, casi todos -ed.",
        "dc": "Inglés: present simple, past simple y verbos irregulares",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · IN2",
        "saber": {"id": "ING-7-verbos", "nombre": "Tiempos verbales en inglés",
                  "prereqs": ["ING-7-vocabulario"]},
        "banco": [
            {"q": "«She ___ to school every day.»", "ops": ["goes", "go", "gone"],
             "m": "Tercera persona del singular en present simple: lleva -es."},
            {"q": "«They ___ football on Sundays.»", "ops": ["play", "plays", "played"],
             "m": "«They» es plural: el verbo va sin -s."},
            {"q": "«I ___ to the cinema yesterday.»", "ops": ["went", "go", "goes"],
             "m": "«Yesterday» pide past simple, y «go» es irregular: went."},
            {"q": "«We ___ pizza last night.»", "ops": ["ate", "eat", "eaten"],
             "m": "Past simple de «eat» es «ate»; «eaten» es el participio."},
            {"q": "¿Cuál es el past simple de «buy»?", "ops": ["bought", "buyed", "buied"],
             "m": "Es irregular: no lleva -ed."},
            {"q": "¿Cuál es el past simple de «work»?", "ops": ["worked", "wrought", "workt"],
             "m": "Es regular: se le agrega -ed."},
            {"q": "«He ___ TV every evening.»", "ops": ["watches", "watch", "watched"],
             "m": "Los verbos terminados en -ch agregan -es en tercera persona."},
            {"q": "«Did you ___ the film?»", "ops": ["see", "saw", "seen"],
             "m": "Después de «did» el verbo va en infinitivo, sin marca de pasado."},
            {"q": "«She ___ not like coffee.»", "ops": ["does", "do", "did"],
             "m": "Tercera persona en presente: el auxiliar es «does»."},
            {"q": "¿Cuál es el past simple de «have»?", "ops": ["had", "haved", "has"],
             "m": "Es irregular."},
            {"q": "«They ___ in Buenos Aires in 2010.»", "ops": ["lived", "live", "living"],
             "m": "Una fecha del pasado pide past simple; «live» es regular."},
            {"q": "¿Cuál es el past simple de «make»?", "ops": ["made", "maked", "make"],
             "m": "Es irregular."},
            {"q": "«I ___ my homework every day.»", "ops": ["do", "does", "did"],
             "m": "«I» no lleva -s en present simple."},
            {"q": "¿Cuál es el past simple de «take»?", "ops": ["took", "taked", "taken"],
             "m": "Irregular. «Taken» es el participio."},
            {"q": "«She ___ born in 2012.»", "ops": ["was", "were", "is"],
             "m": "Tercera persona del singular en pasado del verbo «to be»."},
        ],
    },
    {
        "id": "ingles_lectura_7", "grado": 7, "area": "lengua",
        "titulo": "Leé en inglés", "icono": "📗",
        "mecanica": "trivia",
        "consigna": "Leé el texto corto y respondé.",
        "explica": "No hace falta entender cada palabra: alcanza con captar la idea.",
        "dc": "Inglés: comprensión lectora en lengua extranjera",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · IN3",
        "saber": {"id": "ING-7-lectura", "nombre": "Comprensión lectora en inglés",
                  "prereqs": ["ING-7-verbos"]},
        "banco": [
            {"q": "«Tom wakes up at 7. He has breakfast and takes the bus to school.» ¿Cómo va a la escuela?",
             "ops": ["En colectivo", "Caminando", "En bicicleta"],
             "m": "«Takes the bus» es toma el colectivo."},
            {"q": "«The museum is closed on Mondays.» ¿Cuándo NO se puede visitar?",
             "ops": ["Los lunes", "Los domingos", "Todos los días"],
             "m": "«Closed» es cerrado; «Mondays» son los lunes."},
            {"q": "«Anna is afraid of dogs.» ¿Qué le pasa a Anna?",
             "ops": ["Les tiene miedo a los perros", "Le gustan los perros",
                     "Tiene un perro"],
             "m": "«Afraid of» significa tener miedo de algo."},
            {"q": "«It was raining, so we stayed at home.» ¿Por qué se quedaron en casa?",
             "ops": ["Porque llovía", "Porque hacía calor", "Porque estaban cansados"],
            ...
            {"q": "Si no entendés una palabra de un texto en inglés, ¿qué conviene?",
             "ops": ["Deducirla por el contexto y seguir leyendo",
                     "Frenar hasta buscarla", "Abandonar el texto"],
             "m": "La comprensión global no exige entender cada palabra."},
        ],
    },

    # ── CIENCIAS NATURALES de 7° ─────────────────────────────────────────────────
    # ⚠ CN11 es ESI (anatomía reproductiva) y va junto con X1. Marcado en el
    # manifiesto para revisión docente.
    {
        "id": "redes_troficas_7", "grado": 7, "area": "naturales",
        "titulo": "Constructor de redes tróficas", "icono": "🕸️",
        "mecanica": "clasificar",
        "consigna": "¿Qué rol cumple en la red?",
        "explica": "Los descomponedores cierran el ciclo: sin ellos la materia no vuelve al suelo.",
        "categorias": [{"cat": "productor", "label": "🌱 Productor"},
                       {"cat": "consumidor", "label": "🦊 Consumidor"},
                       {"cat": "descomponedor", "label": "🍄 Descomponedor"}],
        "dc": "Cadenas y redes tróficas; roles en el ecosistema",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CN1",
        "saber": {"id": "NAT-7-redes", "nombre": "Redes tróficas", "prereqs": []},
        "banco": [
            {"it": "El fitoplancton del océano", "cat": "productor",
             "m": "Hace fotosíntesis: es la base de casi toda la red marina."},
            {"it": "La anchoíta que se alimenta de plancton", "cat": "consumidor",
             "m": "Consumidor de primer orden."},
            {"it": "Las bacterias que degradan un pez muerto", "cat": "descomponedor",
             "m": "Devuelven los nutrientes al agua."},
            {"it": "El alga marina", "cat": "productor", "m": "Tiene clorofila y produce su alimento."},
            {"it": "El lobo marino que come peces", "cat": "consumidor",
             "m": "Obtiene la energía de otros seres vivos."},
            {"it": "Los hongos del suelo del bosque", "cat": "descomponedor",
             "m": "Transforman la materia muerta en nutrientes disponibles."},
            {"it": "El pastizal de la pampa", "cat": "productor", "m": "Convierte luz en materia orgánica."},
            {"it": "El zorro que caza roedores", "cat": "consumidor",
             "m": "Consumidor de segundo o tercer orden."},
            {"it": "Las lombrices que procesan hojarasca", "cat": "descomponedor",
             "m": "Fragmentan la materia muerta y la incorporan al suelo."},
            {"it": "El musgo sobre la roca húmeda", "cat": "productor",
             "m": "Es una planta: hace fotosíntesis."},
            {"it": "El puma", "cat": "consumidor", "m": "Depredador tope: sigue siendo consumidor."},
            {"it": "El moho sobre la fruta olvidada", "cat": "descomponedor",
             "m": "Un hongo que se alimenta de materia ya elaborada."},
            {"it": "La cianobacteria fotosintética", "cat": "productor",
             "m": "Aunque sea bacteria, hace fotosíntesis: produce."},
            {"it": "El carancho que come animales muertos", "cat": "consumidor",
             "m": "Es carroñero, pero no descompone la materia químicamente."},
            {"it": "Las bacterias que fijan nitrógeno en las raíces", "cat": "descomponedor",
             "m": "Participan del reciclado de materia en el suelo."},
            {"it": "El helecho del sotobosque", "cat": "productor", "m": "Planta con clorofila."},
        ],
    },
    {
        "id": "flujo_energia_7", "grado": 7, "area": "naturales",
        "titulo": "Flujo de energía y reciclaje", "icono": "🔋",
        "mecanica": "trivia",
        "consigna": "Seguí la energía por la cadena.",
        "explica": "La energía se pierde en cada nivel; la materia, en cambio, se recicla.",
        "dc": "Flujo de energía; la energía disminuye en cada nivel trófico",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CN2",
        "saber": {"id": "NAT-7-energia", "nombre": "Flujo de energía en el ecosistema",
                  "prereqs": ["NAT-7-redes"]},
        "banco": [
            {"q": "¿De dónde entra la energía a casi todos los ecosistemas?",
             "ops": ["Del Sol, por la fotosíntesis", "Del suelo", "De los descomponedores"],
             "m": "Del suelo se toman nutrientes, no energía."},
            {"q": "¿Qué le pasa a la energía al pasar de un nivel al siguiente?",
             "ops": ["Se pierde una gran parte como calor", "Se multiplica",
                     "Se mantiene igual"],
             "m": "Sólo una fracción chica llega al nivel de arriba."},
            {"q": "¿Por qué hay muchas más plantas que grandes carnívoros?",
             "ops": ["Porque la energía disponible se achica en cada nivel",
                     "Porque los carnívoros comen poco", "Por el clima"],
             "m": "La pirámide de energía explica la pirámide de números."},
            {"q": "¿La materia también se pierde en cada nivel?",
             "ops": ["No: la materia se recicla gracias a los descomponedores",
                     "Sí, igual que la energía", "Sí, más que la energía"],
            ...
            {"q": "¿Es correcto decir que la energía «se gasta»?",
             "ops": ["Se transforma y se degrada como calor, no desaparece",
                     "Sí, desaparece", "No, se conserva intacta"],
            ...
            {"q": "Los descomponedores, ¿aportan energía a los niveles superiores?",
             "ops": ["Aportan materia; la energía ya se degradó",
                     "Sí, devuelven toda la energía", "No hacen nada"],
             "m": "Cierran el ciclo de la materia, no el de la energía."},
            {"q": "En una pirámide de energía, ¿dónde está el escalón más ancho?",
             "ops": ["En la base, con los productores", "En la punta", "En el medio"],
             "m": "Es donde hay más energía disponible."},
            {"q": "¿Qué diferencia hay entre cadena y red trófica?",
             "ops": ["La red muestra que cada especie come de varias fuentes",
                     "Son sinónimos", "La cadena es más grande"],
             "m": "La red es más realista: casi ningún animal come una sola cosa."},
        ],
    },
    {
        "id": "sucesion_ecologica_7", "grado": 7, "area": "naturales",
        "titulo": "Sucesión ecológica", "icono": "🌾",
        "mecanica": "trivia",
        "consigna": "Pensá cómo se recupera un ambiente.",
        "explica": "Después de un disturbio, el ambiente se recompone por etapas y en orden.",
        "dc": "Sucesión tras un disturbio; efecto en cascada de una especie",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CN3",
        "saber": {"id": "NAT-7-sucesion", "nombre": "Sucesión ecológica",
                  "prereqs": ["NAT-7-energia"]},
        "banco": [
            {"q": "¿Qué es una sucesión ecológica?",
             "ops": ["El cambio ordenado de las comunidades de un lugar a lo largo del tiempo",
                     "La migración de una especie", "Una cadena alimentaria"],
             "m": "No es un cambio al azar: sigue etapas reconocibles."},
            {"q": "Después de un incendio, ¿qué aparece primero?",
             "ops": ["Pastos y hierbas de crecimiento rápido", "Árboles grandes",
                     "Los grandes mamíferos"],
             "m": "Las especies pioneras son las que colonizan primero."},
            {"q": "¿Qué son las especies pioneras?",
             "ops": ["Las primeras en colonizar un ambiente alterado",
                     "Las que llegan al final", "Las más grandes"],
             "m": "Toleran condiciones duras y preparan el suelo para las siguientes."},
            {"q": "¿Qué es la comunidad clímax?",
             "ops": ["La etapa final y estable de la sucesión", "La primera etapa",
            ...
            {"q": "Si se elimina al depredador tope de un ecosistema, ¿qué suele pasar?",
             "ops": ["Sus presas se multiplican y afectan al resto",
                     "No cambia nada", "Se extingue todo"],
             "m": "Eso es un efecto en cascada: el impacto se propaga por la red."},
            {"q": "¿Qué es una especie exótica invasora?",
             "ops": ["Una traída de otro lugar que se expande y desplaza a las nativas",
                     "Una especie muy rara", "Una que está en peligro"],
             "m": "Sin sus depredadores naturales, puede crecer sin control."},
            {"q": "El castor introducido en Tierra del Fuego es un ejemplo de…",
             "ops": ["Especie invasora que transformó el ambiente", "Especie pionera nativa",
                     "Comunidad clímax"],
             "m": "Sus diques inundaron bosques que no se regeneran."},
            {"q": "¿Qué es un disturbio ecológico?",
             "ops": ["Un evento que altera la comunidad, como un incendio o una tala",
                     "Un cambio de estación", "La llegada de la noche"],
             "m": "Puede ser natural o provocado por la actividad humana."},
            {"q": "¿La sucesión ocurre siempre a la misma velocidad?",
             "ops": ["No: depende del clima, el suelo y el disturbio",
                     "Sí, siempre igual", "Sólo en los bosques"],
             "m": "Un bosque puede tardar décadas; un pastizal, pocos años."},
            {"q": "¿Qué es la sucesión primaria?",
             "ops": ["La que empieza donde no había suelo, como en una roca desnuda",
                     "La que sigue a un incendio", "La más rápida"],
            ...
            {"q": "¿Por qué la biodiversidad aumenta durante la sucesión?",
             "ops": ["Porque cada etapa crea condiciones para nuevas especies",
                     "Porque llegan más animales de golpe", "No aumenta"],
            ...
            {"q": "¿Qué pasa si se introduce una especie sin depredadores naturales?",
             "ops": ["Puede crecer sin control y desplazar a las nativas",
                     "Se extingue rápido", "Se equilibra sola"],
            ...
            {"q": "Un pastizal que se abandona y con los años se llena de arbustos y árboles muestra…",
             "ops": ["Una sucesión secundaria", "Una sucesión primaria", "Un disturbio"],
             "m": "El suelo ya estaba: por eso avanza relativamente rápido."},
            {"q": "¿Los seres vivos modifican el ambiente donde viven?",
             "ops": ["Sí, y eso es motor de la sucesión", "No, sólo se adaptan",
                     "Sólo las plantas"],
             "m": "Las pioneras generan suelo y sombra, y así cambian las condiciones."},
        ],
    },
    {
        "id": "sistema_nervioso_7", "grado": 7, "area": "naturales",
        "titulo": "Camino del estímulo", "icono": "🧠",
        "mecanica": "trivia",
        "consigna": "Seguí el recorrido del estímulo a la respuesta.",
        "explica": "El estímulo entra por un receptor, se procesa en el centro y sale como respuesta.",
        "dc": "Sentidos y sistema nervioso; central y periférico; efectos del alcohol",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CN4",
        "saber": {"id": "NAT-7-nervioso", "nombre": "Sistema nervioso", "prereqs": []},
        "banco": [
            {"q": "¿Cuál es el orden correcto del camino del estímulo?",
             "ops": ["Receptor → nervio → centro nervioso → nervio → efector",
                     "Efector → receptor → centro", "Centro → receptor → efector"],
             "m": "Primero se capta, después se procesa y al final se responde."},
            {"q": "¿Qué órganos forman el sistema nervioso CENTRAL?",
             "ops": ["El encéfalo y la médula espinal", "Los nervios de los brazos",
                     "Los órganos de los sentidos"],
             "m": "Los nervios que salen de ahí forman el periférico."},
            {"q": "¿Qué es una neurona?", "ops": ["La célula que transmite el impulso nervioso",
                     "Un órgano del cerebro", "Un tipo de músculo"],
             "m": "Es la unidad funcional del sistema nervioso."},
            {"q": "¿Qué es un acto reflejo?", "ops": ["Una respuesta rápida que se resuelve en la médula",
                     "Una decisión pensada", "Un movimiento voluntario"],
             "m": "No pasa por el cerebro: por eso es tan rápido."},
            {"q": "Sacar la mano de algo caliente antes de darse cuenta es…",
             "ops": ["Un acto reflejo", "Un acto voluntario", "Un error del sistema"],
             "m": "La médula responde antes de que el cerebro procese el dolor."},
            {"q": "¿Qué es un receptor?", "ops": ["La estructura que capta el estímulo",
                     "El músculo que responde", "El nervio que transmite"],
             "m": "Están en los órganos de los sentidos y en la piel."},
            {"q": "¿Qué es un efector?", "ops": ["El músculo o la glándula que ejecuta la respuesta",
                     "El que capta el estímulo", "El centro nervioso"],
             "m": "Es el que produce el movimiento o la secreción."},
            {"q": "¿Cómo afecta el alcohol al sistema nervioso?",
             "ops": ["Lo deprime: enlentece los reflejos y el juicio",
                     "Lo estimula y mejora los reflejos", "No lo afecta"],
             "m": "La sensación inicial de desinhibición engaña: es un depresor."},
            {"q": "¿Por qué el alcohol y conducir son incompatibles?",
             "ops": ["Porque alarga el tiempo de reacción", "Porque da sueño solamente",
                     "Porque afecta la vista nada más"],
             "m": "Unos décimos de segundo más de reacción son metros de más de frenado."},
            {"q": "¿Qué es la sinapsis?", "ops": ["La conexión por la que pasa el impulso entre neuronas",
                     "El núcleo de la neurona", "Un tipo de nervio"],
            ...
            {"q": "¿Qué pasa con el tiempo de reacción cuando alguien está cansado?",
             "ops": ["Se alarga", "Se acorta", "No cambia"],
             "m": "El cansancio afecta al sistema nervioso igual que otras sustancias."},
        ],
    },
    {
        "id": "inmune_7", "grado": 7, "area": "naturales",
        "titulo": "Barreras y defensas", "icono": "🛡️",
        "mecanica": "trivia",
        "consigna": "¿Cómo se defiende el cuerpo?",
        "explica": "La defensa inespecífica actúa contra todo; la específica, contra un enemigo puntual.",
        "dc": "Defensa inespecífica y específica; respuesta primaria y secundaria",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CN5",
        "saber": {"id": "NAT-7-inmune", "nombre": "Sistema inmune",
                  "prereqs": ["NAT-7-nervioso"]},
        "banco": [
            {"q": "¿Cuál es la primera barrera de defensa del cuerpo?",
             "ops": ["La piel y las mucosas", "Los anticuerpos", "Los linfocitos"],
             "m": "Es una barrera física: impide la entrada."},
            {"q": "¿Qué es una defensa INESPECÍFICA?",
             "ops": ["La que actúa igual contra cualquier invasor", "La que ataca a uno solo",
                     "La que da la vacuna"],
             "m": "La piel, la fiebre y la inflamación no distinguen de qué microbio se trata."},
            {"q": "¿Qué es una defensa ESPECÍFICA?",
             "ops": ["La que reconoce y ataca a un invasor puntual",
                     "La barrera de la piel", "La fiebre"],
             "m": "Los anticuerpos se fabrican a medida de cada antígeno."},
            {"q": "¿Qué es un anticuerpo?", "ops": ["Una proteína que reconoce a un invasor específico",
                     "Un tipo de virus", "Una célula de la piel"],
            ...
            {"q": "¿Por qué la segunda vez que aparece el mismo microbio la respuesta es más rápida?",
             "ops": ["Porque hay células de memoria", "Porque el microbio es más débil",
                     "Porque la piel se hizo más gruesa"],
             "m": "Ésa es la base de cómo funcionan las vacunas."},
            {"q": "¿Para qué sirve la fiebre?", "ops": ["Dificulta la reproducción de los microbios",
                     "Es sólo un síntoma inútil", "Enfría el cuerpo"],
             "m": "Es parte de la respuesta, aunque haya que controlarla si sube demasiado."},
            {"q": "¿Qué es la inflamación?", "ops": ["Una respuesta que lleva más defensas a la zona afectada",
                     "Una infección", "Un daño permanente"],
             "m": "El enrojecimiento y el calor vienen del aumento de la circulación."},
            {"q": "¿Los antibióticos sirven contra los virus?",
             "ops": ["No: actúan sobre las bacterias", "Sí, contra todos",
                     "Sí, si la dosis es alta"],
             "m": "Tomarlos de más favorece la resistencia bacteriana."},
            {"q": "¿Qué es un antígeno?", "ops": ["Una sustancia que el cuerpo reconoce como extraña",
                     "Un anticuerpo", "Un tipo de glóbulo rojo"],
             "m": "Es lo que dispara la respuesta específica."},
            {"q": "¿Qué células producen los anticuerpos?", "ops": ["Los linfocitos",
                     "Los glóbulos rojos", "Las plaquetas"],
             "m": "Los glóbulos rojos transportan oxígeno; las plaquetas coagulan."},
            {"q": "El moco de las vías respiratorias, ¿qué función cumple?",
             "ops": ["Atrapa partículas y microbios antes de que entren",
                     "Sólo molesta", "Transporta oxígeno"],
             "m": "Es parte de las barreras inespecíficas."},
            {"q": "¿Por qué la respuesta secundaria es más intensa?",
             "ops": ["Porque el sistema ya reconoce al invasor y reacciona antes",
                     "Porque el cuerpo está más débil", "Porque hay más microbios"],
             "m": "Las células de memoria acortan el tiempo de reacción."},
            {"q": "El ácido del estómago, ¿es una defensa?",
             "ops": ["Sí, inespecífica: destruye muchos microbios que se tragan",
                     "No, sólo digiere", "Sólo si hay fiebre"],
             "m": "Es una barrera química."},
            {"q": "¿Qué es la inmunidad?", "ops": ["La capacidad de defenderse de un agente al que ya se enfrentó",
                     "No enfermarse nunca", "Tener fiebre alta"],
             "m": "Se puede adquirir por haber cursado la enfermedad o por vacunación."},
        ],
    },
    {
        "id": "vacunas_7", "grado": 7, "area": "naturales",
        "titulo": "Cómo actúa una vacuna", "icono": "💉",
        "mecanica": "trivia",
        "consigna": "Pensá qué hace la vacuna en el cuerpo.",
        "explica": "La vacuna entrena al sistema inmune SIN que haya que pasar la enfermedad.",
        "dc": "Acción de las vacunas; calendario; protección colectiva",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CN6",
        "saber": {"id": "NAT-7-vacunas", "nombre": "Vacunas e inmunidad",
                  "prereqs": ["NAT-7-inmune"]},
        "banco": [
            {"q": "¿Qué hace una vacuna?",
             "ops": ["Entrena al sistema inmune sin producir la enfermedad",
                     "Mata a los microbios que ya están", "Cura una infección en curso"],
             "m": "Es preventiva: se da ANTES de enfermarse."},
            {"q": "¿Qué contiene una vacuna?",
             "ops": ["El microbio inactivado o una parte de él", "Antibióticos",
            ...
            {"q": "¿Por qué hay que vacunarse contra la gripe todos los años?",
             "ops": ["Porque el virus cambia y la vacuna se actualiza",
                     "Porque la vacuna es de mala calidad", "Porque el cuerpo la rechaza"],
            ...
            {"q": "¿A qué edad se dan la mayoría de las vacunas del calendario?",
             "ops": ["Durante los primeros años de vida", "Recién en la adultez",
            ...
            {"q": "Si alguien no puede vacunarse por una enfermedad, ¿cómo se protege?",
             "ops": ["Con la protección colectiva de los que sí se vacunan",
                     "No se puede proteger", "Tomando antibióticos"],
             "m": "Por eso vacunarse es también un acto de cuidado hacia otros."},
            {"q": "¿Qué diferencia hay entre vacuna y antibiótico?",
             "ops": ["La vacuna previene; el antibiótico trata una infección bacteriana",
                     "Son lo mismo", "El antibiótico previene y la vacuna cura"],
             "m": "Una actúa antes; el otro, cuando la infección ya está."},
            {"q": "La vacuna contra el VPH se da…", "ops": ["En la adolescencia, a todos",
                     "Sólo a las mujeres adultas", "Al nacer"],
    ...
    },
    {
        ...
        "banco": [
            ...
            {"q": "¿La energía de una pila se acaba?",
             "ops": ["Se transforma hasta que los reactivos se agotan",
                     "Desaparece sin más", "Se recicla sola"],
             "m": "La cantidad se conserva; lo que se agota es la sustancia que la almacena."},
            {"q": "En un molino eólico, ¿qué se transforma?",
             "ops": ["Energía del viento en eléctrica", "Calor en movimiento",
                     "Luz en calor"],
             "m": "El viento mueve las palas y éstas el generador."},
            {"q": "Al frenar un auto, ¿adónde va la energía del movimiento?",
             "ops": ["Se transforma en calor en los frenos", "Desaparece",
                     "Vuelve al motor"],
             "m": "Por eso los frenos se calientan tanto."},
            {"q": "¿Se puede recuperar toda la energía degradada como calor disperso?",
             "ops": ["No, en la práctica no", "Sí, con la máquina adecuada",
                     "Sí, siempre"],
             "m": "Ésa es la diferencia entre conservación y degradación."},
        ],
    },
    {
        "id": "quimica_fisica_7", "grado": 7, "area": "naturales",
        "titulo": "¿Química o física?", "icono": "🧪",
        "mecanica": "clasificar",
        "consigna": "¿Cambió la sustancia o sólo su forma?",
        "explica": "En un cambio químico aparece una sustancia NUEVA; en uno físico, no.",
        "categorias": [{"cat": "fisica", "label": "🧊 Física"},
                       {"cat": "quimica", "label": "🔥 Química"}],
        "dc": "Transformaciones químicas y físicas; reactivos y productos; combustión",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CN8",
        "saber": {"id": "NAT-7-transformaciones", "nombre": "Transformaciones químicas y físicas",
                  "prereqs": ["NAT-7-transformacion"]},
        "banco": [
            {"it": "El hielo se derrite", "cat": "fisica",
             "m": "Sigue siendo agua: sólo cambió de estado."},
            {"it": "Un papel se quema", "cat": "quimica",
             "m": "Aparecen sustancias nuevas: cenizas y gases. No hay vuelta atrás."},
            {"it": "El agua hierve", "cat": "fisica", "m": "El vapor sigue siendo agua."},
            {"it": "Un clavo se oxida", "cat": "quimica",
             "m": "El hierro se combina con el oxígeno y forma óxido, otra sustancia."},
            {"it": "Se rompe un vaso", "cat": "fisica", "m": "Cambió la forma, no el vidrio."},
            {"it": "La leche se corta", "cat": "quimica",
             "m": "Las proteínas se transforman: ya no es leche."},
            {"it": "Se disuelve azúcar en agua", "cat": "fisica",
             "m": "El azúcar sigue ahí: se puede recuperar evaporando el agua."},
            {"it": "Se hornea una torta", "cat": "quimica",
             "m": "Los ingredientes reaccionan y forman algo nuevo."},
            {"it": "Se corta una madera con serrucho", "cat": "fisica",
             "m": "Sigue siendo madera, en trozos más chicos."},
            {"it": "Una fruta se pudre", "cat": "quimica",
             "m": "Los microorganismos transforman su materia."},
            {"it": "Un alambre de cobre se dobla", "cat": "fisica",
             "m": "Cambió la forma; el cobre es el mismo."},
            {"it": "Se enciende una vela y la cera arde", "cat": "quimica",
             "m": "La combustión produce dióxido de carbono y agua."},
            {"it": "Se evapora el agua de un charco", "cat": "fisica",
             "m": "Cambio de estado, no de sustancia."},
            {"it": "Se agrega vinagre al bicarbonato y burbujea", "cat": "quimica",
             "m": "El gas que sale es una sustancia nueva."},
            {"it": "Se muele café en grano", "cat": "fisica",
             "m": "El polvo sigue siendo café."},
            {"it": "Una manzana cortada se pone marrón", "cat": "quimica",
             "m": "Se oxida al contacto con el aire."},
        ],
    },
    {
        "id": "movimientos_tierra_7", "grado": 7, "area": "naturales",
        "titulo": "Día, noche, estaciones y fases", "icono": "🌎",
        "mecanica": "trivia",
        "consigna": "Pensá qué movimiento produce cada cosa.",
        "explica": "El día lo produce la rotación; las estaciones, la inclinación del eje.",
        "dc": "Rotación y traslación; eje inclinado; fases lunares",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CN9",
        "saber": {"id": "NAT-7-tierra", "nombre": "Movimientos de la Tierra y la Luna",
                  "prereqs": []},
        "banco": [
            {"q": "¿Qué produce el día y la noche?", "ops": ["La rotación de la Tierra",
                     "La traslación alrededor del Sol", "El movimiento de la Luna"],
             "m": "La rotación dura 24 horas; la traslación, un año."},
            {"q": "¿Qué produce las estaciones del año?",
             "ops": ["La inclinación del eje terrestre durante la traslación",
                     "La distancia al Sol", "La rotación"],
            ...
            {"q": "Cuando es verano en la Argentina, en Europa es…",
             "ops": ["Invierno", "Verano también", "Otoño"],
            ...
            {"q": "¿Cuánto tarda la Tierra en dar una vuelta sobre su eje?",
             "ops": ["24 horas", "365 días", "28 días"],
             "m": "365 días es la traslación."},
            {"q": "¿Cuánto tarda la Luna en dar una vuelta alrededor de la Tierra?",
             "ops": ["Alrededor de 28 días", "24 horas", "365 días"],
             "m": "Por eso el ciclo de las fases dura aproximadamente un mes."},
            {"q": "¿Por qué vemos siempre la misma cara de la Luna?",
             "ops": ["Porque tarda lo mismo en rotar que en girar alrededor de la Tierra",
                     "Porque no rota", "Porque está muy lejos"],
             "m": "Se llama rotación sincrónica."},
            {"q": "¿Por qué la Luna cambia de forma?",
             "ops": ["Porque vemos distinta parte de su mitad iluminada",
                     "Porque la sombra de la Tierra la tapa", "Porque cambia de tamaño"],
             "m": "La sombra de la Tierra sólo actúa en un eclipse de Luna, que es otra cosa."},
            {"q": "En el solsticio de verano, ¿qué pasa?",
             "ops": ["Es el día más largo del año en ese hemisferio",
                     "El día y la noche duran igual", "Es el día más corto"],
             "m": "En el equinoccio duran igual."},
            {"q": "¿Qué es un equinoccio?", "ops": ["El día en que la noche y el día duran lo mismo",
                     "El día más largo", "El día más corto"],
             "m": "Ocurre dos veces al año, en marzo y en septiembre."},
            {"q": "¿En qué orden van las fases de la Luna?",
             "ops": ["Nueva, creciente, llena, menguante", "Llena, nueva, creciente, menguante",
            ...
            {"q": "¿Qué es un año bisiesto y por qué existe?",
             "ops": ["Porque la traslación tarda un poco más de 365 días",
                     "Porque la Luna cambia", "Porque el calendario está mal"],
             "m": "Cada cuatro años se acumula casi un día entero."},
            {"q": "¿El Sol se mueve alrededor de la Tierra?",
             "ops": ["No: es un movimiento aparente por la rotación terrestre",
                     "Sí, una vez por día", "Sí, una vez por año"],
             "m": "Ese movimiento aparente sostuvo al geocentrismo durante siglos."},
        ],
    },
    {
        "id": "eclipses_universo_7", "grado": 7, "area": "naturales",
        "titulo": "Eclipses y el universo", "icono": "🌌",
        "mecanica": "trivia",
        "consigna": "Pensá en las escalas y en las sombras.",
        "explica": "El eclipse de Sol funciona porque el Sol es 400 veces más grande y está 400 veces más lejos.",
        "dc": "Eclipses; escalas; modelo actual del universo y exoplanetas",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CN10",
        "saber": {"id": "NAT-7-universo", "nombre": "Eclipses y modelo del universo",
                  "prereqs": ["NAT-7-tierra"]},
        "banco": [
            {"q": "En un eclipse de SOL, ¿qué tapa a qué?",
             "ops": ["La Luna tapa al Sol", "La Tierra tapa al Sol", "El Sol tapa a la Luna"],
             "m": "La Luna se interpone entre el Sol y nosotros."},
            {"q": "En un eclipse de LUNA, ¿qué pasa?",
             "ops": ["La sombra de la Tierra cae sobre la Luna", "La Luna tapa al Sol",
                     "La Luna se apaga"],
             "m": "La Tierra queda en el medio."},
            {"q": "¿Por qué la Luna, siendo chiquita, puede tapar al Sol?",
             "ops": ["Porque el Sol es 400 veces más grande pero está 400 veces más lejos",
                     "Porque la Luna crece", "Porque el Sol se achica"],
             "m": "Es una coincidencia de escalas que hace posible el eclipse total."},
            {"q": "¿Por qué no hay un eclipse cada mes?",
             "ops": ["Porque la órbita de la Luna está inclinada respecto de la de la Tierra",
                     "Porque la Luna se aleja", "Porque el Sol se mueve"],
             "m": "Sólo se alinean en ciertos momentos del año."},
            {"q": "¿Se puede mirar un eclipse de Sol a ojo desnudo?",
             "ops": ["No: daña la vista de forma permanente", "Sí, si es corto",
                     "Sí, con anteojos de sol comunes"],
             "m": "Hacen falta filtros especiales certificados."},
            {"q": "¿Qué es la Vía Láctea?", "ops": ["La galaxia donde está el Sol",
                     "Un cúmulo de planetas", "Otra galaxia lejana"],
             "m": "El Sol es una de sus cientos de miles de millones de estrellas."},
            {"q": "¿Dónde está el Sol dentro de la Vía Láctea?",
             "ops": ["En un brazo, lejos del centro", "En el centro exacto",
                     "Fuera de la galaxia"],
             "m": "Está a unos 26.000 años luz del centro."},
            {"q": "¿Qué es un año luz?", "ops": ["La distancia que recorre la luz en un año",
                     "El tiempo que tarda la luz en llegar", "Un año en otro planeta"],
             "m": "Es una unidad de DISTANCIA, no de tiempo."},
            {"q": "¿Qué es un exoplaneta?", "ops": ["Un planeta que orbita otra estrella",
                     "Un planeta muy grande", "Un planeta sin atmósfera"],
             "m": "Ya se confirmaron miles."},
            {"q": "¿Qué es el Big Bang según el modelo actual?",
             "ops": ["El estado inicial denso y caliente del que el universo se expande",
                     "Una explosión en el espacio vacío", "El fin del universo"],
             "m": "No fue una explosión EN el espacio: el espacio mismo se expande."},
            {"q": "¿El universo se está expandiendo?", "ops": ["Sí, y la expansión se acelera",
                     "No, es estático", "Se está contrayendo"],
             "m": "Se observa por el corrimiento al rojo de las galaxias lejanas."},
            {"q": "Cuando mirás una estrella muy lejana, ¿qué estás viendo?",
             "ops": ["Cómo era hace mucho tiempo, porque la luz tardó en llegar",
                     "Cómo es ahora mismo", "Un reflejo del Sol"],
             "m": "Mirar lejos es mirar al pasado."},
            {"q": "¿Cuánto tarda la luz del Sol en llegar a la Tierra?",
             "ops": ["Unos 8 minutos", "Un segundo", "Un año"],
             "m": "Por eso vemos al Sol como era hace ocho minutos."},
            {"q": "¿Qué es una galaxia?", "ops": ["Un conjunto enorme de estrellas, gas y polvo ligados por la gravedad",
                     "Un sistema de planetas", "Una nube de gas sin estrellas"],
    ...
    },
    {
        ...
        "saber": {"id": "NAT-7-reproductor", "nombre": "Sistema reproductor",
                  "prereqs": ["NAT-7-inmune"]},
        "banco": [
            {"q": "¿Qué órgano produce los óvulos?", "ops": ["El ovario", "El útero",
                     "La trompa de Falopio"],
             "m": "El útero es donde se implantaría el embrión."},
            {"q": "¿Qué órganos producen los espermatozoides?", "ops": ["Los testículos",
                     "La próstata", "La uretra"],
            ...
            {"q": "¿Qué hormonas participan del ciclo menstrual?",
             "ops": ["Estrógenos y progesterona", "Insulina y adrenalina",
                     "Tiroxina y cortisol"],
             "m": "Son hormonas sexuales producidas principalmente en los ovarios."},
            {"q": "¿Qué es la vulva?", "ops": ["El conjunto de los órganos genitales externos",
                     "El útero", "La vagina"],
             "m": "La vagina es un conducto interno: no son sinónimos."},
            {"q": "¿Cuál es la función del escroto?",
             "ops": ["Mantener los testículos a una temperatura menor que la del cuerpo",
                     "Producir hormonas", "Almacenar orina"],
            ...
            {"q": "¿Qué es la pubertad desde el punto de vista del aparato reproductor?",
             "ops": ["El momento en que empieza a ser funcional",
                     "El fin del desarrollo", "Una enfermedad"],
             "m": "Es una etapa normal del desarrollo."},
            {"q": "¿Qué produce la próstata?", "ops": ["Parte del líquido seminal",
                     "Los espermatozoides", "Las hormonas femeninas"],
             "m": "Los espermatozoides se producen en los testículos."},
            {"q": "¿Los sistemas reproductores funcionan aislados del resto del cuerpo?",
             "ops": ["No: están regulados por el sistema endocrino",
                     "Sí, funcionan solos", "Sólo dependen del nervioso"],
             "m": "Las hormonas coordinan su funcionamiento."},
            {"q": "¿Por qué importa usar los nombres correctos de las partes del cuerpo?",
             "ops": ["Porque permite pedir ayuda y cuidarse con precisión",
                     "Porque queda mejor", "No importa"],
             "m": "Es una de las razones por las que la ESI insiste en nombrar bien."},
            {"q": "¿Qué son las trompas de Falopio?", "ops": ["Los conductos que unen los ovarios con el útero",
                     "Glándulas hormonales", "Parte de la vejiga"],
             "m": "Por ahí viaja el óvulo."},
            {"q": "¿A quién conviene consultarle dudas sobre salud sexual?",
             "ops": ["A un profesional de la salud o un adulto de confianza",
                     "A nadie", "Sólo a internet"],
             "m": "En los centros de salud la consulta es gratuita y confidencial."},
        ],
    },

    # ── CIENCIAS SOCIALES de 7° ──────────────────────────────────────────────────
    # ⚠ CS3 y CS6 tratan la última dictadura y el terrorismo de Estado. Se escriben
    # con los hechos que NO están en disputa —plan sistemático, desaparición forzada,
    # centros clandestinos, apropiación de bebés, los juicios— y deliberadamente no se
    # convierte en ítem de opción múltiple ninguna cifra discutida. Revisión docente
    # obligatoria antes de la venta.
    {
        "id": "linea_siglo_xx_7", "grado": 7, "area": "sociales",
        "titulo": "Línea de tiempo del siglo XX", "icono": "🕰️",
        "mecanica": "ordenar",
        "consigna": "Ordená del hecho MÁS ANTIGUO al más nuevo. Tocá en orden.",
        "explica": "Anclate en las fechas que ya sabés y ubicá el resto alrededor.",
        "dc": "1930, sustitución de importaciones, peronismo, 1976, Malvinas, 1983",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CS1",
        "saber": {"id": "SOC-7-siglo-xx", "nombre": "El siglo XX argentino", "prereqs": []},
        "banco": [
            {"items": ["Golpe de Estado de 1930", "Primera presidencia de Perón (1946)",
                       "Golpe de Estado de 1976", "Vuelta de la democracia (1983)"]},
            {"items": ["Crisis mundial de 1929", "Comienza la sustitución de importaciones (1930s)",
                       "Voto femenino en la Argentina (1947)",
                       "Primera elección con voto de mujeres (1951)"]},
            {"items": ["Golpe de 1930", "Golpe de 1955", "Golpe de 1976",
                       "Elecciones de 1983"]},
            {"items": ["Segunda Guerra Mundial (1939-1945)",
                       "Creación de las Naciones Unidas (1945)",
                       "Guerra de Malvinas (1982)", "Juicio a las Juntas (1985)"]},
            {"items": ["Ley Sáenz Peña (1912)", "Golpe de 1930",
                       "Primera presidencia de Perón (1946)", "Golpe de 1976"]},
            {"items": ["Sustitución de importaciones (década de 1930)",
                       "Voto femenino (1947)", "Guerra de Malvinas (1982)",
                       "Reforma de la Constitución (1994)"]},
            {"items": ["Golpe de Estado de 1976", "Guerra de Malvinas (1982)",
                       "Vuelta de la democracia (1983)", "Juicio a las Juntas (1985)"]},
            {"items": ["Fin de la Segunda Guerra Mundial (1945)",
                       "Comienzo de la Guerra Fría (fines de los 40)",
                       "Caída del Muro de Berlín (1989)",
                       "Reforma constitucional argentina (1994)"]},
            {"items": ["Primera presidencia de Perón (1946)", "Voto femenino (1947)",
                       "Golpe de 1955", "Golpe de 1976"]},
            {"items": ["Guerra de Malvinas (1982)", "Vuelta de la democracia (1983)",
                       "Juicio a las Juntas (1985)", "Reforma constitucional (1994)"]},
        ],
    },
    {
        "id": "bandos_siglo_xx_7", "grado": 7, "area": "sociales",
        "titulo": "Bandos: Segunda Guerra y Guerra Fría", "icono": "🌍",
        "mecanica": "clasificar",
        "consigna": "¿De qué conflicto es este elemento?",
        "explica": "La Segunda Guerra fue con ejércitos; la Guerra Fría, una tensión sin enfrentamiento directo.",
        "categorias": [{"cat": "segunda_guerra", "label": "⚔️ Segunda Guerra"},
                       {"cat": "guerra_fria", "label": "❄️ Guerra Fría"}],
        "dc": "Aliados y Eje; el mundo bipolar de la Guerra Fría",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CS2",
        "saber": {"id": "SOC-7-conflictos", "nombre": "Segunda Guerra y Guerra Fría",
                  "prereqs": ["SOC-7-siglo-xx"]},
        "banco": [
            {"it": "La alianza entre Alemania, Italia y Japón", "cat": "segunda_guerra",
             "m": "Eran las potencias del Eje."},
            {"it": "El Muro de Berlín", "cat": "guerra_fria",
             "m": "Se levantó en 1961 y dividió la ciudad hasta 1989."},
            {"it": "El desembarco en Normandía", "cat": "segunda_guerra",
             "m": "Operación aliada de 1944."},
            {"it": "La carrera espacial entre Estados Unidos y la URSS", "cat": "guerra_fria",
             "m": "La competencia se dio en la ciencia y la tecnología, no en el campo de batalla."},
            {"it": "El Holocausto", "cat": "segunda_guerra",
             "m": "El exterminio sistemático perpetrado por el régimen nazi."},
            {"it": "La OTAN y el Pacto de Varsovia", "cat": "guerra_fria",
             "m": "Las dos alianzas militares del mundo bipolar."},
            {"it": "El bombardeo de Hiroshima y Nagasaki", "cat": "segunda_guerra",
             "m": "Agosto de 1945, al final del conflicto."},
            {"it": "La crisis de los misiles en Cuba", "cat": "guerra_fria",
             "m": "1962: el momento de mayor tensión nuclear."},
            {"it": "La invasión de Polonia en 1939", "cat": "segunda_guerra",
             "m": "El hecho que dio inicio a la guerra en Europa."},
            {"it": "La caída del Muro en 1989", "cat": "guerra_fria",
             "m": "Marca simbólicamente el final de la Guerra Fría."},
            {"it": "La alianza entre Estados Unidos, el Reino Unido y la URSS", "cat": "segunda_guerra",
             "m": "Eran los Aliados: pelearon juntos y después quedaron enfrentados."},
            {"it": "La división del mundo en dos bloques ideológicos", "cat": "guerra_fria",
             "m": "Capitalismo y comunismo como modelos en disputa."},
            {"it": "La creación de las Naciones Unidas en 1945", "cat": "segunda_guerra",
             "m": "Nació al terminar el conflicto, para evitar otro igual."},
            {"it": "La llegada del hombre a la Luna en 1969", "cat": "guerra_fria",
             "m": "Fue un hito de la carrera espacial entre las dos potencias."},
            {"it": "El juicio de Núremberg", "cat": "segunda_guerra",
            ...
            {"it": "El apoyo de las potencias a distintos bandos en conflictos de otros países",
             "cat": "guerra_fria", "m": "Los enfrentamientos eran indirectos: por eso «fría»."},
        ],
    },
    {
        "id": "democracia_dictadura_7", "grado": 7, "area": "sociales",
        "titulo": "¿Democracia o dictadura?", "icono": "🕊️",
        "mecanica": "trivia",
        "consigna": "Pensá quién ejerce el poder y con qué límites.",
        "explica": "En democracia el poder se elige y tiene límites; en dictadura, no.",
        "dc": "Alternancia de democracias y dictaduras; terrorismo de Estado; DDHH",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CS3",
        "saber": {"id": "SOC-7-terrorismo-estado", "nombre": "Democracia, dictadura y DDHH",
                  "prereqs": ["SOC-7-siglo-xx"]},
        "banco": [
            {"q": "¿Qué caracteriza a un gobierno democrático?",
             "ops": ["Se elige por el voto y tiene límites y controles",
                     "Gobierna una sola persona sin control", "No hay elecciones"],
             "m": "No alcanza con votar: también hacen falta división de poderes y libertades."},
            {"q": "¿Qué es un golpe de Estado?",
             "ops": ["La toma del poder por fuera de la Constitución",
                     "Una elección adelantada", "Un cambio de ministro"],
             "m": "Interrumpe el orden constitucional por la fuerza."},
            {"q": "¿Cuántos golpes de Estado hubo en la Argentina en el siglo XX?",
             "ops": ["Seis: 1930, 1943, 1955, 1962, 1966 y 1976", "Uno solo, en 1976",
                     "Ninguno"],
            ...
            {"q": "¿Qué es el terrorismo de Estado?",
             "ops": ["Cuando el propio Estado usa su aparato para perseguir y reprimir ilegalmente",
                     "Un ataque contra el Estado", "Una protesta social"],
             "m": "Lo grave es que quien debía proteger los derechos fue el que los violó."},
            {"q": "¿Qué fue un centro clandestino de detención?",
             "ops": ["Un lugar secreto donde se detenía a personas al margen de la ley",
                     "Una cárcel común", "Un cuartel militar cualquiera"],
             "m": "Clandestino significa que su existencia se negaba oficialmente."},
            {"q": "¿Qué es una desaparición forzada?",
             "ops": ["Cuando el Estado detiene a alguien y niega tenerlo o dar información",
                     "Cuando alguien se muda sin avisar", "Una detención con orden judicial"],
             "m": "La negación es parte del delito: deja a la familia sin ninguna vía legal."},
            {"q": "¿Qué son las Abuelas de Plaza de Mayo?",
             "ops": ["Una organización que busca a los nietos apropiados durante la dictadura",
                     "Un partido político", "Un organismo del gobierno"],
             "m": "Fue una de las apropiaciones sistemáticas de bebés que la Justicia comprobó."},
            {"q": "¿Qué fue la CONADEP?",
             "ops": ["La comisión que investigó las desapariciones y publicó el informe «Nunca Más»",
                     "Un tribunal militar", "Un partido político"],
             "m": "Se creó en 1983 y su informe fue prueba en los juicios."},
            {"q": "¿Qué fue el Juicio a las Juntas de 1985?",
             "ops": ["El juicio civil a los responsables de la dictadura",
                     "Un juicio militar interno", "Una comisión investigadora"],
            ...
            {"q": "¿Qué se conmemora el 24 de marzo?",
             "ops": ["El Día Nacional de la Memoria por la Verdad y la Justicia",
                     "El Día de la Independencia", "La vuelta de la democracia"],
             "m": "Recuerda el golpe de 1976. Es feriado inamovible por ley."},
            {"q": "¿Qué son los derechos humanos?",
             "ops": ["Derechos que toda persona tiene por el solo hecho de serlo",
                     "Derechos que otorga cada gobierno", "Derechos que se compran"],
             "m": "No dependen de la nacionalidad ni de quién gobierne."},
            {"q": "¿Qué pasa con la libertad de prensa en una dictadura?",
             "ops": ["Se restringe o se censura", "Se amplía", "No cambia"],
             "m": "Controlar la información es una de las primeras medidas."},
            {"q": "¿Por qué se dice que la memoria es una construcción colectiva?",
             "ops": ["Porque recordar lo que pasó ayuda a que no vuelva a pasar",
                     "Porque es obligatoria", "Porque la decide el gobierno"],
             "m": "Ésa es la razón de los espacios y las fechas de memoria."},
            {"q": "¿Los delitos de lesa humanidad prescriben?",
             "ops": ["No: se pueden juzgar sin límite de tiempo", "Sí, a los diez años",
                     "Sí, a los veinte años"],
             "m": "La imprescriptibilidad es lo que permitió reabrir los juicios años después."},
        ],
    },
    {
        "id": "cadena_productiva_7", "grado": 7, "area": "sociales",
        "titulo": "Cadena productiva y regiones", "icono": "🚜",
        "mecanica": "trivia",
        "consigna": "Seguí el recorrido de la producción.",
        "explica": "Cada etapa agrega valor: la materia prima sola vale mucho menos.",
        "dc": "Encadenamientos agroindustriales; producciones por región",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CS4",
        "saber": {"id": "SOC-7-produccion", "nombre": "Cadenas productivas regionales",
                  "prereqs": []},
        "banco": [
            {"q": "¿Cuál es el orden de una cadena productiva?",
             "ops": ["Materia prima → industrialización → distribución → consumo",
            ...
            {"q": "¿Qué es el valor agregado?",
             "ops": ["Lo que se suma al producto en cada etapa de elaboración",
                     "El precio de la materia prima", "El costo del transporte"],
             "m": "Por eso exportar harina rinde más que exportar trigo."},
            {"q": "¿En qué región argentina se produce principalmente la yerba mate?",
             "ops": ["Misiones y Corrientes", "La Patagonia", "Cuyo"],
             "m": "Necesita el clima subtropical del noreste."},
            {"q": "¿Qué se produce principalmente en Cuyo?",
             "ops": ["Vid y vino", "Yerba mate", "Algodón"],
             "m": "Mendoza y San Juan concentran la vitivinicultura."},
            {"q": "¿Qué producción caracteriza al Alto Valle de Río Negro y Neuquén?",
             "ops": ["Manzanas y peras", "Caña de azúcar", "Yerba mate"],
             "m": "La fruticultura de pepita es su actividad emblemática."},
            {"q": "¿Dónde se concentra la producción de caña de azúcar?",
             "ops": ["Tucumán y el noroeste", "La Patagonia", "La pampa húmeda"],
             "m": "Necesita clima cálido y húmedo."},
            {"q": "¿Qué se produce principalmente en la región pampeana?",
             "ops": ["Cereales, oleaginosas y ganado", "Petróleo", "Yerba mate"],
             "m": "Su suelo fértil y su clima templado la hacen el corazón agrícola."},
            {"q": "¿Qué es un circuito productivo agroindustrial?",
             "ops": ["El conjunto de etapas que van del campo a la industria y al consumidor",
                     "Sólo la etapa del campo", "Sólo la venta"],
             "m": "Incluye a todos los actores, no sólo al productor."},
            {"q": "¿Por qué conviene industrializar la materia prima antes de exportarla?",
             "ops": ["Porque se vende más caro y genera más trabajo local",
                     "Porque pesa menos", "Porque es más fácil"],
             "m": "El valor agregado queda en el país en vez de irse afuera."},
            {"q": "¿Qué región produce lana y carne ovina?", "ops": ["La Patagonia",
                     "El noreste", "Cuyo"],
             "m": "Las estepas patagónicas son aptas para el ovino."},
            {"q": "¿Qué es la etapa de comercialización?",
             "ops": ["Cuando el producto llega al consumidor", "Cuando se cosecha",
                     "Cuando se industrializa"],
             "m": "Es la última etapa del circuito."},
            {"q": "El algodón se produce principalmente en…", "ops": ["Chaco y Santiago del Estero",
                     "La Patagonia", "Cuyo"],
             "m": "Es un cultivo del norte argentino."},
            {"q": "¿Qué actores intervienen en un circuito productivo?",
             "ops": ["Productores, industriales, transportistas y comerciantes",
                     "Sólo los productores", "Sólo el Estado"],
             "m": "Cada uno se queda con una parte del valor final."},
            {"q": "¿Qué región concentra la actividad petrolera?",
             "ops": ["Patagonia y Cuyo", "El noreste", "La pampa húmeda"],
             "m": "Neuquén, Chubut, Santa Cruz y Mendoza son las principales."},
        ],
    },
    {
        "id": "migraciones_7", "grado": 7, "area": "sociales",
        "titulo": "Flujos migratorios", "icono": "🧳",
        "mecanica": "clasificar",
        "consigna": "¿La persona eligió irse o tuvo que hacerlo?",
        "explica": "En una migración forzada no hay opción real de quedarse.",
        "categorias": [{"cat": "voluntaria", "label": "🎒 Voluntaria"},
                       {"cat": "forzada", "label": "⚠️ Forzada"},
                       {"cat": "mixta", "label": "🔀 Mixta"}],
        "dc": "Migraciones forzadas y voluntarias; áreas expulsoras y receptoras",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CS5",
        "saber": {"id": "SOC-7-migraciones", "nombre": "Migraciones",
                  "prereqs": ["SOC-7-produccion"]},
        "banco": [
            {"it": "Una ingeniera se muda a otro país porque le ofrecieron un mejor puesto",
             "cat": "voluntaria", "m": "Elige entre dos opciones posibles."},
            {"it": "Una familia huye de una zona en guerra", "cat": "forzada",
             "m": "Quedarse pondría en riesgo su vida."},
            {"it": "Un joven emigra porque en su región no hay trabajo desde hace años",
             "cat": "mixta", "m": "Formalmente elige, pero la falta de alternativas lo empuja."},
            {"it": "Un estudiante se va a cursar un posgrado al exterior", "cat": "voluntaria",
             "m": "Es una decisión tomada entre opciones reales."},
            {"it": "Una comunidad tiene que abandonar su pueblo por una inundación",
             "cat": "forzada", "m": "El desastre ambiental no deja alternativa."},
            {"it": "Una familia deja el campo porque la mecanización eliminó su trabajo",
             "cat": "mixta", "m": "La causa económica estructural condiciona la decisión."},
            {"it": "Alguien se muda a otra provincia porque le gusta el clima", "cat": "voluntaria",
             "m": "Motivo personal, sin presión externa."},
            {"it": "Personas perseguidas por su religión piden refugio en otro país",
             "cat": "forzada", "m": "El derecho al asilo existe justamente para estos casos."},
            {"it": "Una persona emigra porque en su país la inflación se comió su salario",
             "cat": "mixta", "m": "La crisis económica reduce el margen de elección."},
            {"it": "Un músico se instala en otra ciudad para desarrollar su carrera",
             "cat": "voluntaria", "m": "Decisión profesional entre alternativas."},
            {"it": "Una población es desplazada por la construcción de una represa",
             "cat": "forzada", "m": "El desplazamiento lo impone una obra, no la persona."},
            {"it": "Una familia se muda buscando escuelas y hospitales que en su zona no hay",
             "cat": "mixta", "m": "La falta de servicios básicos empuja la decisión."},
            {"it": "Una pareja se muda al exterior para estar cerca de sus hijos", "cat": "voluntaria",
             "m": "Motivo familiar, con opción de quedarse."},
            {"it": "Personas escapan de un régimen que las persigue por su opinión política",
             "cat": "forzada", "m": "El exilio político es una migración forzada."},
            {"it": "Un trabajador rural viaja cada año a otra provincia para la cosecha",
             "cat": "mixta", "m": "La migración estacional responde a la necesidad de trabajo."},
            {"it": "Alguien se muda a otra ciudad porque le ofrecieron una beca",
             "cat": "voluntaria", "m": "Una oportunidad que se elige tomar."},
        ],
    },
    {
        "id": "espacios_memoria_7", "grado": 7, "area": "sociales",
        "titulo": "Espacios de memoria porteños", "icono": "🕯️",
        "mecanica": "trivia",
        "consigna": "¿Qué recuerda cada espacio?",
        "explica": "Los espacios de memoria son lugares que se preservan para que lo que pasó no se olvide.",
        "dc": "Parque de la Memoria, ex ESMA, Museo del Holocausto, Museo Malvinas",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CS6",
        "saber": {"id": "SOC-7-memoria", "nombre": "Espacios de memoria",
                  "prereqs": ["SOC-7-terrorismo-estado"]},
        "banco": [
            {"q": "¿Qué es el Parque de la Memoria?",
             "ops": ["Un espacio con un monumento que lleva los nombres de las víctimas del terrorismo de Estado",
                     "Un parque de juegos", "Un museo de historia natural"],
             "m": "Está sobre la costanera, frente al Río de la Plata."},
            {"q": "¿Qué funcionó en el predio de la ex ESMA durante la dictadura?",
             "ops": ["Un centro clandestino de detención", "Una escuela pública",
                     "Un hospital"],
             "m": "Hoy es el Espacio Memoria y Derechos Humanos."},
            {"q": "¿Qué recuerda el Museo del Holocausto de Buenos Aires?",
             "ops": ["El exterminio del pueblo judío durante la Segunda Guerra",
                     "La Guerra de Malvinas", "La independencia argentina"],
             "m": "Muchos sobrevivientes se radicaron en la Argentina."},
            {"q": "¿A qué está dedicado el Museo Malvinas e Islas del Atlántico Sur?",
             "ops": ["A la historia de las islas y al conflicto de 1982",
                     "A la fauna marina solamente", "A la dictadura"],
             "m": "Funciona en el mismo predio de la ex ESMA."},
            {"q": "¿Qué es la Casa Ana Frank de Buenos Aires?",
             "ops": ["Un centro educativo sobre el Holocausto y los derechos humanos",
                     "La casa donde vivió Ana Frank", "Un archivo de la dictadura"],
             "m": "Ana Frank nunca vivió en la Argentina: es una réplica con fines educativos."},
            {"q": "¿Para qué sirve un espacio de memoria?",
             "ops": ["Para que las nuevas generaciones conozcan lo que pasó",
                     "Para atraer turistas", "Para guardar objetos antiguos"],
             "m": "Su función es pedagógica y de reparación."},
            {"q": "¿Qué son los pañuelos blancos pintados en la Plaza de Mayo?",
             "ops": ["El símbolo de las Madres y Abuelas que reclaman por sus hijos y nietos",
                     "Una decoración", "Un homenaje a los inmigrantes"],
             "m": "Las Madres empezaron a rondar la plaza en 1977."},
            {"q": "¿Qué se conmemora el 2 de abril?",
             "ops": ["El Día del Veterano y de los Caídos en la Guerra de Malvinas",
                     "La vuelta de la democracia", "El golpe de 1976"],
             "m": "Recuerda el desembarco de 1982."},
            {"q": "¿Por qué se preservan los edificios donde ocurrieron los hechos?",
             "ops": ["Porque son prueba material y espacio de transmisión",
                     "Porque son antiguos", "Porque no se pueden demoler"],
             "m": "Sirvieron como evidencia en los juicios."},
            {"q": "¿Qué hacen las Abuelas de Plaza de Mayo?",
             "ops": ["Buscan a los nietos apropiados y les restituyen su identidad",
                     "Administran museos", "Organizan actos escolares"],
             "m": "Ya se restituyó la identidad de más de un centenar de personas."},
            {"q": "¿Qué es el derecho a la identidad?",
             "ops": ["El derecho a conocer el propio origen y llevar el nombre verdadero",
                     "El derecho a votar", "El derecho a la educación"],
             "m": "Está reconocido en la Convención sobre los Derechos del Niño."},
            {"q": "¿Qué significa «Nunca Más»?",
             "ops": ["El compromiso de que el terrorismo de Estado no se repita",
                     "El nombre de un museo", "Una consigna partidaria"],
            ...
            {"q": "Los espacios de memoria, ¿son sólo sobre la dictadura argentina?",
             "ops": ["No: también hay sobre el Holocausto y Malvinas",
                     "Sí, sólo sobre la dictadura", "Sólo sobre Malvinas"],
             "m": "Cada uno preserva la memoria de un proceso distinto."},
            {"q": "¿Qué es una marca territorial de memoria?",
             "ops": ["Una señal en el lugar donde ocurrió un hecho, para recordarlo",
                     "Un cartel de tránsito", "Una placa de obra"],
             "m": "Convierte un punto de la ciudad en un espacio de transmisión."},
        ],
    },
    {
        "id": "billetera_7", "grado": 7, "area": "matematica",
        "titulo": "Mi primera billetera", "icono": "💰",
        "mecanica": "clasificar",
        "consigna": "¿Esto es ahorro, deuda o inversión?",
        "explica": "El ahorro guarda, la deuda compromete plata futura, la inversión busca que crezca.",
        "categorias": [{"cat": "ahorro", "label": "🐖 Ahorro"},
                       {"cat": "deuda", "label": "📉 Deuda"},
                       {"cat": "inversion", "label": "📈 Inversión"}],
        "dc": "Sociales/FEC: ahorro, deuda e inversión; medios de pago; interés simple",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CS7",
        "saber": {"id": "SOC-7-financiera", "nombre": "Ahorro, deuda e inversión",
                  "prereqs": ["MAT-7-razon"]},
        "banco": [
            {"it": "Guardar $5.000 por mes en una caja de ahorro", "cat": "ahorro",
             "m": "Se aparta plata sin comprometerla ni arriesgarla."},
            {"it": "Comprar un celular en 12 cuotas con tarjeta de crédito", "cat": "deuda",
             "m": "Se usa plata que todavía no se tiene."},
            {"it": "Poner el dinero en un plazo fijo que paga interés", "cat": "inversion",
             "m": "Se busca que el dinero genere un rendimiento."},
            {"it": "Juntar plata en una alcancía para las vacaciones", "cat": "ahorro",
             "m": "Guardar con un objetivo, sin riesgo ni rendimiento."},
            {"it": "Pedir un préstamo al banco", "cat": "deuda",
             "m": "Hay que devolverlo con intereses."},
            {"it": "Comprar herramientas para trabajar con ellas", "cat": "inversion",
             "m": "Se espera que generen ingresos futuros."},
            {"it": "Dejar el sueldo en la cuenta sin tocarlo", "cat": "ahorro",
             "m": "Es ahorro, aunque no genere rendimiento."},
            {"it": "Pagar el mínimo del resumen de la tarjeta", "cat": "deuda",
             "m": "Lo que no se paga sigue generando intereses: es la deuda más cara."},
            {"it": "Comprar un curso para conseguir un mejor trabajo", "cat": "inversion",
             "m": "Se invierte en la propia formación."},
            {"it": "Apartar una parte del sueldo apenas cobra", "cat": "ahorro",
             "m": "Ahorrar primero y gastar después es la estrategia recomendada."},
            {"it": "Financiar el supermercado en cuotas", "cat": "deuda",
             "m": "Endeudarse por consumo corriente es lo más riesgoso."},
            {"it": "Comprar una máquina para producir y vender", "cat": "inversion",
             "m": "Se espera recuperar lo invertido y generar ganancia."},
            {"it": "Guardar plata para una emergencia", "cat": "ahorro",
             "m": "El fondo de emergencia es la primera recomendación financiera."},
            {"it": "Comprar ahora y pagar el mes que viene", "cat": "deuda",
             "m": "Aunque no haya interés, se compromete el ingreso futuro."},
            {"it": "Aportar a un fondo que rinde a lo largo del tiempo", "cat": "inversion",
             "m": "Busca rendimiento, y por eso también tiene riesgo."},
            {"it": "Tener el dinero disponible en la billetera virtual sin gastarlo", "cat": "ahorro",
             "m": "Está guardado y disponible."},
        ],
    },
    {
        "id": "puerto_madero_7", "grado": 7, "area": "sociales",
        "titulo": "Puerto Madero y el arte urbano", "icono": "🏗️",
        "mecanica": "trivia",
        "consigna": "Pensá cómo cambia la ciudad.",
        "explica": "Refuncionalizar es darle un uso nuevo a un espacio que quedó obsoleto.",
        "dc": "Refuncionalización urbana; murales, grafitis e intervenciones",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CS8",
        "saber": {"id": "SOC-7-ciudad", "nombre": "Transformación urbana y arte urbano",
                  "prereqs": []},
        "banco": [
            {"q": "¿Qué era Puerto Madero antes de su transformación?",
             "ops": ["Una zona portuaria en desuso con depósitos abandonados",
                     "Un barrio residencial", "Un parque"],
             "m": "El puerto quedó obsoleto cuando cambiaron los barcos y las cargas."},
            {"q": "¿Qué significa refuncionalizar un espacio?",
             "ops": ["Darle un uso nuevo conservando parte de lo construido",
                     "Demolerlo todo", "Dejarlo como estaba"],
             "m": "Los docks de ladrillo se convirtieron en oficinas y restaurantes."},
            {"q": "¿Qué es la gentrificación?",
             "ops": ["Cuando un barrio se renueva y sube tanto de precio que desplaza a sus vecinos",
                     "La construcción de plazas", "La demolición de edificios viejos"],
             "m": "Es la contracara habitual de una refuncionalización exitosa."},
            {"q": "¿Qué diferencia hay entre un mural y un grafiti?",
             "ops": ["El mural suele ser una obra planificada y autorizada",
                     "El grafiti siempre es más grande", "No hay diferencia"],
             "m": "El grafiti nació como práctica espontánea y muchas veces no autorizada."},
            {"q": "¿Qué es una intervención urbana?",
             "ops": ["Una acción artística que transforma temporalmente un espacio público",
                     "Una obra de construcción", "Un corte de calle"],
             "m": "Busca hacer pensar sobre el espacio, no sólo decorarlo."},
            {"q": "¿Por qué se conservaron las grúas del puerto?",
             "ops": ["Porque son patrimonio industrial y cuentan la historia del lugar",
                     "Porque todavía funcionan", "Porque son muy pesadas"],
             "m": "Preservar marcas del uso anterior es parte de la refuncionalización."},
            {"q": "¿Qué es el patrimonio industrial?",
             "ops": ["Construcciones y máquinas que testimonian la actividad productiva del pasado",
                     "Las fábricas actuales", "Los museos de arte"],
             "m": "Galpones, silos y grúas entran en esa categoría."},
            {"q": "¿Qué barrio porteño es conocido por sus murales de gran escala?",
             "ops": ["Villa Urquiza, entre otros", "Puerto Madero", "Recoleta"],
            ...
            {"q": "¿Puede el arte urbano transformar la percepción de un barrio?",
             "ops": ["Sí, cambia cómo lo ven vecinos y visitantes", "No, es sólo decoración",
            ...
            {"q": "¿Qué se construyó en los antiguos diques de Puerto Madero?",
             "ops": ["Oficinas, viviendas y espacios gastronómicos", "Fábricas nuevas",
            ...
            {"q": "¿Qué es la Reserva Ecológica que está junto a Puerto Madero?",
             "ops": ["Un área natural formada sobre terrenos ganados al río",
                     "Un parque diseñado desde cero", "Una isla natural"],
             "m": "La naturaleza colonizó un relleno de origen artificial."},
            {"q": "¿Por qué las ciudades refuncionalizan zonas en desuso?",
             "ops": ["Porque aprovechan infraestructura que ya existe",
                     "Porque es más barato demoler", "Porque lo exige la ley"],
             "m": "Reutilizar suele costar menos que urbanizar desde cero."},
            {"q": "¿El arte urbano puede tener contenido político o social?",
             "ops": ["Sí, muchas veces es su razón de ser", "No, es sólo estético",
            ...
            {"q": "¿Quiénes suelen quedar afuera de una renovación urbana?",
             "ops": ["Los vecinos de menores ingresos, por el aumento de los precios",
                     "Los turistas", "Los comerciantes"],
             "m": "Por eso la gentrificación es un tema de discusión pública."},
        ],
    },
    {
        "id": "comunicacion_tiempo_7", "grado": 7, "area": "sociales",
        "titulo": "La comunicación en el tiempo", "icono": "📡",
        "mecanica": "ordenar",
        "consigna": "Ordená del MÁS ANTIGUO al más nuevo. Tocá en orden.",
        "explica": "Cada tecnología nueva no borra a la anterior: convive con ella un tiempo.",
        "dc": "Avance de las tecnologías de comunicación; la historieta argentina",
        "fuente": "docs/auditoria-dc-caba/grado-7.md · CS9",
        "saber": {"id": "SOC-7-comunicacion", "nombre": "Historia de la comunicación",
                  "prereqs": ["SOC-7-ciudad"]},
        "banco": [
            {"items": ["La carta en papel", "El telégrafo", "El teléfono fijo",
                       "El teléfono celular"]},
            {"items": ["La imprenta de tipos móviles", "El diario impreso", "La radio",
                       "La televisión"]},
            {"items": ["El telégrafo", "El teléfono", "La radio", "Internet"]},
            {"items": ["El diario en papel", "La radio a válvulas", "La televisión en blanco y negro",
                       "La televisión en color"]},
            {"items": ["La señal de humo", "La paloma mensajera", "El telégrafo",
                       "El correo electrónico"]},
            {"items": ["El disco de vinilo", "El casete", "El CD", "La música en streaming"]},
            {"items": ["La máquina de escribir", "La computadora personal", "El teléfono inteligente",
                       "El asistente con inteligencia artificial"]},
            {"items": ["El cine mudo", "El cine sonoro", "La televisión", "Las plataformas de video"]},
            {"items": ["El correo postal", "El fax", "El correo electrónico",
                       "La mensajería instantánea"]},
            {"items": ["La radio a galena", "La televisión abierta", "El cable",
                       "El streaming"]},
        ],
    },
]
