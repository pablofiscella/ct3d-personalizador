...
const INGLES_BANCO = [
  ...
  { q: "¿Cómo se dice «casa» en inglés?", ok: "house", d: ["table", "car"], m: "«house» es casa; «car» es auto." },
  ...
  { q: "¿Cómo se dice «agua» en inglés?", ok: "water", d: ["milk", "fire"], m: "«water» es agua; «milk» es leche." },
  ...
  { q: "¿Cómo se dice «gracias» en inglés?", ok: "thank you", d: ["hello", "goodbye"], m: "«thank you» es gracias; «hello» es hola." },
